            ...
            SiebelAppFacade.SCiPadContactFinanceListViewPR = (function() {
                ...
                function CreditHistory_GetRecords() {
                    ...
                    for (var l = 0; l < historyRecordSet.length; l++) {
                        ...
                        newRecord += '<td class="SC-CA-TD-AppRefNum">' + historyRecordSet[l]["SC Name"] + '</td>';
                ...
                function submitApplication() {
                    ...
                    setTimeout(function() {
                        ...
                        if (PrimaryIOIn.GetType() == "SavePrimaryApplicant") {
                            ...
                            } else if (SC_Residental_Status == "Buying") {
                                PrimaryIOIn.SetProperty("ResidentialStatus", "B");
                            } else {
                        ...
                        if (isJointAccount == 'Y') {
                            ...
                            if (CoAppInIO.GetType() == "SaveCoApplicant") {
                                ...
                                } else if (Co_Residental_Status == "Buying") {
                                    CoAppInIO.SetProperty("ResidentialStatus", "B");
                                } else {
						...
						var sApplicationStatus = "",sReturnMessage = "";
						if(wPrimaryOut != null){
							...
							ai.cb = function(){
								...
								if(bRecordUpdate || retry == 3){
									...
									setTimeout(function() {
										...
										//$("body").trigger('Custom.End');
										if(sApplicationStatus != "" || sApplicationStatus != undefined){
											if(sApplicationStatus.toUpperCase() == "APPROVED" && bRecordUpdate){
											...
											}else if (sApplicationStatus.toUpperCase() == "DECLINE" && bRecordUpdate){
												$("#Fin-Status-Text").text("Synchrony Bank and Vive Financial are unable to approve your application at this time.  You will receive a written explanation in the mail within 7-10 days regarding the reasons for the decision and the source of the information utilized.  It will include a number for you to call if you have questions.\nPlease see sales associate for next steps.");
											}else{
