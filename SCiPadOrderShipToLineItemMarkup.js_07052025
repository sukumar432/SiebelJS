...
*****************************/
if (typeof (SiebelAppFacade.SCiPadOrderShipToLineItemMarkup) === "undefined")
{

  SiebelJS.Namespace("SiebelAppFacade.SCiPadOrderShipToLineItemMarkup");
  define("siebel/custom/SelectComfort/SCiPadOrderShipToLineItemMarkup", ["siebel/phyrenderer", "siebel/custom/SelectComfort/bootstrap.min", "siebel/custom/SelectComfort/SC_OUI_Methods"],
    function ()
    {
      SiebelAppFacade.SCiPadOrderShipToLineItemMarkup = (function ()
      {
        ...
        var ShippingMarkup = new SCiPadOrderShipToLineItemMarkup();
        var lovArray_ShipMethods = '';
        var addList = '';

        function SCiPadOrderShipToLineItemMarkup(pm)
        {}

        SCiPadOrderShipToLineItemMarkup.prototype.ShipOptionsMarkup = function ()
        {
        ...
        SCiPadOrderShipToLineItemMarkup.prototype.DefaultShippingMarkup = function (scAccountOrder)
        {
          ...
          if (scAccountOrder)
          {
            ...
            default_Ship_Markup += '                                            <p style="display: none;">Phone:</p>';
            default_Ship_Markup += '                                            <input type="" name="shipdefaultnumber" id="scship-Acc-phone-number" class="shipping-ds-input" style="display: none;">';
            default_Ship_Markup += '                                        </div>';
          ...
          default_Ship_Markup += '</div>';
          /* default_Ship_Markup+='<div class="col-sm-7 col-md-7 col-lg-7 shipping-content-item" id="Ship-Date-Div">';
							default_Ship_Markup+='<p>Request Ship Date:  </p>';
							 ...
							 // default_Ship_Markup+='<label id="Ship-Defalut-RequestShipDate"><span id="Ship-Default-Calander">select</span></label>';  
							 default_Ship_Markup+='<input type="date" id="Ship-Defalut-RequestShipDate" value="" class="shipping-ds-input">'; 
							default_Ship_Markup+='</div>';  */
          default_Ship_Markup += '<div class="col-sm-7 col-md-7 col-lg-7 shipping-content-item">';
          ...
          //SYERUVA: Added above SC-readonly code to make deliveryPhone readonly - STRY0104341
          default_Ship_Markup += '</div>';
        ...
        SCiPadOrderShipToLineItemMarkup.prototype.ShippingDetails = function ()
        {
          ...
          ship_details_Markup += '		 </div>';
          //SYERUVA: Commented code to make deliveryPhone readonly - STRY0104341
        ...
        SCiPadOrderShipToLineItemMarkup.prototype.Shipping_CreateNewContact = function ()
        {
          ...
          ship_AddNewContact += '<button type="reset" class="close SC-close-popup blue-bg" data-dismiss="modal">×</button>';
        ...
        SCiPadOrderShipToLineItemMarkup.prototype.Shipping_CreateNewAddress = function ()
        {
          ...
          ship_AddNewAddress += '                            <button type="reset" class="close SC-close-popup blue-bg" data-dismiss="modal">×</button>';
        ...
        SCiPadOrderShipToLineItemMarkup.prototype.Shipping_Verify = function ()
        {
        ...
        SCiPadOrderShipToLineItemMarkup.prototype.Shipping_CF_Success = function ()
        {
        ...
        SCiPadOrderShipToLineItemMarkup.prototype.Shipping_CF_Failure = function ()
        {
        ...
        SCiPadOrderShipToLineItemMarkup.prototype.StoreLocation_Verify = function ()
        {
        ...
        SCiPadOrderShipToLineItemMarkup.prototype.MyStoreLocation_Verify = function ()
        {
          var My_storemarkup = '';
        ...
        SCiPadOrderShipToLineItemMarkup.prototype.SelectDeliveryType = function (pEligibleAddresses)
        {
        ...
        //start:Doorstep Delivery popup
        SCiPadOrderShipToLineItemMarkup.prototype.ReSelectDeliveryType = function (pEligibleAddresses)
        {
          var sDeliveryType, sEligibleAddress, sAddress, sCity, sState, sCountry, sAddressId;
          var DeliveryTypeMarkup = '';
          DeliveryTypeMarkup += ' <div class="modal-dialog" style="width:700px !important">';
          ...
          for (var i = 0; i < pEligibleAddresses.GetChildCount(); i++)
          {
            sEligibleAddress = pEligibleAddresses.GetChild(i).GetProperty('ReOptionEligible'); //ReOptionEligible
            if (sEligibleAddress == "Y")
            {
              sDeliveryType = pEligibleAddresses.GetChild(i).GetProperty('SC Delivery Type');
              sAddress = pEligibleAddresses.GetChild(i).GetProperty('SC Ship To Addr');
        ...
        //start:Doorstep Delivery popup
        SCiPadOrderShipToLineItemMarkup.prototype.ReSelectDeliveryTypeOption = function (pEligibleAddresses)
        {
          var sDeliveryType, sEligibleAddress, sAddress, sCity, sState, sCountry, sAddressId;
          var DeliveryTypeMarkup = '';
          DeliveryTypeMarkup += ' <div class="modal-dialog" style="width:700px !important">';
          ...
          for (var i = 0; i < pEligibleAddresses.GetChildCount(); i++)
          {
            sEligibleAddress = pEligibleAddresses.GetChild(i).GetProperty('ReOptionEligible');
            if (sEligibleAddress == "Y")
            {
              sDeliveryType = pEligibleAddresses.GetChild(i).GetProperty('SC Delivery Type');
              sAddress = pEligibleAddresses.GetChild(i).GetProperty('SC Ship To Addr');
              ...
              DeliveryTypeMarkup += ' <th>SKU#</th>';
              DeliveryTypeMarkup += ' <th>QTY</th>';
              DeliveryTypeMarkup += ' <th>Delivery Type</th>';
              DeliveryTypeMarkup += ' </tr>';
              DeliveryTypeMarkup += ' </thead>';
              DeliveryTypeMarkup += ' <tbody id="SC_Summary_Products">';
              ...
              for (var j = 0; j < pEligibleAddresses.GetChild(i).GetChildCount(); j++)
              {
                if (pEligibleAddresses.GetChild(i).GetChild(j).GetProperty("Request To Cancel") != "Y")
                {
                  ...
                  DeliveryTypeMarkup += ' <td>' + pEligibleAddresses.GetChild(i).GetChild(j).GetProperty("SC Product") + '</td>';
                  DeliveryTypeMarkup += ' <td class="so-product-quantity">' + pEligibleAddresses.GetChild(i).GetChild(j).GetProperty("SC Product Qty") + '</td>';
                  DeliveryTypeMarkup += ' <td>' + pEligibleAddresses.GetChild(i).GetChild(j).GetProperty("SC Delivery Type") + '</td>';
                  DeliveryTypeMarkup += ' </tr>';
                }
              }
              DeliveryTypeMarkup += ' </tbody>';
        ...
        SCiPadOrderShipToLineItemMarkup.prototype.ShippingSummary = function ()
        {
        ...
        SCiPadOrderShipToLineItemMarkup.prototype.ShippingSummaryMarkup = function (Addres_Array, scaccountOrder)
        {
        ...
        SCiPadOrderShipToLineItemMarkup.prototype.GetShippingMethods = function (subType)
        {
        ...
        SCiPadOrderShipToLineItemMarkup.prototype.GetAddressList = function (conId_Global)
        {
        ...
        SCiPadOrderShipToLineItemMarkup.prototype.AttachAddresses = function ()
        {
          var addressLine = '';
        ...
        SCiPadOrderShipToLineItemMarkup.prototype.SetPreSelectedValues = function (linItemsListRS)
        {
        ...
        SCiPadOrderShipToLineItemMarkup.prototype.Request_Referral_Markup = function ()
        {
      ...
      return "SiebelAppFacade.SCiPadOrderShipToLineItemMarkup";
    })
}