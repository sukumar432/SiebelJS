        ...
        function () {
            SiebelAppFacade.SCiPadSalesOrderCreateFormAppletPR = (function () {
                ...
                SCiPadSalesOrderCreateFormAppletPR.prototype.ShowUI = function () {
                    ...
                    //LikhithaK:Start:21May2025:SFSTRY0003472:Below code added for Terminal popup
                    var sIpadFeatureFlg = SiebelApp.S_App.GetProfileAttr('IpadFeatureFlag');
                    if (sIpadFeatureFlg == "Y") {
                        //LikhithaK:Start:20Aug2025:Nullifying Terminal (during New Sales Order) against the Order when Tab closed directly.
                        var sResumeOrderFlg = SiebelApp.S_App.GetProfileAttr('ResumeOrder');
                        var sOrderNumber = localStorage.getItem('OrderNum');
                        ...
                        if (sResumeOrderFlg != "Y") {
                            if (sOrderNumber == null) {
                                localStorage.setItem('OrderNum', sOrderNum);
                            } else if (sOrderNumber != sOrderNum) {
                        ...
                        //LikhithaK:End:20Aug2025:Nullifying Terminal (during New Sales Order) against the Order when Tab closed directly.
                        setTimeout(function () {
                    ...
                    //LikhithaK:End:21May2025:SFSTRY0003472:Above code added for Terminal popup
                    ...
                    //}
                    //LikhithaK:Start:21May2025:SFSTRY0003472:Added below line for Terminal UI.
                    var sIpadFeatureFlg = SiebelApp.S_App.GetProfileAttr('IpadFeatureFlag');
                    if (sIpadFeatureFlg == "Y") {
                        $('#SC-terminal-offline-popup').parent('div').parent('#applet1').remove();
                    }
                    //LikhithaK:End:21May2025:SFSTRY0003472:Added above line for Terminal UI.
           ...
           markup+='                                            </div>';*/
                    ...
                    $("#addressto").click(function () {
                        ...
                        if (scaddrDropdown == 'N') {
                            var billToAddress = AttachAddresses();
                            $("#addressto").html(billToAddress);
                            scaddrDropdown = "Y";
                    ...
                    //LikhithaK:Start:21May2025:SFSTRY0003472:Terminal Icon & Cross icon click on the top right most corner on UI
			...
			{  
			 ...
			 $(".QVC_fileds").show();	
                    ...
                    //LikhithaK:Start:21May2025:SFSTRY0003472:Save terminal Code
                    ...
                    //LikhithaK:End:21May2025:SFSTRY0003472:Save terminal Code
			...
			$("#SC-BiitoAddress-Edit").hide();
                ...
                SCiPadSalesOrderCreateFormAppletPR.prototype.BindEvents = function () {
                    ...
                    $("#gotoContact").click(function () {
                        ...
                        //LikhithaK:Start:21May2025:SFSTRY0003472:Terminal Changes
                        var sIpadFeatureFlg = SiebelApp.S_App.GetProfileAttr('IpadFeatureFlag');
                        if (sIpadFeatureFlg == "Y") {
                        ...
                        //LikhithaK:End:21May2025:SFSTRY0003472:Terminal Changes
                    });
			...
			refByName="searchiconrefby";
                ...
                //LikhithaK:Start:21May2025:SFSTRY0003472:Added below function to track inactivity.
                ...
                //LikhithaK:End:21May2025:SFSTRY0003472:Added above function to track inactivity.
