if (typeof(SiebelAppFacade.SCiPadContactFinanceListViewPR) === "undefined") {

    SiebelJS.Namespace("SiebelAppFacade.SCiPadContactFinanceListViewPR");
    define("siebel/custom/SelectComfort/SCiPadContactFinanceListViewPR", ["siebel/viewpr", "siebel/custom/SelectComfort/SCiPadCreditApplicationMarkup", "siebel/custom/SelectComfort/bootstrap.min", "siebel/custom/SelectComfort/jquery.validate.min", "siebel/custom/SelectComfort/SC_OUI_Markups", "siebel/custom/SelectComfort/SC_OUI_Methods", "siebel/custom/SelectComfort/SCErrorCodes"],
        function() {
            SiebelAppFacade.SCiPadContactFinanceListViewPR = (function() {
                var SiebelConstant = SiebelJS.Dependency("SiebelApp.Constants");
                var CreditAppMarkup = SiebelJS.Dependency("SiebelApp.SCiPadCreditApplicationMarkup");
                ...
                var selectedIndex = '',
                    rowId = '';
                var sSCPrimaryIdType = "",
                    sSCPrimaryIdState = "",
                    sSCPrimaryIdExpMon = "",
                    sSCPrimaryIdExpYear = "";
                var sSCSecondaryIdType = "",
                    sSCSecondaryIdState = "",
                    sSCSecondaryIdExpMon = "",
                    sSCSecondaryIdExpYear = "";
                var sFirstFinId = "";
				var creditamount ="";
				var bNavRestriction = false;

                function SCiPadContactFinanceListViewPR(pm) {
                    SiebelAppFacade.SCiPadContactFinanceListViewPR.superclass.constructor.apply(this, arguments);
                }

                SiebelJS.Extend(SCiPadContactFinanceListViewPR, SiebelAppFacade.ViewPR);
                SCiPadContactFinanceListViewPR.prototype.Init = function() {
                    SiebelAppFacade.SCiPadContactFinanceListViewPR.superclass.Init.apply(this, arguments);
					if(localStorage.getItem("bNavRestriction") == "True"){
						localStorage.setItem("bNavRestriction","False");
                ...
                SCiPadContactFinanceListViewPR.prototype.ShowUI = function() {
                    SiebelAppFacade.SCiPadContactFinanceListViewPR.superclass.ShowUI.apply(this, arguments);
                ...
                SCiPadContactFinanceListViewPR.prototype.BindData = function(bRefresh) {
                    SiebelAppFacade.SCiPadContactFinanceListViewPR.superclass.BindData.apply(this, arguments);
                ...
                SCiPadContactFinanceListViewPR.prototype.BindEvents = function() {
                    SiebelAppFacade.SCiPadContactFinanceListViewPR.superclass.BindEvents.apply(this, arguments);
					...
					//SNARRA:31-07-2019 Primary Phone Info toggle
                    /*$(document).click(function(e) {
						$("#sc-sstootltip-num").hide();
						$("#sc-MNItootltip-info").hide();
						$("#sc-businesstootltip-info").hide();
						$("#sc-tootltip-info").hide();
						$("#sc-cosstootltip-num").hide();
						$("#sc-COMNItootltip-info").hide();
						$("#sc-cobusinesstootltip-info").hide();
                    });*/
					
					$(document).on("click", "#SC_SecondaryPhone", function(e) {
						if ($(this).attr("Id") == "SC_SecondaryPhone") {
							$("#sc-tootltip-info").children(0).children(0).removeClass("SC-phone-tooltip");
                            $("#sc-tootltip-info").children(0).children(0).removeClass("SC-Emailadress-tooltip");
                            $("#sc-tootltip-info").children(0).children(0).addClass("SC-homephone-tooltip");
						}
						$("#sc-sstootltip-num").hide();
						$("#sc-MNItootltip-info").hide();
						$("#sc-businesstootltip-info").hide();
						$("#sc-tootltip-info").show();
						$("#SC-alterphonenum-tooltip-info").hide();
						$("#SC-email-tooltip-info").hide();
					});
					
					$(document).on("click", "#SC_EmpPhone,#sc-businessphone-info", function(e) {
                        $("#sc-sstootltip-num").hide();
						$("#sc-MNItootltip-info").hide();
						$("#sc-businesstootltip-info").show();
                        $("#sc-tootltip-info").hide();
						$("#SC-alterphonenum-tooltip-info").hide();
						$("#SC-email-tooltip-info").hide();
                    });
					
					$(document).on("click", "#SC_AltSecondaryPhone,#sc-alterphone-info", function(e) {
                        $("#sc-sstootltip-num").hide();
						$("#sc-MNItootltip-info").hide();
						$("#sc-businesstootltip-info").hide();
                        $("#sc-tootltip-info").hide();
						$("#SC-alterphonenum-tooltip-info").show();
						$("#SC-email-tooltip-info").hide();
						$("#SC-alterphonenum-tooltip-info").children(0).children(0).removeClass("SC-phone-tooltip");
                    });
					
					$(document).on("click", "#SC_Email,#sc-email-info", function(e) {
                        $("#sc-sstootltip-num").hide();
						$("#sc-MNItootltip-info").hide();
						$("#sc-businesstootltip-info").hide();
                        $("#sc-tootltip-info").hide();
						$("#SC-alterphonenum-tooltip-info").hide();
						$("#SC-email-tooltip-info").show();
                    });

					$(document).on("click", "#SC_MNI,#sc-MNI-info", function(e) {
                        $("#sc-sstootltip-num").hide();
						$("#sc-MNItootltip-info").show();
						$("#sc-businesstootltip-info").hide();
                        $("#sc-tootltip-info").hide();
						$("#SC-alterphonenum-tooltip-info").hide();
						$("#SC-email-tooltip-info").hide();
                    ...
                    $(document).on("click", "#sc-cophone-info,#sc-cohomephone-info,#Co_PrimaryPhn,#Co_SecondaryPhn", function(e) {
                        if ($(this).attr("Id") == "sc-cohomephone-info" || $(this).attr("Id") == "Co_SecondaryPhn") {
                            $("#sc-cotootltip-info").children(0).children(0).removeClass("SC-phone-tooltip");
                            $("#sc-cotootltip-info").children(0).children(0).addClass("SC-homephone-tooltip");
                        }else{
							$("#sc-cotootltip-info").children(0).children(0).addClass("SC-phone-tooltip");
                            $("#sc-cotootltip-info").children(0).children(0).removeClass("SC-homephone-tooltip");
						}
						$("#sc-cosstootltip-num").hide();
						$("#sc-COMNItootltip-info").hide();
						$("#sc-cobusinesstootltip-info").hide();
                        $("#sc-cotootltip-info").show();
					});
					
					$(document).on("click", "#Co_EmpPhn,#sc-cobusinessphone-info", function(e) {
                        $("#sc-cosstootltip-num").hide();
						$("#sc-COMNItootltip-info").hide();
						$("#sc-cobusinesstootltip-info").show();
                        $("#sc-cotootltip-info").hide();
                    });

					$(document).on("click", "#Co_MNI,#sc-coMNI-info", function(e) {
                        $("#sc-cosstootltip-num").hide();
						$("#sc-COMNItootltip-info").show();
						$("#sc-cobusinesstootltip-info").hide();
                        $("#sc-cotootltip-info").hide();
                    ...
                    $(document).on('click', "#SC-CA-ManualUpdate-Save", function() {
						...
						//var SC_Partner = $("#SC-CA-Patner").val();
						...
						/*if(SC_Partner == "Synchrony" && (MU_Status == "Decline" || MU_Status == "Declined")){
							submitHCApplication();
						}*/
                    ...
                    var financeheadermarkup = CreditAppMarkup.SCFinanceHeaderMarkup(hcMerchantId);
                    ...
                    $(document).on('click', "#SC-yes-okay", function() {
                        $("#app-info-popup").modal("hide");
						...
						if (isJointAccount != "Y") {
						   ...
						   $("#reqcre").addClass("SC-disabled");
					       $("#reqcre").val(creditamount);	
                        ...
                        $('#Co_FirstName, #Co_MiddleInitial, #Co_LastName').keypress(function(e) {
                        ...
                        $('#SC_MailingAddress, #SC_Apt_Cmp, #SC_Employer, #Co_MailingAddress, #Co_Apt_Cmp, #Co_Employer').keypress(function(e) {
                            var regex = new RegExp("^[a-zA-Z0-9 ]+$");
                            var str = String.fromCharCode(!e.charCode ? e.which : e.charCode);
                            if (regex.test(str)) {
                                return true;
                        ...
                        $('#SC_City, #Co_City').keypress(function(e) {
                        ...
                        $('#SC_Residence, #SC_Monthlypayement, #SC_PrimaryPhone, #SC_SecondaryPhone, #SC_MNI, #SC_EmpPhone, #SC_SSN').keypress(function(e) {
                        ...
                        $('#Co_Residence, #Co_Monthlypayement, #Co_PrimaryPhone, #Co_SecondaryPhone, #Co_MNI, #Co_EmpPhone, #Co_SSN').keypress(function(e) {
                            var regex = new RegExp("^[0-9]+$");
                            var str = String.fromCharCode(!e.charCode ? e.which : e.charCode);
                            if (regex.test(str)) {
                                return true;
                        ...
                        $('#SC_ZipCode, #Co_ZipCode').keypress(function(e) {
                            var regex = new RegExp("^[0-9]+$");
                            var str = String.fromCharCode(!e.charCode ? e.which : e.charCode);
                            if (regex.test(str)) {
                                return true;
						...
						$("#sign-act").click(function() {
						  if(isJointAccount == "N" && this.checked){
							$("#SC-sign-submit").removeClass("SC-disabled");
						  }else if(isJointAccount == "Y"){
							var bSecondaryAppCheck = $("#sig-cact").is(":checked");
							if(bSecondaryAppCheck){
								if($("#SC-sign-submit").hasClass("SC-disabled")){
								   $("#SC-sign-submit").removeClass("SC-disabled");	
								}else{
									$("#SC-sign-submit").addClass("SC-disabled");
								}
						...
						$("#sig-cact").click(function() {
						  var bPrimaryAppCheck = $("#sign-act").is(":checked");
						  if(this.checked && bPrimaryAppCheck){
							$("#SC-sign-submit").removeClass("SC-disabled");
						  }else{
							$("#SC-sign-submit").addClass("SC-disabled");
						  }
					...
					var sysdate,currentApMonth,currentcoMonth,CurrentYear;
					$(document).on("change", "#PPEY,#SPEY", function() {
						sysdate = new Date();
                        CurrentYear = sysdate.getFullYear();
						if (CurrentYear == $("#PPEY").val()) {
                            currentApMonth = sysdate.getMonth()+1;
                        } else
                            currentApMonth = 01;
                        if (CurrentYear == $("#SPEY").val()) {
                            currentcoMonth = sysdate.getMonth()+1;
                        } else
                            currentcoMonth = 01;
					});
                    //start:on click of next button in applicant information page
                    $(document).on("click", "#finance-button", function() {
						sysdate = new Date();
                        CurrentYear = sysdate.getFullYear();
                        $("#sc-finance-app").validate({
                            rules: {
                                primaryidtype: {
                                    required: true
                                },
                            ...
                            messages: {
                                primaryidtype: {
                                    required: errorCodes.SC_PRIMARY_ID_TYPE
                                },
                                isuuingstate: {
                                    required: errorCodes.SC_ISSUING_STATE
                                },
                                PPEM: {
                                    min: errorCodes.SC_EXP_DATE,
                                    required: errorCodes.SC_EXPR_MONTH,
                                    maxlength: errorCodes.SC_EXPR_MAX_LENGTH
                                },
                                PPEY: {
                                    min: errorCodes.SC_EXP_DATE,
                                    required: errorCodes.SC_EXPR_YEAR,
                                    maxlength: errorCodes.SC_EXPR_YEAR_MAX_LENGTH
                                },
                                coprimaryidtype: {
                                    required: errorCodes.SC_PRIMARY_TYPE
                                },
                                coisuuingstate: {
                                    required: errorCodes.SC_ISSU_STATE

                                },
                                SPEM: {
                                    min: errorCodes.SC_EXP_DATE,
                                    required: errorCodes.SC_EXP_MONTH,
                                    maxlength: errorCodes.SC_EXP_MAX_LENGTH
                                },
                                SPEY: {
                                    min: errorCodes.SC_EXP_DATE,
                                    required: errorCodes.SC_EXP_YEAR,
                                    maxlength: errorCodes.SC_EXP_YEAR_MAX_LENGTH
                                }
                            },
                            tooltip_options: {
                                primaryidtype: {
                            ...
                            submitHandler: function(form) {
                                //$("#sc-finance-app").submit();
                                sSCPrimaryIdType = $("#SC_applicant_PrimaryId").val();
                                sSCPrimaryIdState = $("#SC_fin_IssueState").val();
                                sSCPrimaryIdExpMon = $("#PPEM").val();
                                sSCPrimaryIdExpYear = $("#PPEY").val();
                                if (isJointAccount == "Y") {
                                    sSCSecondaryIdType = $("#SC_co_applicant_PrimaryId").val();
                                    sSCSecondaryIdState = $("#SC_fin_co_IssueState").val();
                                    sSCSecondaryIdExpMon = $("#SPEM").val();
                                    sSCSecondaryIdExpYear = $("#SPEY").val();
                                }
                                $("#app-info-popup").modal("hide");
                                $("#SC-Credit-popup").modal({
                                    backdrop: 'static'
                                });
								
								$('#SC-credit-appli').keypress(function(e) { 
									var regex = new RegExp("^[0-9.,]+$");
									var str = String.fromCharCode(!e.charCode ? e.which : e.charCode);
									if (regex.test(str)) {
										return true;
                    ...
                    $(document).on("click", "#sc_goto_gotoreview,#sc_goto_addcoapp", function() {
                        ...
                        $("#sc-fcc-primary-applicant").validate({
                            ...
                            messages: {
                                ...
                                secondaryphone: {
									required: errorCodes.SC_PHN_NUM,
                  ...
                  //start:on click on next button in credit amount page
				 // $(document).on("click","#SC-next", function(){
					...
					$("#creditform").validate({
                            ...
                            messages: {
                                CreditAmount: {
                                    required: errorCodes.SC_REQUIRED_CRE_AMT,
                                    number: errorCodes.SC_NUMBERS_ONLY,
                                    maxlength: errorCodes.SC_REQ_CREDIT_MAX_LENGTH
                                }
                            },
					...
					submitHandler: function(form){
					 creditamount= $("#SC-credit-appli").val();
					  $("#SC-Credit-popup").modal("hide");
					   $("#SC-Control-popup").modal({
                                    backdrop: 'static'
									});
					   }
                     });
				 ...
				 // });
					...
					//start:on click on cancel button in applicant page
				    $(document).on("click","#SC-cancel-finance", function(){
					   $("#custom-backdrop").show(); 
					   $("#SC-confirm-cancel-popup").modal({
                                    backdrop: 'static'
                       });
				    });
					
					$(document).on("click","#sc-confirm-cancel-yes-button", function(){
					   $("#SC-confirm-cancel-popup").modal('hide');
					   $("#SC-Control-BackToRep-popup").modal({
                                    backdrop: 'static'
                       });
				    });
					
					$(document).on("click","#SC-Control-BackToRep-okay", function(){
					   $("#SC-Control-BackToRep-popup").modal('hide');
					   $("#SC-canc-application-popup").modal({
                           backdrop: 'static'
                       });
				    });
					
					$(document).on("click","#sc-confirm-cancel-no-button", function(){
					   $("#SC-confirm-cancel-popup").modal('hide');
                   ...
                   /* $(document).on("mouseover", "#SC-CO-app-MonthlyNet", function() {
                    ...
                    /* //start:onclick applicant submit button
					 ...
					 SC_SecondaryPhone = $("#SC_SecondaryPhone").val();
					 SC_SecondaryPhone = SC_SecondaryPhone.replace(/\D+/g, "");
					...
					$(document).on("click", "#SC-sign-submit", function() {
						$("#SC-SO-sign-popup").modal("hide");
						$("#SC-vive-sign-popup").modal({
                            backdrop: 'static'
                        });
						$("#custom-backdrop").show();
					});
					$(document).on("click", "#sign-vive-MApp", function() {
						if(this.checked){
							var vPrimaryCheck = $("#sign-vive-MEcon").is(":checked");
							var vSecondaryCheck = $("#sig-vive-MTerms").is(":checked");
							if(vPrimaryCheck && vSecondaryCheck){
								if($("#SC-vive-submit").hasClass("SC-disabled")){
								   $("#SC-vive-submit").removeClass("SC-disabled");	
								}else{
									$("#SC-vive-submit").addClass("SC-disabled");
								}
					...
					$(document).on("click", "#sign-vive-MEcon", function() {
						if(this.checked){
							var vPrimaryCheck = $("#sign-vive-MApp").is(":checked");
							var vSecondaryCheck = $("#sig-vive-MTerms").is(":checked");
							if(vPrimaryCheck && vSecondaryCheck){
								if($("#SC-vive-submit").hasClass("SC-disabled")){
								   $("#SC-vive-submit").removeClass("SC-disabled");	
					...
					$(document).on("click", "#sig-vive-MTerms", function() {
						if(this.checked){
							var vPrimaryCheck = $("#sign-vive-MApp").is(":checked");
							var vSecondaryCheck = $("#sign-vive-MEcon").is(":checked");
							if(vPrimaryCheck && vSecondaryCheck){
								if($("#SC-vive-submit").hasClass("SC-disabled")){
								   $("#SC-vive-submit").removeClass("SC-disabled");	
								}else{
					...
					$(document).on("click", "#SC-vive-popup-close", function() {
						$("#SC-SO-sign-popup").modal({
                            backdrop: 'static'
                        });
						$("#custom-backdrop").hide();
					});
                    //start:click on submit button for both applicant and coapplicant details
                    $(document).on("click", "#SC-vive-submit", function() {
						$("#SC-vive-sign-popup").modal("hide");
						$("#SC-Fin-Processing-popup").modal({
                            backdrop: 'static'
                        });
						$("body").trigger('Custom.Start');
						setTimeout(function(){
							$("#SC-vive-submit").prop("disabled", true);
							SC_FirstName = $("#SC_FirstName").val();
							SC_MiddleInitial = $("#SC_MiddleInitial").val();
							SC_LastName = $("#SC_LastName").val();
							SC_MailingAddress = $("#SC_MailingAddress").val();
                    ...
                    //SNARRA:26-07-2019 Added code for launching finance application

                    $(document).on('click', "#SC-add-CA-btn", function() {
						$("#SC-finance-join").modal({
                            backdrop: 'static'
                        });
					});

                    $('#sc-join-yes-button').click(function(e) {
                        isJointAccount = "Y";
                        $("#SC-finance-join").modal("hide");
                        var financeMarkup = CreditAppMarkup.SCFinancepopup();
                        $("#app-info-popup").html(financeMarkup);
                        //START -- Custom Logic to get Issuing State							
                        lovArray = SCOUIMethods.SCGetOrderLoVs("[Order By] >= 1 and [Order By] <= 52 and [Type]= 'STATE_ABBREV' and [Active] = 'Y'");
                        var IssustateValue = '';
                        IssustateValue += ' <option></option>';
                        for (var st = 0; st < lovArray.length; st++) {
                            IssustateValue += ' <option>' + lovArray[st] + '</option>';
                        }
                        $('#SC_fin_IssueState').html(IssustateValue);
                        $("#SC_fin_co_IssueState").html(IssustateValue);
                        //END -- Seting Issuing State values 
                        //START -- Custom Logic to get Issuing State							
                        var PrimaryIdValue = '';
                        var PrimaryIddriversvalue = "State Issued Driver's License";
                        PrimaryIdValue += ' <option>' + PrimaryIddriversvalue + '</option>';
                        PrimaryIdValue += ' <option>Government Issued ID</option>';
                        PrimaryIdValue += ' <option>State Issued ID</option>';
                        PrimaryIdValue += ' <option>Passport</option>';
                        PrimaryIdValue += ' <option>Military ID</option>';
                        PrimaryIdValue += ' <option>Government Issued Green/Resident Alien Card</option>';
                        $('#SC_applicant_PrimaryId').html(PrimaryIdValue);
                        $("#SC_co_applicant_PrimaryId").html(PrimaryIdValue);
                        var secondaryIdValue = '';
                        secondaryIdValue += ' <option>Visa, MasterCard, American Express, Discover Card</option>';
                        secondaryIdValue += ' <option>Department Store Or Oil Company Credit Card</option>';
                        $('#SC_applicant_SecondaryId').html(secondaryIdValue);
                        $("#SC_co_applicant_SecondaryId").html(secondaryIdValue);
                        $("#app-info-popup").modal({
                            backdrop: 'static'
                        });
                        $("#sc-finance-app")[0].reset();
                        $(".SCConcoApplicant").show();
                    });
                    $("#SC-CTN-okay").click(function(event) {
                        $("#SC-SO-CTN-popup").modal("hide");

                    });
                    $("#sc-join-no-button").click(function(event) {
                        isJointAccount = "N";
                        $("#SC-finance-join").modal("hide");
                        var financeMarkup = CreditAppMarkup.SCFinancepopup();
                        $("#app-info-popup").html(financeMarkup);
                        ...
                        $(".SCConcoApplicant").hide();

                    });

                    /*$(document).on('click', "#finance-button", function (e) {
                    	...
                    	var SPEY = $("#SPEY").val();
                    	var SSEY = $("#SSEY").val();
                    	if (PPEY < currentYear || (PPEY == currentYear && PPEM < currentMonth)) {
                    		bInvalidDate = true;
                    	}
                    	if (PSEY < currentYear || (PSEY == currentYear && PSEM < currentMonth)) {
                    		bInvalidDate = true;
                    	}
                    	if (SPEY < currentYear || (SPEY == currentYear && SPEM < currentMonth)) {
                    		bInvalidDate = true;
                    	}
                    	if (SSEY < currentYear || (SSEY == currentYear && SSEM < currentMonth)) {
                    		bInvalidDate = true;
                    	}
                    	if(!bInvalidDate){
                    		$("#app-info-popup").modal("hide");
                    		$("#SC-SO-CT-popup").modal({
                    		   backdrop: 'static'
                    		}); 
                    	}else{
                    ...
                    $(document).on('click', "#sc-appyes-button", function() {
                        $("#SC-SO-CT-popup").modal("hide");
                        $("#SC-SO-Yes-popup").modal({
                            backdrop: 'static'
                        });

                    });

                    $(document).on('click', "#sc-appno-button", function() {
                        $("#SC-SO-CT-popup").modal("hide");
                        $("#SC-SO-CTN-popup").modal({
                            backdrop: 'static'
                        });
					});
					
					$(document).on('click', "#SC-disclosure-close", function() {
                        $("#SC-SO-CT-popup").modal("hide");
                        $("#SC-Control-BackToRep-popup").modal({
                            backdrop: 'static'
                        });
                    ...
                    $(document).on('click', "#SC-yes-okay", function() {
                        $("#SC-SO-Yes-popup").modal("hide");
						$('.modal-backdrop').remove();
                    });

                    $(document).on('click', "#SC-Control-okay", function() {
						bNavRestriction = true;
                        $("#SC-Control-popup").modal("hide");
                        $("#SC-SO-CT-popup").modal({
                            backdrop: 'static'
                        });
						$("#SC-disclosure-close").css("display","none");
						...
						window.addEventListener("pagehide", event => {
							if(bNavRestriction){
								localStorage.setItem("bNavRestriction","True");
							}
						}, false);
                    ...
                    $(document).on('click', "#SC-CTN-okay", function() {
                        $("#SC-SO-CTN-popup").modal("hide");
						$("#SC-SO-CT-popup").modal({
                            backdrop: 'static'
                        });
						$("#SC-disclosure-close").css("display", "block");
					});
					
					$(document).on('click', "#SC-Vive-Info", function() {
						if($('#SC-Vive-Info-tooltip').css('display') == 'block'){
							$("#SC-Vive-Info-tooltip").css("display", "none");
						}else{
							$("#SC-Vive-Info-tooltip").css("display", "block");
						}
					});
					
                    $(document).on('click', "#submit-aff, #submit-app", function() {
                        $("#appcreditterms").text(' I, ' + $("#SC_FirstName").val() + ' ' + $("#SC_LastName").val() + ' agree that I have read and agree to the above provision of the Credit Terms. Selecting "Submit" constitutes my electronic signature.');
						
                        $("#coapplcreditterms").text(' I, ' + $("#Co_FirstName").val() + ' ' + $("#Co_LastName").val() + ' agree that I have read and agree to the above provision of the Credit Terms. Selecting "Submit" constitutes my electronic signature.');
						if (isJointAccount != "Y") {
                            $("#coappcrdittermsblock").hide();
                        }
                        $("#SC-SO-sign-popup").modal({
                            backdrop: 'static'
                        });
                    ...
                    $(document).on('click', "#SC-sign-popup-close", function() {
                        $("#SC-SO-sign-popup").modal("hide");
                        $("#custom-backdrop").hide();
						$('.modal-backdrop').remove();
					});
                     $(document).on("click", "#SC-application-canc", function() {
						$("#custom-backdrop").hide();
						$('.modal-backdrop').remove();
                     	localStorage.setItem("bNavRestriction","False");
                     	bNavRestriction = false;
						var passcode = $("#SC-canc-application").val();
                        var searchExpr = "[Type]= 'IPAD_FINANCE' AND [Name] = 'Store Password' AND [Active] = 'Y'";
				 		var sortSpec = "Order By";
				 		var lovvalue = SCOUIMethods.SCGetOrderLoVs(searchExpr);
						  if(lovvalue == $("#SC-canc-application").val() ){
							 $("#SC-canc-application-popup").modal('hide');		
							 $("#custom-backdrop").hide();
							 $('.modal-backdrop').remove();
					 ...
					 $(document).on("click", "#SC-can-close", function() {
						 $("#SC-canc-application-popup").modal('hide');		
						 $("#custom-backdrop").hide();					 
                    });
                ...
                SCiPadContactFinanceListViewPR.prototype.EndLife = function() {
                    SiebelAppFacade.SCiPadContactFinanceListViewPR.superclass.EndLife.apply(this, arguments);
                ...
                function CreditHistory_GetRecords() {
                    ...
                    for (var l = 0; l < historyRecordSet.length; l++) {
						...
						/*newRecord+='<td class="SC-CA-TD-AccountNumber">'+historyRecordSet[l]['SC Primary Id Details']+'</td>';
						newRecord+='<td class="SC-CA-TD-AccountNumber">'+historyRecordSet[l]['SC Secondary Id Details']+'</td>';
						newRecord+='<td class="SC-CA-TD-AccountNumber">'+historyRecordSet[l]['SC Primary Applicant Accept']+'</td>';
					    newRecord+='<td class="SC-CA-TD-AccountNumber">'+historyRecordSet[l]['SC Secondary Applicant Accept']+'</td>';
						newRecord+='<td class="SC-CA-TD-AccountNumber">'+historyRecordSet[l]['SC Received Discloser']+'</td>'; */
                        newRecord += '</tr>';
                        recordSet += newRecord;
                    }
                ...
                function submitApplication() {
                    ...
                    setTimeout(function() {
                        ...
                        if (SubmitAppInIO.GetType() == "SubmitNewApplication") {
							...
							var DeviceType = scPrimaryDivType + " - iPad";
						...
						if (BService) {
						  ...
						  ai.errcb = function(){
							  ...
							  SiebelJS.Log("Error while submitting Finance Application");
						  };
						  ai.cb = function(){
							  //Code occurs here for the method that Siebel Open UI runs if the AJAX call is successful
								var outPropSet = arguments[2];
								if (outPropSet != null) {
									wPrimaryOut = outPropSet.GetChildByType('ResultSet');
								}
						  };
						  BService.InvokeMethod("RunProcess", wInput, ai);
						}
                        //BService.InvokeMethod("RunProcess", wInput, wPrimaryOut);
						//var outputProperties = wPrimaryOut.GetChild(0);
						var sApplicationStatus = "",sReturnMessage = "", sFinPartner = "";
						if(wPrimaryOut != null){
							sApplicationStatus = wPrimaryOut.GetProperty("ApplicationStatus");
							sReturnMessage = wPrimaryOut.GetProperty("SubmitStatus");
						}
                        ...
                        do {
							...
							ai.cb = function(){
								...
								if (rFinRecordSet.length >= 1) {
									...
									if(sApplicationStatus == "" || sApplicationStatus == undefined){
										sApplicationStatus = rFinRecordSet[0]["SC Application Status"];
									}
									sFinPartner = rFinRecordSet[0]["SC Account Type"];
									SiebelJS.Log("CurrentId..:" + sCurrentFirstFindId);
									if (sFirstFinId != sCurrentFirstFindId) {
										var sPrimaryId = sSCPrimaryIdType + " : " + sSCPrimaryIdState + " : " + sSCPrimaryIdExpMon + " : " + sSCPrimaryIdExpYear;
										var sSecondaryId = "";
										var sSecondaryAccept = "";
										if (isJointAccount == "Y") {
											sSecondaryId = sSCSecondaryIdType + " : " + sSCSecondaryIdState + " : " + sSCSecondaryIdExpMon + " : " + sSCSecondaryIdExpYear;
											sSecondaryAccept = "Y";
										}
										var scPrimaryDivType = SCOUIMethods.SCGetProfileAttrValue("SC Primary Division Type");
										var DeviceType = scPrimaryDivType + " - iPad";
										var sStoreNumber = SCOUIMethods.SCGetProfileAttrValue("SC Store Number");
										var fieldnames = "SC Primary Id Details,SC Secondary Id Details,SC Received Discloser,SC Primary Applicant Accept,SC Secondary Applicant Accept,SC Fin Device Type,Store Number";
										var fieldvalues = sPrimaryId + "," + sSecondaryId + ",Y,Y," + sSecondaryAccept + "," + DeviceType+","+sStoreNumber;
										...
										do{
											...
											i++;
										}while(rFinRecordSet.length > 1 && rFinRecordSet[i] != undefined && sFirstFinId != rFinRecordSet[i]["Id"]);
										bRecordUpdate = true;
									}
								}
								retry++;
								if(bRecordUpdate || retry == 3){
									...
									$("#SC-Fin-Processing-popup").modal("hide");
									$("#SC-Status-Confirm-popup").modal({
										backdrop: 'static'
									});
									setTimeout(function() {
										//$("#custom-backdrop").hide();
										//$("body").trigger('Custom.End');
										if(sFinPartner == "Synchrony"){
											if(sApplicationStatus != "" || sApplicationStatus != undefined){
												if((sApplicationStatus.toUpperCase() == "APPROVED" || sApplicationStatus.toUpperCase() == "APPROVE") && bRecordUpdate){
													$("#Fin-Status-Text").text("Your application has been approved!\nPlease see the sales associate for the next steps in completing your transaction");
												}else if ((sApplicationStatus.toUpperCase() == "DECLINED" || sApplicationStatus.toUpperCase() == "DECLINE")&& bRecordUpdate){
													$("#Fin-Status-Text").text("Synchrony Bank is unable to approve your application at this time.  You will receive a written explanation in the mail within 7-10 days regarding the reasons for the decision and the source of the information utilized.  It will include a number for you to call if you have questions.\nPlease see sales associate for next steps.");
												}else{
													$("#Fin-Status-Text").text("Please see the sales associate for the next steps in completing your transaction");
												}
											}else{
												$("#Fin-Status-Text").text("Please see the sales associate for the next steps in completing your transaction");
											}
											...
											if(sApplicationStatus != "" || sApplicationStatus != undefined){
												if((sApplicationStatus.toUpperCase() == "APPROVED" || sApplicationStatus.toUpperCase() == "APPROVE") && bRecordUpdate){
													$("#Fin-Status-Text").text("Congratulations! Your application has been approved by Vive Financial.");
												}else if((sApplicationStatus.toUpperCase() == "DECLINED" || sApplicationStatus.toUpperCase() == "DECLINE")&& bRecordUpdate){
													$("#Fin-Status-Text").text("An Approval could not be obtained at this time.  You will receive a letter in 10-15 days from Vive Financial.");
												}else{
													$("#Fin-Status-Text").text("Additional time is needed to process your application for credit, please call Vive Financial at 800-548-5545 for additional information.");
												}
											}else{
												$("#Fin-Status-Text").text("Additional time is needed to process your application for credit, please call Vive Financial at 800-548-5545 for additional information.");
											}
										}
										$(document).on("click","#SC-Status-Confirm-okay", function(){
										   $("#SC-Status-Confirm-popup").hide(); 
										   $("#SC-Control-BackToRep-popup").modal({
												backdrop: 'static'
										   });
										});
                ...
                return SCiPadContactFinanceListViewPR;
            }());
            return "SiebelAppFacade.SCiPadContactFinanceListViewPR";
        })
}