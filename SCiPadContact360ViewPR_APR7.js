...
if (typeof(SiebelAppFacade.SCiPadContact360ViewPR) === "undefined") {
 ...
 define("siebel/custom/SelectComfort/SCiPadContact360ViewPR", ["siebel/viewpr","siebel/custom/SelectComfort/bootstrap.min","siebel/custom/SelectComfort/jquery.validate.min","siebel/custom/SelectComfort/moment","siebel/custom/SelectComfort/moment-timezone-with-data.min","siebel/custom/SelectComfort/SCContact360Markup","siebel/custom/SelectComfort/SCiPadCreateContactMarkup","siebel/custom/SelectComfort/SCiPadCreateContactFunctionality","siebel/custom/SelectComfort/SCErrorCodes","siebel/custom/SelectComfort/SC_OUI_Markups","siebel/custom/SelectComfort/SC_OUI_Methods","siebel/custom/SelectComfort/SC_OUI_Definitions"],
  function () {
   SiebelAppFacade.SCiPadContact360ViewPR = (function () {
	   //Start -- Variable declaration
			...
			var divisions = {"Cust-Details-Pin":"Cust-Details-Applet","Con-Info-Pin":"Con-Info-Applet","Cust-inter-Pin":"Cust-inter-Applet","Prof-Info-Pin":"Prof-Info-Applet","Cons-Notes-Pin":"Cons-Notes-Applet","Assets-Pin":"Assets-Applet","Orders-Pin":"Orders-Applet","Oppor-Pin":"Oppor-Applet","SR-Pin":"SR-Applet","Activities-Pin":"Activities-Applet","Inn-Circle-Pin":"Inn-Circle-Applet","Item-lookup-Pin":"Item-lookup-Applet"};
			var appletNames = {"Cust-Details-Pin":"Cust-Details","Con-Info-Pin":"Cont-Info","Cust-inter-Pin":"Cust-Interacion","Prof-Info-Pin":"prof-Info","Cons-Notes-Pin":"Cons-Notes","Assets-Pin":"Assets","Orders-Pin":"Orders","Oppor-Pin":"Opportunity","SR-Pin":"Serv-Req","Activities-Pin":"Activities","Inn-Circle-Pin":"Inn-Circle","Item-lookup-Pin":"item-lookup"};
			var pinids= [];
			...
			var comments_Activities=true,status_Activities=true,type_Activities=true,desc_Activities=true,subChannel_Activities=true,created_Activities=true,owner_Activities=true,startDt_Activities=true,sr_Activities=true,activity_Activities=true,activity_rsn1=true,activity_rsn2=true;
			var toolbarflag = "N";
		...
		SCiPadContact360ViewPR.prototype.ShowUI = function () {
			...
			//Start: Appending contact 360 markup
				...
				$('#SC-360-SalesOrder').css({"font-size":"13px"});
		...
		SCiPadContact360ViewPR.prototype.BindData = function (bRefresh) {
			...
			setProfName += '<p class="SC-360-profile-name community-name no-margin">'+ConFormApp_RS[0]["Community"]+'</p>';
			...
			var custDetails_Markup = Contact360Markup.CustomerDetailsMarkupFn(ConFormApp_RS,Order_RS,isiFitRecord);
			...
			if(isiFitRecord != "Y"){
				...
				var activities_markup = Contact360Markup.ActivityMarkupFn();
				 ...
				 $(document).ready(function () {
				 	...
				 	$(document).on('click', "#SC-360-customer-details-edit", function () {
						...
						$('#cd-Partner-Sleep-Number-div').html(lovValue);
				 		...
				 		//SiebelJS.Log("lovArray::"+lovArray);
				 		lovValue += '  <label class="SC-360-item-label no-margin">Blacklisted Reason:</label>';
				 			...
				 			submitHandler: function (form) {
							  ...
							  setTimeout(function() {
							   ...
							   $(".SC-360-cd").removeClass('add-pointer-events');
								...
								custDetails_Markup = '';
								 custDetails_Markup+='  <label class="SC-360-item-label no-margin">Blacklisted Reason:</label>';
							  ...
							  //Added by SJAKKIDI to display community name
								setProfName += '<p class="SC-360-profile-name community-name no-margin">'+newSetAfterCommit[0]["Community"]+'</p>';
								$(".SC-360-profile-name").html(setProfName);
				 				// End-- profile-name mark up
				 	...
				 	$("#sc-create-activity").validate({
						...
						submitHandler: function (form) {
							...
							setTimeout(function(){
								...
								//added for  iPad
							   var date_string = moment(conStartDate, "YYYY-MM-DD").format("MM/DD/YYYY HH:mm:ss");
								var Act_inPS = '';
				 		...
				 		if (divElement.style.display == "block") {
				 			...
				 			if (id_clicked == 'Cust-inter-Pin') {
								...
								$("#sc-c-create-Activity-btn").attr("src", "images/custom/plus_circle_inactive.png");
				 				...
				 				$("#Campaigns-Img").attr("src", "images/custom/lookup_grey.png");
				 			} else {}
							...
							$("#" + appletName).addClass("active");
				 			...
				 			if (id_clicked == 'Cust-inter-Pin') {
								...
								$("#sc-c-create-Activity-btn").attr("src", "images/custom/plus_circle.png");
				 				...
				 				$("#Campaigns-Img").attr("src", "images/custom/lookup_blue.png");
				 			} else {}
	   ...
	   $(document).on("click",".glyphicon-minus-sign",function(e){
		   ...
		   $(this).removeClass("glyphicon-minus-sign");  
			...
			$(document).on("click",".phone-icon",function(e){
				...
				$("[aria-describedby='comm_makecall_popup']").css({"top":$(this).context.y,"left":$(this).context.x});
		...
		//Start: -- Functions to get latest information from applets
				...
				function SR_GetRecords() {
					...
					for (var sr = 0; sr < conrcdLen; sr++) {
						...
						sr_new += '<td>' + SR_RS[sr]["SC HD Delivery Date"] + '</td>';
				...
				function campaigns_GetRecords() {
					...
					for (var camp = 0; camp < conrcdLen; camp++) {
						...
						activecampaigns_new += '<td>' + Campaigns_RS[camp]["Name"] + '</td>';
						activecampaigns_new += '<td>' + Campaigns_RS[camp]["Promotion Information"] + '</td>';
						...
						inactivecampaigns_new += '<td>' + Campaigns_RS[camp]["Name"] + '</td>';
						inactivecampaigns_new += '<td>' + Campaigns_RS[camp]["Promotion Information"] + '</td>';
