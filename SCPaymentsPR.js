  ...
  define("siebel/custom/SelectComfort/SCPaymentsPR", ["siebel/jqgridrenderer", "siebel/custom/SelectComfort/SCPaymentsMarkup", "siebel/custom/SelectComfort/bootstrap.min.js", "siebel/custom/SelectComfort/jquery.validate.min", "siebel/custom/SelectComfort/SC_OUI_Methods", "siebel/custom/SelectComfort/SC_OUI_Definitions", "siebel/custom/SelectComfort/SC_OUI_Markups", "siebel/custom/SelectComfort/SCErrorCodes"],
    function () {
      SiebelAppFacade.SCPaymentsPR = (function () {
        ...
        var refreshAllApplets = "",
          sPayRowID = ""; //19Nov2024

        var MKESwitchFlag = theApplication().GetProfileAttr("MKESwitchFlag");
        var PayByLinkFlag = theApplication().GetProfileAttr("PayByLinkFlag"); //LikhithaK:11Apr2025:SFSTRY0003466
        var sChatUserFlg = theApplication().GetProfileAttr("SC Chat User"); //likhithaK:30Oct2025:Added as part of EP-232
        ...
        SCPaymentsPR.prototype.Init = function () {
          ...
          poleDisplayFlg = SiebelApp.S_App.GetProfileAttr('PoleDisplayOUI');
        ...
        SCPaymentsPR.prototype.ShowUI = function () {
          ...
          //LikhithaK:03Mar2025:Start:US#SFSTRY0003418:Added as part of Billing Address Dropdown
          if (sAccOrder != "Y") {
            var NewBillingAddrCreation = SCPaymentMarkup.NewBillingAddr();
            $("#new-bill-addr").html(NewBillingAddrCreation);
          }
          //LikhithaK:03Mar2025:End:US#SFSTRY0003418:Added as part of Billing Address Dropdown
          ...
          city = orderBC.GetFieldValue("Primary Bill To City"); //Likhithak:23/1/2025:To add city name in the address on payments page
          ...
          var email = orderBC.GetFieldValue("Primary Bill To Email Address"); //LikhithaK:SFSTRY0003475
          ...
          //LikhithaK:Start:SFSTRY0003475
          if (email != "" && email != null) {
            $("#S-Email").text(email);
          } else {
            $("#S-Email").text('');
          }
          //LikhithaK:End:SFSTRY0003475
          if (sAccOrder == "Y") { //LikhithaK:03Mar2025:US#SFSTRY0003418:Added if condition as part of Billing Address Dropdown
            //Likhithak:Start:23/1/2025:To add city name in the address on payments page
            if (city.length != 0) {
              address = address + ', ' + city;
            }
            //Likhithak:End:23/1/2025:To add city name in the address on payments page
            if (state.length != 0) {
          ...
          if (OnlyBedding == "No") {
            ...
            $("#OnlyBedding").hide();
            $("#OnlyBedding1").hide();
            $(".sc-onlybedding-yes").hide();
            $(".sc-onlybedding-no").hide();
          }
          // Sukumar
          var inPS = SiebelApp.S_App.NewPropertySet();
          var outPS = SiebelApp.S_App.NewPropertySet();
            ...
            if (((currentItemId == "financing-payment") && (isFinancing == "Y")) || ($("#financing-payment").hasClass("p-item-active") && $("#SC-finance-payment").text() != "Select" && $("#financeaccountnumber").val() == "")) {
              ...
              if (canNewRecord) {
                ...
                if (this.id == "credit-card-paymnet") {
                  //LikhithaK:13May2025:Start:SFSTRY0003466
                  var PayByLinkFlag = theApplication().GetProfileAttr("PayByLinkFlag"); //LikhithaK:11Apr2025:SFSTRY0003466
                  if (PayByLinkFlag == "Y") {
                    var sPBLPaymentLink = paymentBC.GetFieldValue("SC Payment Link");
                    var sPBLCaptureStatus = paymentBC.GetFieldValue("SC Semaphone Capture Status");
                    var sPBLSMS = paymentBC.GetFieldValue("PBL SMS Flg");
                    var sPBLEmail = paymentBC.GetFieldValue("PBL Email Flg");
                    var sPBLAmount = paymentBC.GetFieldValue("Transaction Amount");
                    $("#Payment-Link-CC").val(sPBLPaymentLink);
                    $("#CreditCapt-Status").val(sPBLCaptureStatus);
                    if (sPBLSMS == "Y") {
                      $("#SMS_PBL").prop("checked", true);
                    }
                    if (sPBLEmail == "Y") {
                      $("#Email_PBL").prop("checked", true);
                    }
                    $("#creditPaymentDue").val(sPBLAmount);
                    if (newRecord) {
                      $("#SMS_PBL").prop("checked", false);
                      $("#Email_PBL").prop("checked", false);
                    }
                  }
                  //LikhithaK:13May2025:End:SFSTRY0003466
                  ...
                  if (sVoiceUser == "Y" && SiebelApp.S_App.GetProfileAttr("SycVoiceUserFlg") == "Y") {
                  ...
                  //LikhithaK:11Apr2025:SFSTRY0003466
                  var PayByLinkFlag = theApplication().GetProfileAttr("PayByLinkFlag");
                  //var sIsPhoneOrder = localStorage.getItem("isPhoneOrder");
                  /*var sOrderId = orderBC.GetFieldValue("Id"); //LikhithaK:07Oct2025:Commented as part of EP-193
                  ...
                  if (PayByLinkFlag == "Y" && (MKESwitchFlag == "N" || sChatUserFlg == "Y") && sPayStatus == "Entered" && sPayLink != null && sPayLink != "") {
                    //Added sChatUserFlag in the condition as part of EP-232 to enable PBL for Chat User
                    //LikhithaK:27Oct2025:Start:Added if else part for EP-238
                    if (paymentBC.GetFieldValue("SC Semaphone Capture Status") == "Link Sent") {
                      $("#SC-CreditCard-ResendPBL").removeClass("SC-disabled");
                    } else {
                      $("#SC-CreditCard-ResendPBL").addClass("SC-disabled");
                    }
                    //LikhithaK:27Oct2025:End:Added if else part for EP-238
                    $("#SC-CreditCard").addClass("SC-disabled");
                    $("#SC-CreditCard-PBL").addClass("SC-disabled");
                    $("#creditPaymentDue").prop('readonly', true);
                    $("#SMS_PBL").prop('disabled', true);
                    $("#Email_PBL").prop('disabled', true);
                  } else if (PayByLinkFlag == "Y" && (MKESwitchFlag == "N" || sChatUserFlg == "Y") && sPayStatus == "Entered" && (sPayLink == null || sPayLink == "")) {
                    //Added sChatUserFlag in the condition as part of EP-232 to enable PBL for Chat User
                    $("#SC-CreditCard-ResendPBL").addClass("SC-disabled"); //LikhithaK:27Oct2025:Added as part of EP-238
                    $("#SMS_PBL").prop('disabled', false);
                    $("#Email_PBL").prop('disabled', false);
                    var emailChecked = $('#Email_PBL').is(':checked');
                    var textChecked = $('#SMS_PBL').is(':checked');

                    if ((emailChecked || textChecked) && ($("#creditPaymentDue").val() != "" && $("#creditPaymentDue").val() != null && $("#creditPaymentDue").val() != 0)) {
                      $('#SC-CreditCard-PBL').removeClass('SC-disabled');
                      $('#SC-CreditCard').addClass('SC-disabled');
                    } else {
                      if ($("#creditPaymentDue").val() == 0 && (emailChecked || textChecked)) {
                  ...
                  if ((sVoiceUser == "Y" || sVoiceStoreUser == "Y") && (SiebelApp.S_App.GetProfileAttr("SycVoiceUserFlg") != "Y")) {
                    ...
                    if (sAccountNumber.length == 0 && paymentBC.GetFieldValue("SC Payment Status") == "Entered") {
                      ...
                      if (write) {
                        ...
                        //AKUTPX: 05152025:  Adding below code to log the request payload
                        var ipPS = SiebelApp.S_App.NewPropertySet();
                        var opPS = SiebelApp.S_App.NewPropertySet();
                        ipPS.SetProperty("ProcessName", "SC Capture Error Workflow");
                        ipPS.SetProperty("SC Error Type", "Voice IFrame Request");
                        ipPS.SetProperty("SC Description", sPage);
                        ipPS.SetProperty("SC Sub Task ID", sPaymentRecordId);
                        var Custom_Service = SiebelApp.S_App.GetService("Workflow Process Manager");
                        opPS = Custom_Service.InvokeMethod("RunProcess", ipPS);
                        //AKUTPX: 05152025:  Adding below code to log the request payload
                        ...
                        if (sPage.length > 0) {
                          ...
                          var cclistner = function (event) {
                            ...
                            try {
                              ...
                              var opPS = SiebelApp.S_App.NewPropertySet();
                              ipPS.SetProperty("ProcessName", "SC Capture Error Workflow");
                              ipPS.SetProperty("SC Error Type", "Semaphone Response");
                              ipPS.SetProperty("SC Description", data);
                              ipPS.SetProperty("SC Sub Task ID", sPaymentRecordId);
                              var Custom_Service = SiebelApp.S_App.GetService("Workflow Process Manager");
                              opPS = Custom_Service.InvokeMethod("RunProcess", ipPS);
                              //AKUTPX: 05152025:  Adding below code to log the request payload
                ...
                if (this.id == "check-payment") {
                  ...
                  if (paySCStoreUser != "Y" && orderBC.GetFieldValue("SC Payment Admin Responsbility") == "N") {
                    ...
                    //LikhithaK:05Nov2024: Added for Check DF-1659:Start
                    if (newRecord) {
                      ...
                      var sRoutingNum = pm.Get("TransitRoutingNumber");
                      var sAccountNum = pm.Get("CheckAccountNumber");
                      var sManualCheckNum = pm.Get("ManualCheckNumber");
                      var sDOB = pm.Get("CheckDOB");
                      var sDL = pm.Get("IDNumber");
                      var sDLState = pm.Get("IDTypeCode");

                      $("#bankaccountnumber").val(sAccountNum);
                      $("#checknumber").val(sManualCheckNum);
                      $("#bankrouting").val(sRoutingNum);
                      $("#DOBVALUE").val(sDOB);
                      $("#driverlicence").val(sDL);
                      $("#driverlicencedate").val(sDLState);
                      // $("#checkPaymentDue").val("pm.Get("CheckAmount")");
                    }
                    //LikhithaK:05Nov2024: Added for Check DF-1659:Start
                ...
                if (this.id == "financing-payment") {
                  if (GiftCardCount > 0) {
                    ...
                    maskLastFour('#financeaccountnumber'); //Sukumar
                    ...
                    if (paymentGroup == "SYNCHRONY") {
                      ...
                      //Sukumar 
                      SC_FINANCEACCNUMBERLEN = "CVV2 Number Should be 3 digits";
                      $("#financecvv").rules("add", {
                        minlength: 3,
                        maxlength: 3,
                        messages: {
                          minlength: "CVV2 Number Should be 3 digits",
                          maxlength: "Cvv2 Number Should be 3 digits"
                        }
                      });
                      $("#financecvv").attr("maxlength", "3");
                      $("#financecvv").on("input", function () {
                ...
                if (this.id == "reward-payment") {
                  ...
                  //$("#sc-reward-type-input").focus(); //LikhithaK:01Apr2025:SFSTRY0003430:Commented
                  if (failedpaymentselected)
                  ...
                  if (id == "SC-finance-payment") {
                    ...
                    setTimeout(function () {
                      ...
                      if (paymentGroup == "SYNCHRONY") {
                        ...
                        if ($("#financecvv").val().length != 3) {
                          $("#financecvv").trigger("keyup");
                        }
                        $("#financecvv").attr("maxlength", "3");
                        $("#financecvv").on("input", function () {
                          if (this.value.length > 3) {
          ...
          function maskLastFour(input) {
            ...
            value = $input.val().replace(/\D/g, ''); // Remove non-digits
            ...
            if (value.length > 4) {
              ...
              localStorage.setItem('financeaccountnumber', value);
              $input.val(masked + lastFour);

            }

          }
          $(document).on('keypress', '#financecvv', function (e) {
          ...
          $(document).ready(function () {
            const $financeInput = $('#financeaccountnumber');
            // Only call if not empty and not already masked
            if ($financeInput.val() && !$financeInput.val().includes('•')) {
              maskLastFour($financeInput);
            }
          });
          $(document).on("change", "#financeaccountnumber", function () {

            // Sukumar 04/02 mask Account Number

            // Function to mask all but last 4 characters

            // Check and load stored value on page load

            const currentValue = $(this).val().replace(/\D/g, '');

            const storedValue = localStorage.getItem('financeaccountnumber');

            // Only store if not masked and value has changed

            if (storedValue && !$(this).val().includes('•') && currentValue !== storedValue.replace(/\D/g, '')) {

              localStorage.setItem('financeaccountnumber', currentValue);
          ...
          $(document).on("change", "#Creditcard-Number,#creditCVV,#creditExpM,#creditExpY,#creditPaymentDue", function () {
            if (!$('#Creditcard-Number').is('[readonly]')) {
              if (P2PEFlag != "Y" && sVoiceUser != "Y" && sChatUser != "Y") {
                ...
                BS_Data = JSON.parse(BS_Data);
                var sIsPhoneOrder = BS_Data["SC Phone Order Flag"];*/
                if ((MKESwitchFlag == "N" || sChatUserFlg == "Y") && PayByLinkFlag == "Y") { //Added sChatUserFlag in the condition as part of EP-232 to enable PBL for Chat User
                  var emailChecked = $('#Email_PBL').is(':checked');
                  var textChecked = $('#SMS_PBL').is(':checked');
          ...
          $(document).on("click", "#Sc-Editorder-payments", function () {
            clearInterval(pblGetAccount); //LikhithaK:EP-177:Added as part of PBL Userstory
            //AKSHAY: Added below code for Terminal CR.
            if (sFeatureFlag == "Y" && poleDisplayFlg == "N") {
            ...
            submitHandler: function (form) {
              ...
              setTimeout(function () {
                ...
                if (paymentStatus != "Authorized" && paymentStatus != "Entered") {
                  ...
                  inPS = SiebelApp.S_App.NewPropertySet();
                  outPS = SiebelApp.S_App.NewPropertySet();
                  inPS.SetProperty("Name", "SCSyncCVV2");
                  inPS.SetProperty("Value", financecvv);
                  Bservice = SiebelApp.S_App.GetService("SessionAccessService");
                  outPS = Bservice.InvokeMethod("SetProfileAttr", inPS);

                  if (finAuthCode != null && finAuthCode != undefined && finAuthCode != "") {
                    var accountNumber = localStorage.getItem('financeaccountnumber'); //$("#financeaccountnumber").val();
                    var financePaymentDue = $("#financePaymentDue").val();
                    SiebelApp.S_App.GetActiveView().SetActiveApplet(SiebelApp.S_App.GetActiveView().GetAppletMap()[appletName]);
                  ...
                  var adminMode = paymentBC.InvokeMethod("SetAdminMode", true);
                  paymentBC.SetFieldValue("Account Number", accountNumber);
                  paymentBC.SetFieldValue("SC CVV Finance", financecvv);
                  SiebelJS.Log("Account Number.. SK:" + accountNumber);
                  ...
                  if (write) {
                    ...
                    if (caninvoke) {
                      ...
                      pm.ExecuteMethod("InvokeMethod", "Authorize", null, false);
                      localStorage.setItem('financeaccountnumber', '');
                    } else {
                      $("#unatuhOk").click(function () {
                        $("#SC-CalFreigthMsg").modal('hide');
                      });
          ...
          $("#sc-check-Details").validate({
            ...
            submitHandler: function (form) {
              ...
              setTimeout(function () {
                ...
                if (caninvoke) {
                  if (paySCStoreUser == 'Y') {
                    ...
                    if ($("#SC-check-payment").text() == "CC") {
                      ...
                      var sObjectId = paymentBC.GetFieldValue("Id"); //LikhithaK:18Oct2024:added for Check DF-1659
                ...
                newRecord = false;
                notCommited = false;
                //LikhithaK:18Oct2024: added for Check DF-1659:Start
                var inPS = SiebelApp.S_App.NewPropertySet();
                var outPS = SiebelApp.S_App.NewPropertySet();
                var bService = "";
                inPS.SetProperty("Object Id", sObjectId);
                SiebelJS.Log("Invoking Business Service");
                bService = SiebelApp.S_App.GetService("SC Adyen Payment Service"); //get service
                outPS = bService.InvokeMethod("FetchPayStatus", inPS); //invoke the method
                var PaytStatus = outPS.GetChild(0).GetProperty("PayStatus");
                var sPayMethod = paymentBC.GetFieldValue("Payment Method");
                //LikhithaK:18Oct2024: added for Check DF-1659:End
                if (sPayMethod == "Check" && PaytStatus == "Entered") {
                  //LikhithaK:18Oct2024: If condition added for Check DF-1659
                  $(".active-tab").each(function () {
              ...
              if ((sVoiceUser == "Y" || (isPhoneOrder == "Y" && MKESwitchFlag != "Y")) && (SiebelApp.S_App.GetProfileAttr("SycVoiceUserFlg") == "Y")) {
                  ...
                  if (write) {
                    ...
                    if (sPage.length > 0) {
                      ...
                      if (Add_Params == "Y") {
                        ...
                        if (ShipCountry == 'USA') {
                          ShipCountry = 'US';
                        } else if (ShipCountry == 'CANADA') { //LikhithaK:01Apr2025:SFSTRY0003458:Added else if.
                          ShipCountry = 'CA';
                        }
                      ...
                      if (isPhoneOrder == "Y") {
                        ...
                        var storeNumberid = SCOUIMethods.SCGetProfileAttrValue('SC Store Number');
                        var metastoreid = "&metaData=%7B%22storeId%22%3A%22" + storeNumberid + "%22%7D";
                        sPage = sPagePart3 + Retail_moto1 + Retail_moto2 + sPagePart4 + metastoreid;
                      ...
                      var opPS = SiebelApp.S_App.NewPropertySet();
                      ipPS.SetProperty("ProcessName", "SC Capture Error Workflow");
                      ipPS.SetProperty("SC Error Type", "Adyen Voice IFrame Request");
                      ipPS.SetProperty("SC Description", sPage);
                      ipPS.SetProperty("SC Sub Task ID", sPaymentRecordId);
                      var Custom_Service = SiebelApp.S_App.GetService("Workflow Process Manager");
                      opPS = Custom_Service.InvokeMethod("RunProcess", ipPS);
                ...
                setTimeout(function () {
                  ...
                  if (paymentStatus == "Need Verbal Authorization" && P2PEFlag != "Y") {
                    ...
                    if (sSycChatFlg == "Y" && sChatUser == "Y") {
                      ...
                      if (canWrite) {
                        ...
                        if (sPaymentLink == "") {
                          $("#creditPaymentDue").prop('readonly', false);
                          var sPaymentRecordId = paymentBC.GetFieldValue("Id");
                          sPayRowID = paymentBC.GetFieldValue("Id"); //19Nov2024
                          var orderId = orderBC.GetFieldValue("Id");
                      ...
                      getChatCCAccountNumInterval = setInterval(getChatCCAccountNum, 10000);
                      // refreshAllApplets = setInterval(refreshAllAppletsSycDigital, 2000); //19Nov2024
                    }
                    ...
                    //LikhithaK:Start:SFSTRY0003492
                    var sPayMeth = paymentBC.GetFieldValue("Payment Method");
                    var sRestrictCCReq = SiebelApp.S_App.GetProfileAttr('RestrictCCReq');
                    if (sRestrictCCReq == "Y" && sPayMeth == "Credit Card" && P2PEFlag == "Y") {
                      caninvoke = false;
                    }
                    //LikhithaK:End:SFSTRY0003492

                    SiebelJS.Log("CanInvoke of Auth..:" + caninvoke);
                    if (caninvoke) {

                      //LikhithaK:Start:SFSTRY0003492
                      if (sPayMeth == "Credit Card" && P2PEFlag == "Y") {
                        var vBservice = SiebelApp.S_App.GetService("SessionAccessService");
                        var vinPS = SiebelApp.S_App.NewPropertySet();
                        var voutPS = SiebelApp.S_App.NewPropertySet();
                        vinPS.SetProperty('Name', 'RestrictCCReq');
                        vinPS.SetProperty('Value', 'Y');
                        if (vBservice) {
                          voutPS = vBservice.InvokeMethod("SetProfileAttr", vinPS);
                        }
                      }
                  ...
                  newRecord = false;
                  var sSycChatFlg = theApplication().GetProfileAttr("SycChatUserFlg");
                  if (sChatUser == "Y" && sSycChatFlg == "Y") {} else {
                    $(".active-tab").each(function () {
                      $('#' + this.id).removeClass("active-tab");
                    });
                  }
                  ...
                  var paymentCheck = setInterval(function () {
                    ...
                    } else if (sChatUser == "Y" && sSycChatFlg == "Y" && sPayMethod == "Credit Card" && sPayStatus != "Entered") {
                      $(".active-tab").each(function () {
                        $('#' + this.id).removeClass("active-tab");
                        $("#SC-CreditCard").addClass("SC-disabled");
          ...
          $(document).on('click', '#SC-generate-customer-receipt-Yes', function () {
            $("#SC-SO-customer-receipt").modal('hide');
            $("#SC-SO-order-complete").modal('hide');
            $("#SC-SO-order-complete").css({
              "display": "",
            ...
            SiebelJS.Log("before generate receipt SC-generate-customer-receipt-Yes");
            sPrintOne = "Yes";
            generate_receipt("Customer");
            SiebelJS.Log("After generate receipt customer-receipt-Yes");
            //Sukumar 0213 : Email
            if (sFeatureFlag == "Y") {
              var sOrderId = orderBC.GetFieldValue("Id");
              var sbilltocontactId = orderBC.GetFieldValue("Bill To Contact Id");
                        ...
                        setTimeout(function () {
                          ...
                          setTimeout(function () {
                            ...
                            if (paySCStoreUser == 'Y') {
                              ...
                              //Sukumar Added to print only once when OnlyBedding
                              SiebelJS.Log("generate receipt paySCStoreUser" + paySCStoreUser);
                              SiebelJS.Log("generate receipt sFeatureFlag ,SC_reportName" + sFeatureFlag + SC_reportName);
                              if (sFeatureFlag == "Y" && receipt_mode == "Customer" && OnlyBedding == "No" && sPrintOne == "Yes") {
                                SiebelJS.Log("OnlyBedding");
                                //SiebelApp.S_App.GetActiveView().GetAppletMap()["SC Sales Order Entry Form Applet OUI"].GetBusComp().SetFieldValue("SC Customer One Print Only", "Yes");
                                //SiebelApp.S_App.GetActiveView().GetAppletMap()["SC Sales Order Entry Form Applet OUI"].InvokeMethod("WriteRecord");


                                if (sPrintOne == "Yes") {
                                  SiebelJS.Log("OnlyBedding Only One generate receipt");
                                  var inUpdPS = SiebelApp.S_App.NewPropertySet();
                                  var outUpdPS = SiebelApp.S_App.NewPropertySet();
                                  var bUpdService = "";
                                  inUpdPS.SetProperty("OrderId", orderId);
                                  SiebelJS.Log("Invoking Business Service UpdRec");
                                  bUpdService = SiebelApp.S_App.GetService("SC Get Line Items"); //get service
                                  bUpdService.InvokeMethod("UpdateRec", inUpdPS); //invoke the method															
                                }

                                sPrintOne = "No"
                                autoPrint(SC_reportName);

                              } else if (sFeatureFlag == "Y" && receipt_mode == "Customer") {

                                SiebelJS.Log("generate receipt 2");
                                autoPrint(SC_reportName);
                                autoPrint(SC_reportName);
                              } else {
                                if (P2PEFlag == "Y") {
                                  SiebelJS.Log("generate receipt P2PEFlag" + P2PEFlag);
                                  autoPrint(SC_reportName);
                                } else {
                                  SiebelJS.Log("generate receipt Final");
                                  if (sPrintOne == "Yes") {
                                    var inUpdPS = SiebelApp.S_App.NewPropertySet();
                                    var outUpdPS = SiebelApp.S_App.NewPropertySet();
                                    var bUpdService = "";
          ...
          $("#SC-complete").click(function () {
            ...
            localStorage.setItem('PoleDisplayConfBypass', 'N'); //LikhithaK:04Apr2025:SFSTRY0003441
          });
          ...
          $(document).on("click", "#SC-yes-button", function () {
            ...
            setTimeout(function () {
              ...
              //22Sep25;SL;START-Commented code below & added new code for SAL-734
              ...
              var sOrderId = orderBC.GetFieldValue("Id");
              var fieldvalues = "Quote Cancelled";
              var fieldnames = "Status";
              var Bservice = '',
                inPS = '',
                outPS = '';
              ...
              outPS = Bservice.InvokeMethod("Insert", inPS);
              SiebelApp.S_App.GetActiveView().GetAppletMap()["SC Sales Order Entry Form Applet OUI"].InvokeMethod("RefreshBusComp");
              //22Sep25;SL;END-Commented code below & added new code for SAL-734
          ...
          //Start:Greyout issue - PROD FIX
          var sOverlayRemove = localStorage.getItem("OverlayRemoval");
          if (sOverlayRemove == "Y") {
            setTimeout(function () {
              $('body').removeClass('modal-open');
              $('.modal-backdrop').remove();
              localStorage.setItem("OverlayRemoval", "N");
              //var sGreyout=localStorage.getItem("OverlayRemoval");
            }, 1500);
          }
          //End:Greyout issue - PROD FIX
          //LikhithaK:03Mar2025:Start:US#SFSTRY0003418:Added as part of Billing Address Dropdown
          var scbilladdrDropdown = "N";
          //to make bill to address as a dropdown
          $(document).on("click", "#bill-address-new", function () {
            if (sAccOrder != "Y") {
              if (scbilladdrDropdown == 'N') {
                $("#bill-address-new").html(AttachBillingAddresses());
                scbilladdrDropdown = "Y";
              }
            }
          });
          ...
          //Added for making Billing dropdown readonly during Order revision.
          if (sAccOrder != "Y") {
            var RecordSetd = SiebelApp.S_App.GetActiveView().GetAppletMap()["SC Sales Order Entry Form Applet OUI"].GetPModel().Get("GetRecordSet");
            var sRevisionNum = RecordSetd[0]["Revision"];
            if (sRevisionNum > 1) {
              $("#bill-address-new").addClass('read-mode');
              $("#bill-address-new").css({
                "pointer-events": 'none',
              });
            } else {
              $("#bill-address-new").removeClass('read-mode');
              $("#bill-address-new").css({
                "pointer-events": 'all',
              });
            }
          ...
          //LikhithaK:24Oct2025:EP-238:Start:Resend Payment Link button code starts
          $(document).on("click", "#SC-CreditCard-ResendPBL", function () {
            console.log("Pay By Link Resend button triggered");
            var sPayId = paymentBC.GetFieldValue("Id");
            var Bservice = '',
              inPS = '',
              outPS = '';
            inPS = SiebelApp.S_App.NewPropertySet();
            outPS = SiebelApp.S_App.NewPropertySet();
            inPS.SetProperty("Object Id", sPayId);
            inPS.SetProperty("ProcessName", "SC Adyen PBL Resend WF");
            Bservice = SiebelApp.S_App.GetService("Workflow Process Manager");
            outPS = Bservice.InvokeMethod("RunProcess", inPS);
            $("#SC-CreditCard-ResendPBL").addClass("SC-disabled");
            var maxTimeLimit = 0;
            pblGetStatus = setInterval(function () {
              var sPayStat = paymentBC.GetFieldValue("SC Payment Status");
              var sPayLinkStat = paymentBC.GetFieldValue("SC Semaphone Capture Status");
              $("#CreditCapt-Status").val(sPayLinkStat);
              if (sPayLinkStat == "Link Resent" || sPayStat != "Entered") {
                setTimeout(function () {
                  $(".active-tab").each(function () {
                    $('#' + this.id).removeClass("active-tab");
                  });
                  ...
                  Refreshservice = SiebelApp.S_App.GetService("FINS Teller UI Navigation");
                  RefreshoutPS = Refreshservice.InvokeMethod("RefreshCurrentApplet", RefreshinPS);
                  clearInterval(pblGetStatus);
                }, 10);
              } else {
                if (maxTimeLimit >= 20) { //2min
                  clearInterval(pblGetStatus);
                }
                SiebelApp.S_App.GetActiveView().GetAppletMap()[appletName].InvokeMethod("RefreshRecord");
                maxTimeLimit += 1;
          ...
          //LikhithaK:24Oct2025:EP-238:End:Resend Payment Link button code ends

          //LikhithaK:25July2025:SFSTRY0003466:Start:Send Payment Link button code starts
          $(document).on("click", "#SC-CreditCard-PBL", function () {
            ...
            if (canWrite) {
              ...
              if (sPBLPaymentLink == "") {
                $("#creditPaymentDue").prop('readonly', false);
                var sPBLPaymentRecordId = paymentBC.GetFieldValue("Id");
                var sOrderId = orderBC.GetFieldValue("Id");
                var sPBLRequestedAmount = $('#creditPaymentDue').val();
                if (sPBLRequestedAmount != "" && sPBLRequestedAmount != null) {
                  sPBLAmount = $('#creditPaymentDue').val();
                }
                var sPBLEmailChecked = $('#Email_PBL').is(':checked');
                if (sPBLEmailChecked == true) {
                  sPBLEmail = "Y";
                } else {
                  sPBLEmail = "N";
                }
                var sPBLTextChecked = $('#SMS_PBL').is(':checked');
                if (sPBLTextChecked == true) {
                  sPBLSMS = "Y";
                } else {
                  sPBLSMS = "N";
                }
                ...
                inPS.SetProperty("Payment Id", sPBLPaymentRecordId);
                inPS.SetProperty("SMSFlag", sPBLSMS);
                inPS.SetProperty("EmailFlag", sPBLEmail);
                inPS.SetProperty("TransactionAmount", sPBLAmount);
                inPS.SetProperty("OrderType", "Sales");
                inPS.SetProperty("ProcessName", "SC Adyen Get And Send Pay By Link WF");
                Bservice = SiebelApp.S_App.GetService("Workflow Process Manager");
                outPS = Bservice.InvokeMethod("RunProcess", inPS);
                var sPBLPaymentLink = outPS.GetChild(0).GetProperty('link');
                $("#Payment-Link-CC").val(sPBLPaymentLink);
                SiebelApp.S_App.GetActiveView().GetAppletMap()[appletName].InvokeMethod("RefreshRecord");
                var sPBLCaptStatus = paymentBC.GetFieldValue("SC Semaphone Capture Status");
                $("#CreditCapt-Status").val(sPBLCaptStatus);
                var Refreshservice = '',
                  RefreshinPS = '',
                  RefreshoutPS = '';
                RefreshinPS = SiebelApp.S_App.NewPropertySet();
                ...
                Refreshservice = SiebelApp.S_App.GetService("FINS Teller UI Navigation");
                RefreshoutPS = Refreshservice.InvokeMethod("RefreshCurrentApplet", RefreshinPS);
                $("td[title='" + sPBLPaymentRecordId + "']").click();
              } else {
                $("#creditPaymentDue").prop('readonly', true);
                $("#Payment-Link-CC").val(sPBLPaymentLink);
                $("#CreditCapt-Status").val(sPBLCaptureStatus);
                $("#SMS_PBL").val(sPBLSMS);
                $("#Email_PBL").val(sPBLEmail);
              }


              var sPBLPayLink = paymentBC.GetFieldValue("SC Payment Link");
              if (sPBLPayLink != null && sPBLPayLink != "") {
                var sPBLLinkStatus = paymentBC.GetFieldValue("SC Semaphone Capture Status");
                $("#CreditCapt-Status").val(sPBLLinkStatus);
                ...
                if (sPaytMethod == "Credit Card") {
                  ...
                  $("#SMS_PBL").prop('disabled', true);
                  $("#Email_PBL").prop('disabled', true);
                  if (paymentBC.GetFieldValue("SC Semaphone Capture Status") == "Link Sent") { //LikhithaK:27Oct2025:Added as part of EP-238
                    $("#SC-CreditCard-ResendPBL").removeClass("SC-disabled");
                  }
                }
                var maxTimeLimit = 0;
                pblGetAccount = setInterval(function () {
                  var sPBLAccountNumber = paymentBC.GetFieldValue("Account Number");
                  var sPayStat = paymentBC.GetFieldValue("SC Payment Status");
                  var sPayLinkStat = paymentBC.GetFieldValue("SC Semaphone Capture Status");
                  $("#CreditCapt-Status").val(sPayLinkStat);
                  if ((sPBLAccountNumber != "" && sPBLAccountNumber != null) || sPayStat != "Entered") {
                    setTimeout(function () {
                      $(".active-tab").each(function () {
                        $('#' + this.id).removeClass("active-tab");
                      });
                      ...
                      Refreshservice = SiebelApp.S_App.GetService("FINS Teller UI Navigation");
                      RefreshoutPS = Refreshservice.InvokeMethod("RefreshCurrentApplet", RefreshinPS);
                      clearInterval(pblGetAccount);
                    }, 10);
                  } else {
                    if (maxTimeLimit >= 300) { //15min
                      clearInterval(pblGetAccount);
                    }
                ...
                //LikhithaK:27Oct2025:Start:Added as part of EP-238
                setTimeout(function () {
                  if (paymentBC.GetFieldValue("SC Semaphone Capture Status") == "Link Sent") {
                    $("#SC-CreditCard-ResendPBL").removeClass("SC-disabled");
                  }
                }, 30000);
                //LikhithaK:27Oct2025:End:Added as part of EP-238
              }
          ...
          //LikhithaK:25July2025:SFSTRY0003466:End:Send Payment Link button code End
          //LihithaK:Start:Added as part of EP-237
          if (PayByLinkFlag == "Y") {
            var inPS = SiebelApp.S_App.NewPropertySet();
            var outPS = SiebelApp.S_App.NewPropertySet();
            var Bservice = SiebelApp.S_App.GetService("SC Adyen Payment Service");
            var sOrderNum = SiebelApp.S_App.GetActiveView().GetApplet('SC Sales Order Entry Form Applet OUI').GetBusComp().GetFieldValue('Order Number');
            var sOrderDue = SiebelApp.S_App.GetActiveView().GetApplet('SC Sales Order Entry Form Applet OUI').GetBusComp().GetFieldValue('SC Total Balance Due');
            inPS.SetProperty('Order Number', sOrderNum);
            inPS.SetProperty('Order Due', sOrderDue);

            if (Bservice) {
              outPS = Bservice.InvokeMethod("DisablePBL", inPS);
            }
            setTimeout(function () {
              var Refreshservice = '',
                RefreshinPS = '',
          ...
          //LikhithaK:End:Added as part of EP-237
        }
        ...
        SCPaymentsPR.prototype.BindData = function (bRefresh) {
          ...
          setTimeout(function () {
            try {
              ...
              console.log(e);
              if (SiebelApp.S_App.GetActiveView().GetName() == 'SC Sales Order 360 Degree View OUI')
                $(".modal-backdrop").remove();
            }
            $("#custommaskoverlay").hide();
          }, 1000);
        ...
        SCPaymentsPR.prototype.BindEvents = function () {
          ...
          //LikhithaK:11Apr2025:SFSTRY0003466
          $(document).on('change', '#Email_PBL, #SMS_PBL', function () {
            var emailChecked = $('#Email_PBL').is(':checked');
            var textChecked = $('#SMS_PBL').is(':checked');
            //LikhithaK:Start:Added as part of EP-225
            var sChangeElement = $(this).attr('id');
            var isChecked = $(this).is(':checked');
            if (sChangeElement == "SMS_PBL" && isChecked) {
              var sPhone = orderBC.GetFieldValue("SC Preferred Contact");
              if (sPhone == null || sPhone == "") {
                alert("Please provide valid Mobile Phone #.");
                document.getElementById('SMS_PBL').checked = false;
                var textChecked = $('#SMS_PBL').is(':checked');
              }
            } else if (sChangeElement == "Email_PBL" && isChecked) {
              var sEmail = orderBC.GetFieldValue("Primary Bill To Email Address");
              if (sEmail == null || sEmail == "") {
                alert("Please provide valid Email Address.");
                document.getElementById('Email_PBL').checked = false;
                var emailChecked = $('#Email_PBL').is(':checked');
              }
            }
            //LikhithaK:Start:Added as part of EP-225
          ...
          $(document).on('change', '#bill-address-new', function () {
            if (sAccOrder != "Y") {
              var val = $("#bill-address-new").val();
              var bAddrid = parentAddrJSON[val];
              SiebelJS.Log(bAddrid);
              if (val == "ADD NEW ADDRESS") {
                $("#new-bill-addr").modal({
                  backdrop: 'static'
                });
              } else {
                if (bAddrid != undefined && bAddrid != "undefined" && bAddrid != "" && bAddrid != null && bAddrid != SiebelApp.S_App.GetActiveView().GetAppletMap()["SC Sales Order Entry Form Applet OUI"].GetBusComp().GetFieldValue("Bill To Address Id")) {
                  SiebelApp.S_App.GetActiveView().GetAppletMap()["SC Sales Order Entry Form Applet OUI"].GetBusComp().SetFieldValue("Bill To Address Id", bAddrid);
                  SiebelApp.S_App.GetActiveView().GetAppletMap()["SC Sales Order Entry Form Applet OUI"].InvokeMethod("WriteRecord");
                  SiebelApp.S_App.GetActiveView().GetAppletMap()["SC Sales Order Entry Form Applet OUI"].InvokeMethod("RefreshBusComp");
                }
                $("#bill-address-new").html(AttachBillingAddresses());
          ...
          $(document).on('change', "#SC-Billing-NA-Address", function (event) {
            event.preventDefault();
            if ($("#SC-Billing-NA-Apt").val() == "")
              $("#SC-Billing-NA-Apt").focus();
          });
          $(document).on('focus', "#SC-Billing-NA-Apt", function (event) {
            event.preventDefault();
            if ($("#SC-Billing-NA-Apt").val() == "")
              $("#SNAPTTooolTips").show();
          });
          $(document).on('focusout', "#SC-Billing-NA-Apt", function (event) {
            event.preventDefault();
            $("#SNAPTTooolTips").hide();
          });
          $(document).on('click', "#SC-Billing-SaveNewAddress", function () {
            var errorCodes = SCErrorCodes.errorcodes();
            $("#SC-Billing-CreateNewAddress").validate({
              rules: {
                address: {
                  required: true
                },
              ...
              submitHandler: function (form) {
                event.preventDefault();
                var oBillToContactRecordSet = SiebelApp.S_App.GetActiveView().GetAppletMap()["SC Sales Order Entry Form Applet OUI"].GetBusComp().GetRecordSet();
                //var RecordSetc = SiebelApp.S_App.GetActiveView().GetAppletMap()["SC Sales Order Entry Form Applet OUI"].GetPModel().GetRenderer().GetPM().Get("GetRecordSet");
                var pConId = oBillToContactRecordSet[0]["Bill To Contact Id"];
                ...
                setTimeout(function () {
                  ...
                  inPS.SetProperty("ContactId", pConId);
                  inPS.SetProperty("SC StreetAddr1", $("#SC-Billing-NA-Address").val());
                  inPS.SetProperty("SC StreetAddr2", $("#SC-Billing-NA-Apt").val());
                  inPS.SetProperty("SC City", $("#SC-Billing-NA-City").val());
                  inPS.SetProperty("SC State", $("#SC-Billing-NA-State").val());
                  inPS.SetProperty("SC Country", "");
                  inPS.SetProperty("SC PostalCode", $("#SC-Billing-NA-ZipCode").val());
                  inPS.SetProperty("ProcessName", "SC Create And Link Billing Address To Contact");
                  Bservice = SiebelApp.S_App.GetService("Workflow Process Manager"); //get service
                  outPS = Bservice.InvokeMethod("RunProcess", inPS); //invoke the method
                  var oAddrid = outPS.GetChild(0).GetProperty("AddressId");

                  if (oAddrid != undefined && oAddrid != "undefined" && oAddrid != "" && oAddrid != null && oAddrid != SiebelApp.S_App.GetActiveView().GetAppletMap()["SC Sales Order Entry Form Applet OUI"].GetBusComp().GetFieldValue("Bill To Address Id")) {
                    SiebelApp.S_App.GetActiveView().GetAppletMap()["SC Sales Order Entry Form Applet OUI"].GetBusComp().SetFieldValue("Bill To Address Id", oAddrid);
                    SiebelApp.S_App.GetActiveView().GetAppletMap()["SC Sales Order Entry Form Applet OUI"].InvokeMethod("WriteRecord");
                    SiebelApp.S_App.GetActiveView().GetAppletMap()["SC Sales Order Entry Form Applet OUI"].InvokeMethod("RefreshBusComp");
                  }
                  $("#bill-address-new").html(AttachBillingAddresses());
                  $("body").trigger('Custom.End');
                  document.getElementById("SC-Billing-CreateNewAddress").reset();
                  $("#SC-Billing-NA-Address").removeClass("is-active");
                  $("#SC-Billing-NA-Apt").removeClass("is-active");
                  $("#SC-Billing-NA-City").removeClass("is-active");
                  $("#SC-Billing-NA-State").removeClass("is-active");
                  $("#SC-Billing-NA-ZipCode").removeClass("is-active");
                  $("#SC-Billing-NA-Address").removeClass("is-completed");
                  $("#SC-Billing-NA-Apt").removeClass("is-completed");
                  $("#SC-Billing-NA-City").removeClass("is-completed");
                  $("#SC-Billing-NA-State").removeClass("is-completed");
                  $("#SC-Billing-NA-ZipCode").removeClass("is-completed");
                }, 1000);
          ...
          $(document).on("click", ".pay-delete", function () {
            ...
            if (canDelete) {
              //LikhithaK:15Sep2025:Start:EP-188:Pay By Link User story
              if (PayByLinkFlag == "Y") {
                var sPBLPayId = paymentBC.GetFieldValue("Id");
                var inPS = SiebelApp.S_App.NewPropertySet();
                var outPS = SiebelApp.S_App.NewPropertySet();
                var bService = "";
                inPS.SetProperty("PaymentId", sPBLPayId);
                bService = SiebelApp.S_App.GetService("SC Adyen Payment Service"); //get service
                outPS = bService.InvokeMethod("PBLRestrictDelete", inPS); //invoke the method
                var DeletePayLine = outPS.GetChild(0).GetProperty("DeletePayLine");
              }

              if (PayByLinkFlag == "Y" && DeletePayLine == "N") {
                var sInpPS = SiebelApp.S_App.NewPropertySet();
                var sOutPS = SiebelApp.S_App.NewPropertySet();
                sInpPS.SetProperty("ProcessName", "SC Adyen Pay By Link Manual Expire WF");
                sInpPS.SetProperty("Object Id", sPBLPayId);
                var sService = SiebelApp.S_App.GetService("Workflow Process Manager");
                sOutPS = sService.InvokeMethod("RunProcess", sInpPS);
                setTimeout(function () {
                  var Refreshservice = '',
                    RefreshinPS = '',
                    RefreshoutPS = '';
                ...
                //LikhithaK:15Sep2025:End:EP-188:Pay By Link User story
              ...
              if (sChatUser == "Y" && SiebelApp.S_App.GetProfileAttr('GiftCardFlag') != "Y") {
              ...
              if (sVoiceUser == "Y" && SiebelApp.S_App.GetProfileAttr('GiftCardFlag') != "Y") {
          ...
          $(document).on("click", ".sc-failed-payment-row", function () {
            ...
            var sPayStatus = paymentBC.GetFieldValue("SC Payment Status");
            if (sPayStatus != 'Entered' && sPayStatus != 'In Progress') {
          ...
          $("#SC-FinLookup-Accept").click(function (e) {
            ...
            const currentValue = $("#sn-fin-AccNumber").val().replace(/\D/g, '');

            const storedValue = localStorage.getItem('financeaccountnumber');

            // Only store if not masked and value has changed

            if (storedValue && !$("#sn-fin-AccNumber").val().includes('•') && currentValue !== storedValue.replace(/\D/g, '')) {

              localStorage.setItem('financeaccountnumber', currentValue);

            }
            const Finvalue = $("#sn-fin-AccNumber").val().replace(/\D/g, ''); // Remove non-digits

            if (Finvalue.length > 4) {

              const lastFour = Finvalue.slice(-4);

              const masked = Finvalue.slice(0, -4).replace(/./g, '•');
              localStorage.setItem('financeaccountnumber', Finvalue);
              $("#financeaccountnumber").val(masked + lastFour);
        ...
        //19Nov2024
        function refreshAllAppletsSycDigital() {
        ...
        function failedPendingTxnDetials(records) {
          ...
          Markup += '</div>';
          //LikhithaK:11Sep2025:Start:Added as part of EP-185
          Markup += '<div class="col-md-3 col-lg-3 col-sm-3">';
          Markup += ' <p style="color:#20558a;font-weight:600">PAYMENT STATUS DETAILS</p>';
          Markup += '</div>';
          //LikhithaK:11Sep2025:End:Added as part of EP-185
          Markup += '</div>';
          Markup += '</div>';
          var payrcdlen = "";
          payrcdlen = records.length;
          for (var i = 0; i < payrcdlen; i++) {
            ...
            Markup += '<div class="col-md-2 col-lg-2 col-sm-2 sc-failed-payment-row" id="seq-' + (i + 1) + '" style="cursor:pointer">';
            ...
            Markup += '</div>';
            Markup += '<div class="col-md-2 col-lg-2 col-sm-2 sc-failed-payment-row" style="cursor:pointer">';
            ...
            Markup += '<p style="color:#000">' + records[i]['SC Payment Status Details'] + '</p>';
            Markup += '</div>';
            //LikhithaK:11Sep2025:End:Added as part of EP-185
            Markup += '</div>';
            Markup += '</div>';
        ...
        function AttachBillingAddresses() {
          var RecordSetc = SiebelApp.S_App.GetActiveView().GetAppletMap()["SC Sales Order Entry Form Applet OUI"].GetPModel().GetRenderer().GetPM().Get("GetRecordSet");
          var Addrid = RecordSetc[0]["Bill To Address Id"];

          var conId = RecordSetc[0]["Bill To Contact Id"];
          var search_Spec = "[Contact Id] = '" + conId + "' AND ([End Date] IS NULL  OR [End Date] > TODAY())";
          var Fields = "Id,Address Name";
          var addList = SCOUIMethods.GetContactAddressesList("Contact", "FINS Contact Address", search_Spec, Fields);
          //var billAddList = addList;
          markup = "";
          ...
          if (Addrid !== "No Match Row Id" && Addrid !== "") {
            $("#sc-billtoadd-title").attr("title", parentJSON[Addrid]);
            markup += '<option class="SC-SO-Option">' + parentJSON[Addrid] + '</option>';
          } else {
            $("#sc-billtoadd-title").attr("title", "");
          ...
          markup += '<option class="SC-SO-Option new-address">ADD NEW ADDRESS</option>';
          return markup;
        }
        //LikhithaK:03Mar2025:End:US#SFSTRY0003418:Added as part of Billing Address Dropdown
        ...
        function FinanceDetails() {
          ...
          if (paymentBC.GetFieldValue('Account Number') == "") {
            ...
            //Markup += '<label class="input-title">' + paymentBC.GetFieldValue('Account Number') + '</label>';
            Markup += '<label class="input-title">' + $("#financeaccountnumber").val() + '</label>';
          }
          Markup += '</div>';
          Markup += '<div class="input-group input-min-height">';
