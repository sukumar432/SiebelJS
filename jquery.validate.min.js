...
//Added jQuery-Validation-Bootstrap-tooltip
/**
 * @preserve
    ...
    a.extend(!0, a.validator, {
        prototype: {
            defaultShowErrors: function() {
                var d = this,
                    e = a.fn.bstooltip.Constructor.VERSION;
                e && (e = e.split("."), b = parseInt(e[0]), c = parseInt(e[1])), a.each(this.errorList, function(e, f) {
                    if (3 === b && c >= 3) {
                        var g = a(f.element);
                        void 0 !== g.data("bs.tooltip") ? g.data("bs.tooltip").options.title = f.message : g.bstooltip(d.applyTooltipOptions(f.element, f.message)), a(f.element).removeClass(d.settings.validClass).addClass(d.settings.errorClass).bstooltip("show")
                    } else a(f.element).removeClass(d.settings.validClass).addClass(d.settings.errorClass).bstooltip(4 === b ? "dispose" : "destroy").bstooltip(d.applyTooltipOptions(f.element, f.message)).bstooltip("show");
                    ...
                    a(e).removeClass(d.settings.errorClass).addClass(d.settings.validClass).bstooltip(4 === b ? "dispose" : "destroy"), d.settings.unhighlight && d.settings.unhighlight.call(d, e, d.settings.errorClass, d.settings.validClass)
                })
            },
            applyTooltipOptions: function(c, d) {
                var e;
                e = 4 === b ? a.fn.bstooltip.Constructor.Default : 3 === b ? a.fn.bstooltip.Constructor.DEFAULTS : a.fn.bstooltip.defaults;
                var f = {
