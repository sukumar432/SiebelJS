        ...
        function() {
            SiebelApp.SCiPadCreditApplicationMarkup = (function() {
                ...
                SCiPadCreditApplicationMarkup.prototype.SCFinanceHeaderMarkup = function(hcMerchantId) {
                    ...
                    headermarkup += "<li><b>Authorization for the Social Security Administration to Disclose Your Social Security Number Verification.<b> I authorize the Social Security Administration (SSA) to verify and disclose to SYNCB for the purpose of this transaction whether the name, Social Security Number (SSN) and date of birth I have submitted matches information in SSA records. My consent is for a one-time validation within the next 90 days.</li>";
                    headermarkup += '</ul>';
				...
				//Added by APRAKASH FOR SFSTRY0001706
			 SCiPadCreditApplicationMarkup.prototype.SCFinPopupMarkup=function(){
				var finappMarkup= "";
