        ...
        function () {
            SiebelAppFacade.SCiPadSalesOrder360DegreeViewPR = (function () {
                ...
                var dateopened = true,
                    ...
                    modifiedatt = true,
                    commentsatt = true;
                var sIpadFeatureFlag = "N"; //LikhithaK:22May2025:SFSTRY0003472:Terminal UI Changes
                ...
                SCiPadSalesOrder360DegreeViewPR.prototype.Init = function () {
                    ...
                    $("#_sweview").hide();
                    sIpadFeatureFlag = SiebelApp.S_App.GetProfileAttr('IpadFeatureFlag'); //LikhithaK:22May2025:SFSTRY0003472:Added as part of Terminal UI Changes
                }
                ...
                SCiPadSalesOrder360DegreeViewPR.prototype.ShowUI = function () {
                    ...
                    $(document).on("click", "#SC-delete-yes", function () {
                        ...
                        //LikhithaK:Start:22May2025:SFSTRY0003472:Created for home page navigation on Terminal
                        if (sIpadFeatureFlag == "Y") {
                            SCOUIMethods.CheckTerminalStatus(localStorage.getItem('OrderId'));
                        }
                        //LikhithaK:End:22May2025:SFSTRY0003472:Created for home page navigation on Terminal
                    });
                    ...
                    $(document).on("click", "#resume_order360", function () {
                        ...
                        if (sIpadFeatureFlag == "Y") {
                            ...
                            //Kolasani
                            var sOrderId = OrderDetailrecords[0]["Id"];
                            var sOrderNumber = OrderDetailrecords[0]["Order Number"];
                            var inPS = SiebelApp.S_App.NewPropertySet();
                            var outPS = SiebelApp.S_App.NewPropertySet();
                            if (sOrderNumber != "" && sOrderNumber != null) {
                                var Bservice = SiebelApp.S_App.GetService("SC Adyen Payment Service");
                                inPS.SetProperty('Order Number', sOrderNumber);
                    ...
                    $(document).on("click", "#SC-Reprice-order-button", function () {
                        ...
                        setTimeout(function () {
                            ...
                            if (sHomeDelLineExists == "Y") {
                                ...
                                inPS.SetProperty("SearchSpecification", "[Order Header Id] = '" + OrderDetailrecords[0]["Id"] + "'AND ([Fulfillment Status Code] = 'In Progress' OR ([SC Revisable]='Revisable')) AND [Ship Method] = 'Home Delivery' AND [Request To Cancel] <> 'Y'");
                    ...
                    $(document).on("click", "#SC-od-close", function () {
                        ...
                        //VENKATESH-02JUL2024-Added below code for Payment Issues flag
                        ...
                        //VENKATESH-02JULY2024-End of Code for Payment Issues flag
