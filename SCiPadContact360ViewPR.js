...
if (typeof (SiebelAppFacade.SCiPadContact360ViewPR) === "undefined") {

    SiebelJS.Namespace("SiebelAppFacade.SCiPadContact360ViewPR");
    define("siebel/custom/SelectComfort/SCiPadContact360ViewPR", ["siebel/viewpr", "siebel/custom/SelectComfort/bootstrap.min", "siebel/custom/SelectComfort/jquery.validate.min", "siebel/custom/SelectComfort/moment", "siebel/custom/SelectComfort/moment-timezone-with-data.min", "siebel/custom/SelectComfort/SCiPadContact360Markup", "siebel/custom/SelectComfort/SCiPadCreateContactMarkup", "siebel/custom/SelectComfort/SCiPadCreateContactFunctionality", "siebel/custom/SelectComfort/SCErrorCodes", "siebel/custom/SelectComfort/SC_OUI_Markups", "siebel/custom/SelectComfort/SC_OUI_Methods", "siebel/custom/SelectComfort/SC_OUI_Definitions"],
        function () {
            SiebelAppFacade.SCiPadContact360ViewPR = (function () {
                //Start -- Variable declaration
                var pm = '';
                var SiebelConstants = SiebelJS.Dependency("SiebelApp.Constants");
                var Contact360Markup = SiebelJS.Dependency("SiebelAppFacade.SCiPadContact360Markup");
                ...
                var divisions = {
                    "Cust-Details-Pin": "Cust-Details-Applet",
                    "Con-Info-Pin": "Con-Info-Applet",
                    "Cust-inter-Pin": "Cust-inter-Applet",
                    "Prof-Info-Pin": "Prof-Info-Applet",
                    "Cons-Notes-Pin": "Cons-Notes-Applet",
                    "Assets-Pin": "Assets-Applet",
                    "Orders-Pin": "Orders-Applet",
                    "HDSR-Pin": "HDSR-Applet",
                    "Oppor-Pin": "Oppor-Applet",
                    "SR-Pin": "SR-Applet",
                    "Activities-Pin": "Activities-Applet",
                    "Inn-Circle-Pin": "Inn-Circle-Applet",
                    "Item-lookup-Pin": "Item-lookup-Applet",
                    "Eligible-Offer-Pin": "Eligible-Offer-Applet"
                };
                var appletNames = {
                    "Cust-Details-Pin": "Cust-Details",
                    "Con-Info-Pin": "Cont-Info",
                    "Cust-inter-Pin": "Cust-Interacion",
                    "Prof-Info-Pin": "prof-Info",
                    "Cons-Notes-Pin": "Cons-Notes",
                    "Assets-Pin": "Assets",
                    "Orders-Pin": "Orders",
                    "HDSR-Pin": "HDSR",
                    "Oppor-Pin": "Opportunity",
                    "SR-Pin": "Serv-Req",
                    "Activities-Pin": "Activities",
                    "Inn-Circle-Pin": "Inn-Circle",
                    "Item-lookup-Pin": "item-lookup",
                    "Eligible-Offer-Pin": "Eligible-Offer"
                };
                var pinids = [];
                ...
                var OptyName_Opportunities = true,
                ...
                var OpenDt_ServiceRequests = true,
                ...
                var HDSR_OpenedDate_ServiceRequests = true,
                ...
                var Assets_PM = "",
                    Asset_Records = "";
                var Eligible_Offer_PM = "",
                    Eligible_Offer_Records = ""; //Sukumar Added for Eligible Offer
                var Orders_PM = "";
                var Opportunity_PM = "";
                var HDSR_PM = "";
                var SR_PM = "";
                ...
                function SCiPadContact360ViewPR(pm) {
                    SiebelAppFacade.SCiPadContact360ViewPR.superclass.constructor.apply(this, arguments);
                }

                SiebelJS.Extend(SCiPadContact360ViewPR, SiebelAppFacade.ViewPR);



                SCiPadContact360ViewPR.prototype.Init = function () {
                    SiebelAppFacade.SCiPadContact360ViewPR.superclass.Init.apply(this, arguments);
                ...
                SCiPadContact360ViewPR.prototype.ShowUI = function () {
                    SiebelAppFacade.SCiPadContact360ViewPR.superclass.ShowUI.apply(this, arguments);
                    ...
                    Contact360Markup = SiebelJS.Dependency("SiebelAppFacade.SCiPadContact360Markup");
                    ...
                    $("#" + a).hide();
                    a = SiebelApp.S_App.GetActiveView().GetAppletMap()["SN Eligible Offers List Applet"].GetPModel().Get("GetFullId");
                    $("#" + a).hide();
                ...
                SCiPadContact360ViewPR.prototype.BindData = function (bRefresh) {
                    SiebelAppFacade.SCiPadContact360ViewPR.superclass.BindData.apply(this, arguments);
                    ...
                    if (isiFitRecord == "Y") {
                        ...
                        $("#SC-360-Convert").show();
                        $("#Eligible-Offer-AppletName-div").hide(); //Sukumar Added for Eligible
                    } else {
                        $("#SC-360-customer-interaction-edit").show();
                        $("#Cust-inter-AppletName-div").show();
                        ...
                        $("#Eligible-Offer-AppletName-div").show(); //Sukumar Eligible Offer
                        //SWAGH:10192023:SFSTRY0003053
                        ...
                        var sortSpec = "Order By";
                        var isFinanceDisabled = SC_OUI_Methods.SCGetOrderLoVs(searchExpr);
                        if (isFinanceDisabled == "N") {
                            $("#SC-360-Finance").addClass("SC-disabled");
                        }
                    ...
                    var setProfName = '';
                    setProfName = '<p class="SC-360-profile-name no-margin">' + ConFormApp_RS[0]["M/M"] + ' ' + ConFormApp_RS[0]["First Name"] + ' ' + ConFormApp_RS[0]["Last Name"] + '</p>';
                ...
                SCiPadContact360ViewPR.prototype.BindEvents = function () {
                    SiebelAppFacade.SCiPadContact360ViewPR.superclass.BindEvents.apply(this, arguments);
                    ...
                    $(document).ready(function () {
                            ...
                            $("#SC-360-Customer-Details-Form").validate({
                                ...
                                submitHandler: function (form) {
                                    ...
                                    setTimeout(function () {
                                        ...
                                        // Start-- profile-name mark up
                                        var setProfName = '';
                                        setProfName = '<p class="SC-360-profile-name no-margin">' + newSetAfterCommit[0]["M/M"] + ' ' + newSetAfterCommit[0]["First Name"] + ' ' + newSetAfterCommit[0]["Last Name"] + '</p>';
                                        //NTHARRE:07-APR-2021:Removed Customer Category and community, added check and creoss images as per the STRY0090901
                                        //Added Customer Category filed 
                        ...
                        $(document).on("click", "#SC-cusin-save", function () {
                            ...
                            setTimeout(function () {
                                ...
                                } else //SiebelJS.Log('do not call -- true');
                                {
                                ...
                                } else //SiebelJS.Log('do not email -- true');
                                {
                                ...
                                } else //SiebelJS.Log('do not mail -- true');
                                {
                                ...
                                setTimeout(function () {
                                    if (assetCreat == "N") {
                                        ...
                                        if (isExists == true) {
                                            ...
                                            var fieldsArray_new = "Id,Name,Description";
                                            ...
                                            BS_Data_SKU = JSON.parse(Strre);
                                            var prod_id = "";
                                            if (BS_Data_SKU != "{")
                                                prod_id = BS_Data_SKU["Id"];

                                        }
                                        //SiebelJS.Log("New SKU Id::::--"+prod_id);
                    ...
                    $(document).on('click', "#sc-c-create-Activity-btn", function (event) {
                        $('#maskoverlay').show();
                        $('#con-Act-Startdate').attr('type', 'date');
                        setTimeout(function () {
                    ...
                    $(document).on("click", "#contact360-create-EditActivity", function (event) {
                        ...
                        var sControls = SiebelApp.S_App.GetActiveView().GetAppletMap()["SC Contact 360 Activity List Applet OUI"].GetControls();
                        var sActStatusControl = sControls["Status"];
                        var sActCommControl = sControls["Comment"];
                        var sActdescControl = sControls["Description"];
                        var sActStartdateControl = sControls["Planned"];
                        var sCanInvokeWriteRecord = ActPM.ExecuteMethod("CanInvokeMethod", "WriteRecord")
                        if (sCanInvokeWriteRecord) {
                            var date = $("#con-edit-Act-Startdate").val();
                            var d = new Date(date),
                                month = '' + (d.getMonth() + 1),
                                day = '' + d.getDate(),
                                year = d.getFullYear();
                            ...
                            var plannedDate = [month, day, year].join('/');
                            ...
                            ActPM.ExecuteMethod("SetFormattedValue", sActStartdateControl, plannedDate);
                            ...
                            ActPM.ExecuteMethod("InvokeMethod", "WriteRecord", inPropSet, ai)
                        } else {
                            $("#SC-360-Edit-Activity").modal('hide');
                        }
                    });
                    ...
                    $("html, body").on("DOMMouseScroll MouseScrollEvent MozMousePixelScroll wheel scroll", function () {
                        ...
                        if ($("#con-edit-Act-Startdate").hasClass("hasDatepicker"))
                            $("#con-edit-Act-Startdate").datetimepicker("hide");
                        if ($(".ActPlannedDT").hasClass("hasDatepicker"))
                            $(".ActPlannedDT").datetimepicker("hide");
                    });
                    //End:on scroll hiding the datepicker
                        ...
                        $("#sc-create-activity").validate({
                            ...
                            submitHandler: function (form) {
                                ...
                                setTimeout(function () {
                                        ...
                                        var date_string = "";
                                        if (conStartDate != "") {
                                            date_string = moment(conStartDate, "YYYY-MM-DD").format("MM/DD/YYYY HH:mm:ss");
                                        } else {
                                            date_string = "";
                                        }
                                        var Act_inPS = '';
                                        ...
                                        Act_inPS.SetProperty("ActivityStartDate", date_string);
                                        ...
                                        ai.opdecode = true;
                                        ai.errcb = function () {
                                            SiebelJS.Log("Error while executing 'SC Store Data BS -- SC Reciept Generation' Business Service");
                                        };
                                        ai.cb = function () {
                                            // do nothing
                                            $('#sc-create-activity')[0].reset();
                                        ...
                                        Asset_Service.InvokeMethod("RunProcess", Act_inPS, ai);
                                        activities_GetRecords();
                                        getConsolidateNoteRecords(contact_Id);
                    ...
                    $(document).on("click", ".SC-contact360-pin", function () {
                        ...
                        if (id_clicked != "Cust-Details-Pin" && id_clicked != "Con-Info-Pin") {
                            ...
                            if (divElement.style.display == "block") {
                                ...
                                if (id_clicked == 'Cust-inter-Pin') {
                                ...
                                } else //End: For -- Channel
                                    if (id_clicked == 'SR-Pin') {
                                    ...
                                    } else //Start: Getting LOV Values for SR
                    ...
                    $(document).on("click", "#SC-360-SalesOrder", function () {
                        ...
                        setTimeout(function () {
                            ...
                            //ContactFormApplet_PM.ExecuteMethod("InvokeMethod","NewOrder", null, false);
                            ...
                            ContactFormApplet_PM.ExecuteMethod("InvokeMethod", "NewOrder", inPropSet, ai);
                    ...
                    //End --Added code for Ipad Finance
                    ...
                    $(document).on("click", ".sort-by", function () {
                        ...
                        } else if ($(this).attr('id') == "Reason1") {
                            //SPATIBAN:Added code for Sorting #CHG0034381
                            if (noteRsn1 == true) {
                                //SiebelJS.Log("In asc");
                        ...
                        } else //Opportunitiy--------------------------------------------------------Opportunity
                            if ($(this).attr('id') == "OpportunityName") {
                        ...
                        } else //SPATIBAN:Added code for CR#CHG0034565
                            if ($(this).attr('id') == "Revenue_opp") {
                        ...
                        else //HDSR Service Requests---------------------------------------------------HDSR Service Requests				 	
                            if ($(this).attr('id') == "HDSR-OpenedDate") {
                        ...
                        } else //Service Requests---------------------------------------------------Service Requests
                            if ($(this).attr('id') == "OpenedDate") {
                        ...
                        } else if ($(this).attr('id') == "actReason1") {
                            //SPATIBAN:Added code for Sorting #CHG0034381
                    ...
                    var StoreLocation = '',
                        LoginId = SC_OUI_Methods.SCGetProfileAttrValue("Login Name");
                        ...
                        if ($(this).attr("Id") != "refferedPlusicon") {
                            ...
                            setTimeout(function () {
                                if (currentId != null && currentId != "") {
                                    ...
                                    inPS = SiebelApp.S_App.NewPropertySet();
                                    OutPS = SiebelApp.S_App.NewPropertySet();
                                    var fieldnames = "Asset Number,Parent Asset Number,Product Part Number,SC Calc Long Description,Product Primary Product Line,Purchase Date,Install Date,Status,SC Order Number,Base Price,Adjusted Value,SC SRO Duplicate Flag,SC Prod Warranty Name,SC Prod Wnty Duration Calc,SC Display Sale Flag,Asset Number,SC Division,SC Protection Plan,SC Active Protection Plan,SC Protection Plan End Date"; //VENKATESH-11FEB2025-Added 3 Fields for Protection plan
                                    var fieldvalues = "";
                                    inPS.SetProperty("BO", "Contact");
                                    inPS.SetProperty("BC", "Asset Mgmt - Asset - Header");
                                    inPS.SetProperty("FieldsArray", fieldnames);
                                        ...
                                        for (var childpr = 0; childpr < childsdataArray.length; childpr++) {
                                            ...
                                            if (childsdataArray.length >= 1) {
                                                ...
                                                if (SequenceId == 1) {
                                                    ...
                                                    //VENKATESH-11FEB2025-Added for Protection plan
                                                    Componentsmarkup += '              <td style="color:#fff">' + childData["SC Protection Plan"] + '</td>';
                                                    Componentsmarkup += '              <td style="color:#fff">' + childData["SC Active Protection Plan"] + '</td>';
                                                    Componentsmarkup += '              <td style="color:#fff">' + childData["SC Protection Plan End Date"] + '</td>';
                                                    ...
                                                    //VENKATESH-11FEB2025-Added for Protection plan
                                                    Componentsmarkup += '              <td>' + childData["SC Protection Plan"] + '</td>';
                                                    Componentsmarkup += '              <td>' + childData["SC Active Protection Plan"] + '</td>';
                                                    Componentsmarkup += '              <td>' + childData["SC Protection Plan End Date"] + '</td>';
                                                    //VENKATESH-11FEB2025-End for Protection plan
                    ...
                    $(document).on("click", ".phone-icon", function (e) {
                        ...
                        $("[aria-describedby='comm_makecall_popup']").css({
                            "top": $(this).context.y,
                            "left": $(this).context.x
                        });
                    ...
                    $(document).on("click", ".SC-edit-Act-360", function (event) {
                        ...
                        $('#con-edit-Act-Startdate').attr('type', 'date');
                        var SiebelConstants = SiebelJS.Dependency("SiebelApp.Constants");
                        var ActPM = SiebelApp.S_App.GetActiveView().GetAppletMap()["SC Contact 360 Activity List Applet OUI"].GetPModel().GetRenderer().GetPM();
                        ...
                        if (ActRcdSet.length >= strid) {
                            var date = ActRcdSet[strid]["Planned"];
                            var d = new Date(date),
                                month = '' + (d.getMonth() + 1),
                                day = '' + d.getDate(),
                                year = d.getFullYear();
                            ...
                            var plannedDate = [year, month, day].join('-');

                            $("#con-edit-Act-Startdate").val(plannedDate);
                    ...
                    //VALLA:07-Aug-2020: Added Code for Synchrony Financing Change
                    //NTHARRE:01-JUN-2021: Added code for Activities detail View -  STRY0114448
                    //SWAGH:10122023:SFSTRY0003046
                    $(document).on('click', '#hdsr-360-table tbody tr td:nth-child(10)', function () {
                        ...
                        if (!$(this).parent().hasClass("showhide")) {
                            ...
                            } else //$(this).siblings().find("img").attr("src", "images/custom/fileboard.png");
                            /*
                    ...
                    $(document).on('click', '#SC-Act-details-table tbody tr td:not(:nth-child(7))', function () {
                        var Appletid = SiebelApp.S_App.GetActiveView().GetAppletMap()["SC Contact 360 Activity List Applet OUI"].GetPModel().GetRenderer().GetPM().Get("GetFullId");
                        var appletSeq = Appletid[Appletid.length - 1];
                        var trid = "";
                        if ($(this).parent().next('tr').hasClass("showhide")) {
                            trid = $(this).parent().attr("id");
                            SiebelJS.Log("Selected row #" + trid);
                            $("#s_" + appletSeq + "_l tr#" + trid + "").trigger("click");
                            var hidden = $(this).parent().next('tr.showhide').is(":visible");
                            if (hidden) {
                                $(this).parent().removeClass("main-bg");
                                $(this).parent().next('tr.showhide').hide('slow');
                            } else {
                                $("#SC-Act-details-table tbody tr").not(this).siblings().next('tr.showhide').hide('slow');
                                $(this).parent().next('tr.showhide').show('slow');
                                var selected = $(this).parent().hasClass("main-bg");
                                $("#SC-Act-details-table tbody tr").removeClass("main-bg");
                                $(this).parent().addClass("main-bg");
                            }
                            var Activities_RS = SiebelApp.S_App.GetActiveView().GetAppletMap()["SC Contact 360 Activity List Applet OUI"].GetPModel().GetRenderer().GetPM().Get("GetRecordSet");
                            var ActStatus = Activities_RS[trid]["Status"];
                            var PlannedDT = Activities_RS[trid]["Planned"];
                            if (ActStatus === "Done") {
                                if (!($(".Act-editable").hasClass("SC-disabled")))
                                    $(".Act-editable").addClass("SC-disabled");
                            } else {
                                if ($(".Act-editable").hasClass("SC-disabled"))
                                    $(".Act-editable").removeClass("SC-disabled");
                            ...
                            /*if(PlannedDT != "" && PlannedDT != null && PlannedDT != undefined){
                            						var date =PlannedDT;
                            						var d = new Date(date),
                            							month = '' + (d.getMonth() + 1),
                            							day = '' + d.getDate(),
                            						...
                            						var plannedDate =  [year,month, day].join('-');
                            						$("#PSDdate" + trid).val(plannedDate);
                            					}
                            					else
                            						$("#PSDdate" + trid).val("");*/
                            $("#PSDdate" + trid).attr('type', 'datetime');
                        }
                        $("#PSDdate" + trid).datetimepicker({
                            dateFormat: 'mm/dd/yy',
                            timeFormat: 'HH:mm:ss',
                            use24hours: true,
                            onSelect: function (dateText, inst) {
                                $("#PSDdate" + trid).parent().addClass("is-active is-completed");
                            },
                            showButtonPanel: true
                        });

                        $("#PSDdate" + trid).on('keydown', function (ev) {
                            if (ev.keyCode === 9) {
                                //tab
                                if ($("#PSDdate" + trid).hasClass("hasDatepicker"))
                                    $("#PSDdate" + trid).datetimepicker("hide");
                            }
                        });
                    });
                    //NTHARRE:01-JUN-2021: Added code for Opportunities detail View -  STRY0114448
                    $(document).on('click', '#SC-Opty-details-table tbody tr td:not(:nth-child(7))', function () {
                        var Appletid = SiebelApp.S_App.GetActiveView().GetAppletMap()["SC Contact 360 Activity List Applet OUI"].GetPModel().GetRenderer().GetPM().Get("GetFullId");
                        var appletSeq = Appletid[Appletid.length - 1];
                        var trid = "";
                        if ($(this).parent().next('tr').hasClass("showhide")) {
                            ...
                            if (hidden) {
                                ...
                                $("#SC-Opty-details-table tbody tr").not(this).siblings().next('tr.showhide').hide('slow');
                                $(this).parent().next('tr.showhide').show('slow');
                                var selected = $(this).parent().hasClass("main-bg");
                                $("#SC-Opty-details-table tbody tr").removeClass("main-bg");
                                $(this).parent().addClass("main-bg");
                            }
                            var Opportunity_RS = SiebelApp.S_App.GetActiveView().GetAppletMap()["SC Contact 360 Opportunity List Applet"].GetPModel().GetRenderer().GetPM().Get("GetRecordSet");
                            var OptyOwner = Opportunity_RS[trid]["SC Owner"];
                            var loginName = SC_OUI_Methods.SCGetProfileAttrValue('Login Name');
                            if (OptyOwner === loginName) {
                                if ($(".opty-editable").hasClass("SC-disabled"))
                                    $(".opty-editable").removeClass("SC-disabled");
                                //NTHARRE:02JUL2021:To hide the functionality for store users based on lov - SFSTRY0001090
                                var StoreUser = SC_OUI_Methods.SCGetProfileAttrValue('SC Store User');
                                var searchExpr = "[Type] = 'SC_IS_STORE_LEAD' AND [Active] = 'Y'";
                                var sortSpec = "Order By";
                                ...
                                if (StoreUser == "Y" && StoreLead == "No") {
                                    if (!($(".opty-editable").hasClass("SC-disabled")))
                                        $(".opty-editable").addClass("SC-disabled");
                                }
                            } else {
                                if (!($(".opty-editable").hasClass("SC-disabled")))
                                    $(".opty-editable").addClass("SC-disabled");
                    ...
                    $(document).on('click', ".sc-Act-save-360", function () {
                        $(this).parent().removeClass("main-bg");
                        ...
                        //Start loader	
                        setTimeout(function () {
                            var ActPSDdate = $("#PSDdate" + saveid).val();
                            var ActStatus = $("#ActStatus" + saveid).val();
                            var ActComments = $("#ActComments" + saveid).val();
                            var ActDescription = $("#ActDesc" + saveid).val();
                            var ActPM = SiebelApp.S_App.GetActiveView().GetAppletMap()["SC Contact 360 Activity List Applet OUI"].GetPModel().GetRenderer().GetPM();
                            var sControls = SiebelApp.S_App.GetActiveView().GetAppletMap()["SC Contact 360 Activity List Applet OUI"].GetControls();
                            var sActStatusControl = sControls["Status"];
                            var sActCommControl = sControls["Comment"];
                            ...
                            if (sCanInvokeWriteRecord) {
                                ...
                                var Activities_RS = ActPM.Get("GetRecordSet");
                                var oldPSDdt = Activities_RS[saveid]["Planned"];
                                var oldstatus = Activities_RS[saveid]["Status"];
                                var plannedDate = "";
                                /*if(ActPSDdate !=""){
                                							var date = ActPSDdate;
                                							var d = new Date(date),
                                							...
                                							plannedDate =  [month, day, year].join('/');
                                						}
                                						else*/
                                plannedDate = ActPSDdate;
                                ActPM.ExecuteMethod("SetFormattedValue", sActdescControl, ActDescription);
                                ActPM.ExecuteMethod("SetFormattedValue", sActCommControl, ActComments);
                                if (oldPSDdt != plannedDate)
                                    ActPM.ExecuteMethod("SetFormattedValue", sActStartdateControl, plannedDate);
                                if (oldstatus != ActStatus)
                                    ActPM.ExecuteMethod("SetFormattedValue", sActStatusControl, ActStatus);

                                ActPM.ExecuteMethod("InvokeMethod", "WriteRecord");
                            }
                            activities_GetRecords();
                            $("#custommaskoverlay").hide();
                        }, 50);
                    });
                    $(document).on('click', ".sc-Act-cancel-360", function () {
                        $(this).parent().removeClass("main-bg");
                    ...
                    $(document).on('click', ".sc-opty-save-360", function () {
                        $(this).parent().removeClass("main-bg");
                        $(this).parent().parent().parent().parent().hide();
                        $(this).parent().parent().parent().parent().prev().removeClass("main-bg");
                        var Appletid = SiebelApp.S_App.GetActiveView().GetAppletMap()["SC Contact 360 Activity List Applet OUI"].GetPModel().GetRenderer().GetPM().Get("GetFullId");
                        ...
                        //Start loader	
                        setTimeout(function () {
                            var oNotes = $("#OptyNotes" + saveid).val();
                            var oStatus = $("#oppStatus" + saveid).val();
                            var oRevenue = $("#Revenue" + saveid).val();
                            var oProbobility = $("#OptyProb" + saveid).val();
                            var OptyBC = SiebelApp.S_App.GetActiveView().GetAppletMap()["SC Contact 360 Opportunity List Applet"].GetBusComp();
                            OptyBC.SetFieldValue("Notes", oNotes);
                            OptyBC.SetFieldValue("Status", oStatus);
                            OptyBC.SetFieldValue("Primary Revenue Amount", oRevenue);
                            OptyBC.SetFieldValue("SC Oppty Prob", oProbobility);
                            SiebelApp.S_App.GetActiveView().GetAppletMap()["SC Contact 360 Opportunity List Applet"].InvokeMethod("WriteRecord");

                            opportunities_GetRecords();
                            $("#custommaskoverlay").hide();
                        }, 50);
                    });
                    $(document).on('click', ".sc-opty-cancel-360", function () {
                        $(this).parent().removeClass("main-bg");
                        $(".padding-for-calendar").datepicker("hide");
                        $(this).parent().parent().parent().parent().hide();
                        $(this).parent().parent().parent().parent().prev().removeClass("main-bg");
                    ...
                    $(document).on('click', ".ActPlannedDT", function () {
                        var ActRowid = $(this).attr("id");
                        $("#" + ActRowid).datetimepicker("show");
                    });
                ...
                /*$(".ActPlannedDT").on('keydown', function(ev){
                				if(ev.keyCode === 9){ //tab
                					if($(".ActPlannedDT").hasClass("hasDatepicker"))
                						$(".ActPlannedDT").datepicker("hide");
                				}
                			}); */
                ...
                function assets_GetRecords() {
                    ...
                    for (var asset = 0; asset < conrcdLen; asset++) {
                        ...
                        //VENKATESH-11FEB2025-Added for Protection plan
                        asset_new += ' <td>' + Assets_RS[asset]["SC Protection Plan"] + '</td>';
                        asset_new += ' <td>' + Assets_RS[asset]["SC Active Protection Plan"] + '</td>';
                        asset_new += ' <td>' + Assets_RS[asset]["SC Protection Plan End Date"] + '</td>';
                        //VENKATESH-11FEB2025-Added for Protection plan
                ...
                function Eligible_Offer_GetRecords() {
                    ...
                    for (var Eligible_Offfer = 0; Eligible_Offfer < conrcdLen; Eligible_Offfer++) {
                        ...
                        Eligible_Offfer_new += ' <td> ' + Eligible_Offfer_RS[Eligible_Offfer]["Product"] + '</td>';
                        Eligible_Offfer_new += ' <td>' + Eligible_Offfer_RS[Eligible_Offfer]["Payment Type"] + '</td>';
                        Eligible_Offfer_new += ' <td>' + Eligible_Offfer_RS[Eligible_Offfer]["Effective Start Date"] + '</td>';
                        Eligible_Offfer_new += ' <td>' + Eligible_Offfer_RS[Eligible_Offfer]["Effective End Date"] + '</td>';
                ...
                function opportunities_GetRecords() {
                    ...
                    var searchExpr = "[Type] = 'SC_OPTY_STATUS' AND [Active] = 'Y'";
                    var sortSpec = "Order By";
                    var StatusArray = SC_OUI_Methods.SCGetOrderLoVs(searchExpr);
                    var searchExpr2 = "[Type]= 'SC_OPTY_PROB' AND [Active]='Y'";
                    var sortSpec = "";
                    var ProbArrayy = SC_OUI_Methods.SCGetOrderLoVs(searchExpr2);
                    //NTHARRE:02JUL2021:To hide the functionality for store users based on lov - SFSTRY0001090
                    var searchExpr = "[Type] = 'SC_IS_STORE_LEAD' AND [Active] = 'Y'";
                    var sortSpec = "Order By";
                    var StoreLead = SC_OUI_Methods.SCGetOrderLoVs(searchExpr);
                    ...
                    for (var opp = 0; opp < conrcdLen; opp++) {
                        ...
                        oppo += '</tr>';
                        oppo += '    <tr class="showhide">';
                        oppo += '        <td class="main-bg" colspan="7">';
                        oppo += '           <div class="collapse-block" style="height:550px !important">';
                        oppo += '             <div class="row SC-SO-row clearfix">';
                        oppo += '                <div class="col-md-4 col-lg-4 SC-SO-item">';
                        oppo += '                       <label class="item-label">Opportunity Name:</label>';
                        oppo += '                          <input type="text" name="" class="item-value-select-box SC-disabled" id="" value="' + Opportunity_RS[opp]["Name"] + '">';
                        oppo += '                  </div>';
                        oppo += '                <div class="col-md-4 col-lg-4 SC-SO-item">';
                        oppo += '                   <label class="item-label">Status:</label>';
                        oppo += '                      <select class="item-value-select-box opty-editable"  id="oppStatus' + opp + '">';
                        oppo += ' <option value="' + Opportunity_RS[opp]["Status"] + '">' + Opportunity_RS[opp]["Status"] + '</option>';
                        var StatusLen = "";
                        StatusLen = StatusArray.length;
                        for (var ps = 0; ps < StatusLen; ps++) {
                            if (Opportunity_RS[opp]["Status"] != StatusArray[ps])
                                oppo += ' <option value="' + StatusArray[ps] + '">' + StatusArray[ps] + '</option>';
                        }
                        oppo += '                     </select>';
                        oppo += '                 </div>';
                        oppo += '              </div>';
                        oppo += '             <div class="row SC-SO-row clearfix">';
                        oppo += '                 <div class="col-md-4 col-lg-4 SC-SO-item">';
                        oppo += '                    <label class="item-label">Revenue:</label>';
                        oppo += '                       <input type="text" name="" class="item-value-select-box opty-editable" onclick="this.select();" id="Revenue' + opp + '" value="' + Opportunity_RS[opp]["Primary Revenue Amount"] + '">';
                        oppo += '                  </div>';
                        oppo += '                  <div class="col-md-4 col-lg-4 SC-SO-item">';
                        oppo += '                     <label class="item-label">Probability:</label>';
                        oppo += '                        <select class="item-value-select-box opty-editable" id="OptyProb' + opp + '">';
                        oppo += ' 							<option value="' + Opportunity_RS[opp]["SC Oppty Prob"] + '">' + Opportunity_RS[opp]["SC Oppty Prob"] + '</option>';
                        var ProbobLen = "";
                        ProbobLen = ProbArrayy.length;
                        for (var ps = 0; ps < ProbobLen; ps++) {
                            if (Opportunity_RS[opp]["SC Oppty Prob"] != ProbArrayy[ps])
                                oppo += ' <option value="' + ProbArrayy[ps] + '">' + ProbArrayy[ps] + '</option>';
                        }
                        oppo += '                     </select>';
                        oppo += '                   </div>';
                        oppo += '              </div>';
                        ...
                        oppo += '             <div class="row SC-SO-row clearfix">';
                        oppo += '                <div class="col-md-4 col-lg-4 SC-SO-item">';
                        oppo += '                   <label class="item-label">Created Date:</label>';
                        oppo += '                      <input type="text" name="" class="item-value-select-box SC-disabled" id="" value="' + Opportunity_RS[opp]["Created"] + '" readonly>';
                        oppo += '                 </div>';
                        oppo += '                 <div class="col-md-4 col-lg-4 SC-SO-item">';
                        oppo += '                       <label class="item-label">Notes:</label>';
                        oppo += '                          <textarea class="item-value-select-box text-area opty-editable" id="OptyNotes' + opp + '" style="width:80% !important" onclick="this.select();" value="' + Opportunity_RS[opp]["Description"] + '">' + Opportunity_RS[opp]["Description"] + '</textarea>';
                        oppo += '                  </div>';
                        oppo += '              </div>';
                        oppo += '             <div class="row SC-SO-row clearfix">';
                        oppo += '                 <div class="col-md-4 col-lg-4 SC-SO-item">';
                        oppo += '                    <label class="item-label">Owner:</label>';
                        oppo += '                       <input type="text" name="" class="item-value-select-box SC-disabled" id="" value="' + Opportunity_RS[opp]["SC Owner"] + '" readonly>';
                        oppo += '                  </div>';
                        oppo += '                  <div class="col-md-4 col-lg-4 SC-SO-item">';
                        oppo += '                     <label class="item-label">Channel:</label>';
                        oppo += '                       <input type="text" name="" class="item-value-select-box SC-disabled" id="" value="' + Opportunity_RS[opp]["Channel"] + '" readonly>';
                        oppo += '                   </div>';
                        oppo += '               </div>';
                        oppo += '             <div class="row SC-SO-row clearfix">';
                        oppo += '                 <div class="col-md-4 col-lg-4 SC-SO-item">';
                        oppo += '                       <label class="item-label">Lead Rank:</label>';
                        oppo += '                          <input type="text" name="" class="item-value-select-box SC-disabled" id="" value="' + Opportunity_RS[opp]["SC Lead Rank"] + '" readonly>';
                        oppo += '                  </div>';
                        oppo += '                <div class="col-md-4 col-lg-4 SC-SO-item">';
                        oppo += '                   <label class="item-label">Series:</label>';
                        oppo += '                      <input type="text" name="" class="item-value-select-box SC-disabled" id="" value="' + Opportunity_RS[opp]["SC Series"] + '" readonly>';
                        oppo += '                 </div>';
                        oppo += '               </div>';
                        oppo += '             <div class="row SC-SO-row clearfix">';
                        oppo += '                <div class="col-md-4 col-lg-4 SC-SO-item">';
                        oppo += '                   <label class="item-label">Base:</label>';
                        oppo += '                      <input type="text" name="" class="item-value-select-box SC-disabled" id="" value="' + Opportunity_RS[opp]["SC Base"] + '" readonly>';
                        oppo += '                 </div>';
                        oppo += '                <div class="col-md-4 col-lg-4 SC-SO-item">';
                        oppo += '                   <label class="item-label">Bed Quiz Results:</label>';
                        oppo += '                      <input type="text" name="" class="item-value-select-box SC-disabled" id="" value="' + Opportunity_RS[opp]["Bed Quiz Results"] + '" readonly>';
                        oppo += '                 </div>';
                        oppo += '              </div>';
                        oppo += '              <div class="row SC-SO-row clearfix">';
                        oppo += '                    <button class="sc-opty-cancel-360" id="' + opp + '">Cancel</button>';
                        oppo += '                    <button class="sc-opty-save-360" id="' + opp + '">Save</button>';
                        oppo += '               </div>';
                        oppo += '            </div>';
                        oppo += '            </td>';
                        oppo += '         </tr>';
                					...
                					for (var act = 0; act < conrcdLen; act++) {
                					    ...
                					    if (customerType == 'STORE' || customerType == 'SHOW'){
                							if(Activities_RS[act]["Status"]=="Done")
                								activity_new += '<td class="no-padding" style="min-width: 0px;"><img class="SC-disabled so-add-cart" id="' + act + '_con360editActimage" src="images/custom/revise-orange.png"/></td>';
                							else
                								activity_new += '<td class="no-padding" style="min-width: 0px;"><img class="SC-edit-Act-360 so-add-cart" id="' + act + '_con360editActimage" src="images/custom/revise-orange.png"/></td>';
                						}
                ...
                function activities_GetRecords() {
                    ...
                    var conrcdLen = "";
                    conrcdLen = Activities_RS.length;
                    var searchExpr = "[Type] = 'EVENT_STATUS' AND [Active] = 'Y'";
                    var sortSpec = "Order By";
                    var StatusArray = SC_OUI_Methods.SCGetOrderLoVs(searchExpr);
                    for (var act = 0; act < conrcdLen; act++) {
                        var activity_new = '';
                        ...
                        activity_new += '    <tr class="showhide">';
                        activity_new += '        <td class="main-bg" colspan="7">';
                        activity_new += '           <div class="collapse-block" style="height:500px !important">';
                        activity_new += '             <div class="row SC-SO-row clearfix">';
                        activity_new += '                 <div class="col-md-3 col-lg-3 SC-SO-item">';
                        activity_new += '                       <label class="item-label">Planned Start Date:</label>';
                        activity_new += '                          <input type="text" name="PlannedDate" onclick="this.select();" class="item-value-select-box  Act-editable ActPlannedDT" id="PSDdate' + act + '" value="' + Activities_RS[act]["Planned"] + '">';
                        // activity_new += '                          <input type="image" src="images/custom/calendar-grey.png" id="PSDdate'+act+'" class="calendar-icon">'; 
                        activity_new += '                  </div>';
                        activity_new += '                <div class="col-md-3 col-lg-3 SC-SO-item">';
                        activity_new += '                   <label class="item-label">Status:</label>';
                        activity_new += '                      <select class="item-value-select-box Act-editable" id="ActStatus' + act + '">';
                        activity_new += ' <option value="' + Activities_RS[act]["Status"] + '">' + Activities_RS[act]["Status"] + '</option>';
                        var StatusLen = "";
                        paymentlength = StatusArray.length;
                        for (var ps = 0; ps < paymentlength; ps++) {
                            if (Activities_RS[act]["Status"] != StatusArray[ps])
                                activity_new += ' <option value="' + StatusArray[ps] + '">' + StatusArray[ps] + '</option>';
                        }
                        activity_new += '                     </select>';
                        activity_new += '                 </div>';
                        activity_new += '              </div>';
                        activity_new += '             <div class="row SC-SO-row clearfix">';
                        activity_new += '                 <div class="col-md-3 col-lg-3 SC-SO-item">';
                        activity_new += '                    <label class="item-label">Type:</label>';
                        activity_new += '                       <input type="text" name="" class="item-value-select-box SC-disabled" id="" value="' + Activities_RS[act]["Type"] + '" readonly>';
                        activity_new += '                  </div>';
                        activity_new += '                  <div class="col-md-3 col-lg-3 SC-SO-item">';
                        activity_new += '                     <label class="item-label">Owner:</label>';
                        activity_new += '                       <input type="text" name="" class="item-value-select-box SC-disabled" id="" value="' + Activities_RS[act]["Primary Owned By"] + '" readonly>';
                        activity_new += '                   </div>';
                        activity_new += '            </div>';

                        activity_new += '             <div class="row SC-SO-row clearfix">';
                        activity_new += '                 <div class="col-md-3 col-lg-3 SC-SO-item">';
                        activity_new += '                       <label class="item-label">Created Date:</label>';
                        activity_new += '                          <input type="text" name="" class="item-value-select-box SC-disabled" id="" value="' + Activities_RS[act]["Created"] + '">';
                        activity_new += '                  </div>';
                        activity_new += '                <div class="col-md-3 col-lg-3 SC-SO-item">';
                        activity_new += '                   <label class="item-label">Channel:</label>';
                        activity_new += '                      <input type="text" name="" class="item-value-select-box SC-disabled" id="" value="' + Activities_RS[act]["SC Channel"] + '" readonly>';
                        activity_new += '                 </div>';
                        activity_new += '              </div>';
                        activity_new += '             <div class="row SC-SO-row clearfix">';
                        activity_new += '                 <div class="col-md-3 col-lg-3 SC-SO-item">';
                        activity_new += '                    <label class="item-label">Sub Channel:</label>';
                        activity_new += '                       <input type="text" name="" class="item-value-select-box SC-disabled" id="" value="' + Activities_RS[act]["SC Sub-Channel"] + '" readonly>';
                        activity_new += '                  </div>';
                        activity_new += '                  <div class="col-md-3 col-lg-3 SC-SO-item">';
                        activity_new += '                     <label class="item-label">Mobile Phone #:</label>';
                        activity_new += '                       <input type="text" name="" class="item-value-select-box  SC-disabled" id="" value="' + Activities_RS[act]["SC Contact Cellular Phone #"] + '" readonly>';
                        activity_new += '                   </div>';
                        activity_new += '               </div>';
                        activity_new += '             <div class="row SC-SO-row clearfix">';
                        activity_new += '                 <div class="col-md-3 col-lg-3 SC-SO-item">';
                        activity_new += '                       <label class="item-label">Comments:</label>';
                        activity_new += '                          <textarea class="item-value-select-box text-area Act-editable" onclick="this.select();" style="width:80% !important"  id="ActComments' + act + '" value="' + Activities_RS[act]["Comment"] + '">' + Activities_RS[act]["Comment"] + '</textarea>';
                        activity_new += '                  </div>';
                        activity_new += '                <div class="col-md-3 col-lg-3 SC-SO-item">';
                        activity_new += '                   <label class="item-label">Description:</label>';
                        activity_new += '                      <textarea class="item-value-select-box text-area Act-editable" onclick="this.select();" style="width:80% !important" id="ActDesc' + act + '" value="' + Activities_RS[act]["Description"] + '">' + Activities_RS[act]["Description"] + '</textarea>';
                        activity_new += '                 </div>';
                        activity_new += '              </div>';
                        activity_new += '				<div class="row SC-SO-row clearfix">';
                        activity_new += '                 <div class="col-md-3 col-lg-3 SC-SO-item">';
                        activity_new += '                   <label class="item-label">Category 1</label>';
                        activity_new += '                     <input type="text" name="" class="item-value-select-box SC-disabled" id="" value="' + Activities_RS[act]["EmailNow Category One"] + '" readonly>';
                        activity_new += '                 </div>';
                        activity_new += '              </div>';
                        activity_new += '              <div class="row SC-SO-row clearfix">';
                        activity_new += '                    <button class="sc-Act-cancel-360" id="' + act + '">Cancel</button>';
                        activity_new += '                    <button class="sc-Act-save-360" id="' + act + '">Save</button>';
                        activity_new += '               </div>';
                        activity_new += '            </div>';
                ...
                function ComponentsPopup(AssetId) {
                    var Componentsmarkup = "";
                    Componentsmarkup += '     <div class="modal-dialog" style="width:800px !important">';
                    Componentsmarkup += '          <div class="modal-content" style="height:500px !important">';
                    ...
                    Componentsmarkup += '                    </div>';
                    Componentsmarkup += '            </div>';
                    Componentsmarkup += '          <div class="modal-body" style="height:400px !important">';
                    Componentsmarkup += '             <div class="SC-table-with-scroll-main" style="max-height:350px !important; overflow-y:auto">';
                    ...
                    //VENKATESH-Added for Protection Plan
                    Componentsmarkup += '                        <th>Protection Plan</th>';
                    Componentsmarkup += '                        <th>Active Protection Plan</th>';
                    Componentsmarkup += '                        <th>Protection Plan End Date</th>';
                    //VENKATESH-Added for Protection Plan
                    ...
                    if (AssetId != null && AssetId != "") {
                        ...
                        for (var asset = 0; asset < assetRecordsLength; asset++) {
                            if (Asset_Records[asset]["Asset Number"] == AssetId) {
                                ...
                                //VYADAVAL-12Jun2025-Added for Protection plan by Extend
                                Componentsmarkup += ' <td>' + Asset_Records[asset]["SC Protection Plan"] + '</td>';
                                Componentsmarkup += ' <td>' + Asset_Records[asset]["SC Active Protection Plan"] + '</td>';
                                Componentsmarkup += ' <td>' + Asset_Records[asset]["SC Protection Plan End Date"] + '</td>';
                                //VYADAVAL-End of code for Protection plan by extend
                        ...
                        if (AccountType == "Synchrony" && (ApplictnStatus == 'Approved' || ApplictnStatus == 'Approve' || ApplictnStatus == 'APPROVED' || ApplictnStatus == 'APPROVE')) {
                            ...
                            if (AccountNumber != 0 && AccountNumber != undefined && AccountNumber != "" && AccountNumber != null) {
                                ...
                                if (outputRecordSet != "}") {
                                    ...
                                    $("#SC-Synchrony-label").text("No Financing Account on file");
                                    $("#SC-Synchrony-label").attr("style", "color: #FF0000 !important; pointer-events: all!important; font-weight: 700!important;");
                                    $("#SC-Synchrony-refresh").hide();
                                }
                            }
                ...
                SCiPadContact360ViewPR.prototype.EndLife = function () {
                    SiebelAppFacade.SCiPadContact360ViewPR.superclass.EndLife.apply(this, arguments);
                ...
                function searchContact() {
                    ...
                    $("select[id*='field']").each(function () {
                        ...
                        if (fname !== "" && fvalue !== "" && fvalue !== undefined && fname !== undefined) {
                            ...
                            } else //SCHERKU: for date of first activity field
                                if (fname == "Date Of First Activity") {
                                    fvalue = fvalue;
                                    searchObj.push({
                                        "field_name": fname,
                                        "value": fvalue
                ...
                return SCiPadContact360ViewPR;
            }());
            return "SiebelAppFacade.SCiPadContact360ViewPR";
        })
}