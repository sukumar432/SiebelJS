...
if (typeof (SiebelAppFacade.PaymentDetailPM) === "undefined") {
    ...
    define("siebel/custom/SC_paymentdetailpm", ["siebel/pmodel", "siebel/custom/SelectComfort/SC_OUI_Methods"], function () {
            ...
            PaymentDetailPM.prototype.Init = function () {
                ...
                this.AddMethod("DECLINEPAYMENTADYEN",
                    function (data) {
                        ...
                        var Merchant_id = SCOUIMethods.RetrieveLOVValues('SC_ADYEN_MERCHANT_ID', 'Merchant_Account_SycurioChat');
                        var TransAmount = this.Get("GetBusComp").GetFieldValue("Transaction Amount");
