				 ...
				 // });
                   ...
                   /* $(document).on("mouseover", "#SC-CO-app-MonthlyNet", function() {
                    ...
                    $(document).on("click", "#SC-sign-submit", function() {
						...
						$("body").trigger('Custom.Start');
						setTimeout(function(){
							$("#SC-sign-submit").prop("disabled", true);
							SC_FirstName = $("#SC_FirstName").val();
							SC_MiddleInitial = $("#SC_MiddleInitial").val();
							SC_LastName = $("#SC_LastName").val();
							SC_MailingAddress = $("#SC_MailingAddress").val();
                    ...
                    $(document).on('click', "#submit-aff, #submit-app", function() {
                        $("#appcreditterms").text(' I, ' + $("#SC_FirstName").val() + ' ' + $("#SC_LastName").val() + ' agree that I have read and agree to the above provision of the Credit Terms. Selecting "Accept" constitutes my electronic signature.');
						
                        $("#coapplcreditterms").text(' I, ' + $("#Co_FirstName").val() + ' ' + $("#Co_LastName").val() + ' agree that I have read and agree to the above provision of the Credit Terms. Selecting "Accept" constitutes my electronic signature.');
						if (isJointAccount != "Y") {
                ...
                function GetApplictionStatus() {
                    ...
                    if (AppStatusIOIn.GetType() == "CheckApplicationStatus") {
                        ...
                        if (historyRecordSet[selectedIndex]["SC Account Type"] == "Synchrony") {
                            ...
                            AppStatusIOIn.SetProperty("HelpcardMerchantId", "");
                        } else {
                            AppStatusIOIn.SetProperty("ApplicationMerchantId", "");
                            AppStatusIOIn.SetProperty("HelpcardMerchantId", historyRecordSet[selectedIndex]["SC MerchantId"]);
                        }
