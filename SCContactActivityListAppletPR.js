if (typeof (SiebelAppFacade.SCContactActivityListAppletPR) === "undefined")
{
  SiebelJS.Namespace("SiebelAppFacade.SCContactActivityListAppletPR");
  define("siebel/custom/SelectComfort/SCContactActivityListAppletPR", ["siebel/jqgridrenderer", "siebel/custom/SelectComfort/SCErrorCodes", "siebel/custom/SelectComfort/SC_OUI_Methods"],
    function ()
    {
      SiebelAppFacade.SCContactActivityListAppletPR = (function ()
      {
        ...
        function SCContactActivityListAppletPR(pm)
        {
          SiebelAppFacade.SCContactActivityListAppletPR.superclass.constructor.apply(this, arguments);
        }

        SiebelJS.Extend(SCContactActivityListAppletPR, SiebelAppFacade.JQGridRenderer);

        SCContactActivityListAppletPR.prototype.Init = function ()
        {
          SiebelAppFacade.SCContactActivityListAppletPR.superclass.Init.apply(this, arguments);
          ActvityFieldsJSON = {
            "Administration": [],
        ...
        SCContactActivityListAppletPR.prototype.ShowUI = function ()
        {
          SiebelAppFacade.SCContactActivityListAppletPR.superclass.ShowUI.apply(this, arguments);
          ...
          mainMarkup += ' <div class="modal fade sc-create-manual-asset" id="SC-manual-activity-Modal" role="dialog">';
          mainMarkup += ' </div>';
          ...
          //$('#SC-manual-activity-Modal').draggable();
          //$('#SC-SO-ReqCnfrm-Popup').draggable();
        }

        SCContactActivityListAppletPR.prototype.BindData = function (bRefresh)
        {
          SiebelAppFacade.SCContactActivityListAppletPR.superclass.BindData.apply(this, arguments);
          var rowid;
        ...
        SCContactActivityListAppletPR.prototype.BindEvents = function ()
        {
          SiebelAppFacade.SCContactActivityListAppletPR.superclass.BindEvents.apply(this, arguments);
          /* var ActvityFieldsJSON={"Administration":[],"BBB":["Interaction Source","Category","Description","Interaction Disposition","Status","Comments"],"Call - Inbound":["Interaction Source","Category (OM Use Only)","Priority (Specialty Teams Only)"],"Call - Outbound":["Interaction Source"],"Chat - Inbound":["Interaction Source"],"Email - Inbound":["Interaction Source","Priority (Specialty Teams Only)"],"Customer Contact - Planned":["Start Date"],"Customer Contact - Requested":["Start Date","Owner"],"Internal Collaboration":["Start Date","Category (OM Use Only)"],"Vendor Collaboration":["Start Date"],"Verify Financial Status":["Start Date","Category (OM Use Only)"],"Verify Order Status":["Start Date","Category (OM Use Only)"],"Email - Outbound":["Interaction Source","Category (OM Use Only)"],"Email Now":["Confirm Email Address","Email Now Category 1","Email Now Category 2"],"Mail - Inbound":["Interaction Source"],"Mail - Outbound":["Interaction Source"],"Other":["Interaction Source"],"Social Media":["Interaction Source"],"Trial Extension":["Confirm Email Address"],"Voicemail - Inbound":["Interaction Source"],"Verify Portal Info":["Start Date"]};
          var ActvityFieldsIdJSON={"Administration":["SC_Act_Int"],"BBB":["SC_Act_Int","Sc_Act_cat","SC_Act_Desc","SC_Act_IntDis","SC_Act_Stat","SC_Act_Cmt"],"Call - Inbound":["SC_Act_Int","Sc_Act_cat","SC_Act_Pr"],"Call - Outbound":["SC_Act_Int"],"Chat - Inbound":["SC_Act_Int"],"Email - Inbound":["SC_Act_Int","SC_Act_Pr"],"Customer Contact - Planned":["SC_ACT_strtDate"],"Customer Contact - Requested":["SC_ACT_strtDate","SC_ACt_owner"],"Internal Collaboration":["SC_ACT_strtDate","Sc_Act_cat"],"Vendor Collaboration":["SC_ACT_strtDate"],"Verify Financial Status":["SC_ACT_strtDate","Sc_Act_cat"],"Verify Order Status":["SC_ACT_strtDate","Sc_Act_cat"],"Email - Outbound":["SC_Act_Int","Sc_Act_cat"],"Email Now":["SC-con-Email","SC_Act_Cat1","SC_Act_Cat2"],"Mail - Inbound":["SC_Act_Int"],"Mail - Outbound":["SC_Act_Int"],"Other":["SC_Act_Int"],"Social Media":["SC_Act_Int"],"Trial Extension":["SC-con-Email"],"Voicemail - Inbound":["SC_Act_Int"],"Verify Portal Info":["SC_ACT_strtDate"]};
          var ActivitySRJSON={"Administration":"Y","BBB":"N","Call - Inbound":"Y","Call - Outbound":"Y","Chat - Inbound":"Y","Email - Inbound":"Y","Customer Contact - Planned":"Y","Customer Contact - Requested":"Y","Internal Collaboration":"Y","Vendor Collaboration":"Y","Verify Financial Status":"Y","Verify Order Status":"Y","Email - Outbound":"Y","Email Now":"Y","Mail - Inbound":"Y","Mail - Outbound":"Y","Other":"Y","Social Media":"Y","Trial Extension":"Y","Voicemail - Inbound":"Y","Verify Portal Info":"N"};
          var ActivityControlsJSON={"SC_Act_Int":"Interaction Disposition","SC_Act_Cmt":"Comment","SC_Act_Desc":"Description","SC_Act_Pr":"Priority","SC_ACT_strtDate":"Planned","Sc_Act_cat":"Class","SC_Act_IntDis":"SC Interaction Disposition","SC_Act_Stat":"Status","SC_Trial_EXDate":"SC Trial End Date","SC_Act_Cat1":"Category 1","SC_Act_Cat2":"Category 2","SC_ACt_owner":"Primary Owned By"};
          var ActivityFieldsJSON={"SC_Act_Int":"Q7","SC_Act_Cmt":"Comment","SC_Act_Desc":"Description","SC_Act_Pr":"Priority","SC_ACT_strtDate":"Planned","Sc_Act_cat":"Class","SC_Act_IntDis":"SC Interaction Disposition","SC_Act_Stat":"Status","SC_Trial_EXDate":"SC Trial End Date","SC_Act_Cat1":"EmailNow Category One","SC_Act_Cat2":"EmailNow Category Two","SC_ACt_owner":"Primary Owned By"};
          var ActvitylastFieldsJSON={"Administration":["Interaction Disposition","Status","Comments"],"BBB":[],"Call - Inbound":["Interaction Disposition","Status","Comments"],"Call - Outbound":["Interaction Disposition","Status","Comments"],"Chat - Inbound":["Interaction Disposition","Status","Comments"],"Email - Inbound":["Interaction Disposition","Status","Comments"],"Customer Contact - Planned":["Comments"],"Customer Contact - Requested":["Comments"],"Internal Collaboration":["Comments"],"Vendor Collaboration":["Comments"],"Verify Financial Status":["Comments"],"Verify Order Status":["Comments"],"Email - Outbound":["Interaction Disposition","Status","Comments"],"Email Now":["Interaction Disposition","Status","Comments"],"Mail - Inbound":["Interaction Disposition","Status","Comments"],"Mail - Outbound":["Interaction Disposition","Status"],"Other":["Interaction Disposition","Status","Comments"],"Social Media":["Interaction Disposition","Status","Comments"],"Trial Extension":["Trial Extension Date","Interaction Disposition","Comments","Status"],"Voicemail - Inbound":["Interaction Disposition","Status","Comments"],"Verify Portal Info":["Status"]};
          var ActvityLastFieldsIdJSON={"Administration":["SC_Act_IntDis","SC_Act_Stat","SC_Act_Cmt"],"BBB":[],"Call - Inbound":["SC_Act_IntDis","SC_Act_Stat","SC_Act_Cmt"],"Call - Outbound":["SC_Act_IntDis","SC_Act_Stat","SC_Act_Cmt"],"Chat - Inbound":["SC_Act_IntDis","SC_Act_Stat","SC_Act_Cmt"],"Email - Inbound":["SC_Act_IntDis","SC_Act_Stat","SC_Act_Cmt"],"Customer Contact - Planned":["SC_Act_Cmt"],"Customer Contact - Requested":["SC_Act_Cmt"],"Internal Collaboration":["SC_Act_Cmt"],"Vendor Collaboration":["SC_Act_Cmt"],"Verify Financial Status":["SC_Act_Cmt"],"Verify Order Status":["SC_Act_Cmt"],"Email - Outbound":["SC_Act_IntDis","SC_Act_Stat","SC_Act_Cmt"],"Email Now":["SC_Act_IntDis","SC_Act_Stat","SC_Act_Cmt"],"Mail - Inbound":["SC_Act_IntDis","SC_Act_Stat","SC_Act_Cmt"],"Mail - Outbound":["SC_Act_IntDis","SC_Act_Stat"],"Other":["SC_Act_IntDis","SC_Act_Stat","SC_Act_Cmt"],"Social Media":["SC_Act_IntDis","SC_Act_Stat","SC_Act_Cmt"],"Trial Extension":["SC_Trial_EXDate","SC_Act_IntDis","SC_Act_Cmt","SC_Act_Stat"],"Voicemail - Inbound":["SC_Act_IntDis","SC_Act_Stat","SC_Act_Cmt"],"Verify Portal Info":[]}; */
          ...
          /* searchExpr = '', sortSpec = '';
          searchExpr = "[Type]= 'SR_AREA' AND [Active]='Y' AND [Order By] >=1000 and [Order By] <=1500 AND [Parent]='Incident'";
          sortSpec = "Order By";
          SRTypeArray = SC_OUI_Methods.GetLOVs(searchExpr,sortSpec);
          ...
          if (localStorageDate == null || localStorageDate != date)
          {
            ...
            //for(var lv=0;lv<scActSrchSpec.length;lv++){
            /*ActmanualLovArray=SC_OUI_Methods.GetLOVs(scActSrchSpec[0],scActSortSpec[0]);
            ActmanualLovArrayJSOn[scActSrchSpec[0]]=ActmanualLovArray;
            ActmanualLovArray=SC_OUI_Methods.GetLOVs(scActSrchSpec[1],scActSortSpec[1]);
            ActmanualLovArrayJSOn[scActSrchSpec[1]]=ActmanualLovArray;
            ActmanualLovArray=SC_OUI_Methods.GetLOVs(scActSrchSpec[2],scActSortSpec[2]);
            ActmanualLovArrayJSOn[scActSrchSpec[2]]=ActmanualLovArray;
            ActmanualLovArray=SC_OUI_Methods.GetLOVs(scActSrchSpec[3],scActSortSpec[3]);
            ActmanualLovArrayJSOn[scActSrchSpec[3]]=ActmanualLovArray;
            ActmanualLovArray=SC_OUI_Methods.GetLOVs(scActSrchSpec[4],scActSortSpec[4]);
            ActmanualLovArrayJSOn[scActSrchSpec[4]]=ActmanualLovArray;
            ActmanualLovArray=SC_OUI_Methods.GetLOVs(scActSrchSpec[5],scActSortSpec[5]);
            ActmanualLovArrayJSOn[scActSrchSpec[5]]=ActmanualLovArray;*/
            //}
            var Custom_Service = "",
              Input_BS = "",
              Out_BS = "";
            ...
            //localStorage.setItem("SCManualActValues",JSON.stringify(ActmanualLovArrayJSOn));
          }
          ...
          /* var ContactFormApplet_PM = "",ConFormApp_RS,ActPm=this.GetPM(),ActId="",NewSRcreated="N",refreshAsset="N",refreshOrder="N",refreshSR="N";
          var ActBc=SiebelApp.S_App.GetActiveView().GetAppletMap()["Contact Activity List Applet"].GetBusComp();
          var ExistOrderLen=0,exOrderStartpage,ExistOrderRcdSet=[],isOrdercd="N",ExistAssetRcdSet=[];
          var ExistSRLen=0,ExistSRRcdSet=[],exSRStartpage=0,ExistAssetLen=0,exAssetStartpage=0; */
          ...
          this.GetPM().AttachPostProxyExecuteBinding("PostChanges", function (methodName, inputPS, outputPS)
          {
            ...
            if (methodName == "PostChanges" && inputPS.propArray.hasOwnProperty("SWEPOC") && inputPS.propArray["SWEPOC"] == "Type")
            {
              ...
              if (sacttype == "Email Now")
              {
                ...
                $('#SC-manual-ActType').html(ActTypedrpValue);
                Resetmodal();
                isAssetrcd = "N";
                isOrdercd = "N";
                ActIntChanged = "Y";
                ...
                $("#SC-manual-activity-Modal").modal(
                {
                  backdrop: 'static'
                });
                $('#SC-manual-ActType').val("Email Now");
                $('#SC-manual-ActType').trigger("change");
                $('#SC-manual-ActType').parent().addClass("is-active is-completed");
              }
            }
          });
          ...
          function Resetmodal()
          {
            $("#sc-manual-table-OA").hide();
            $("#sc-manual-title-OA").hide();
            $("#sc-manual-pag-OA").hide();
            $("#SC-Manual-ExistSR-parent").hide();
            $("#SC-manual-selectSR").hide();
            $("#SC-Manual-Create-New-SR").hide();
            $("#SC-Manual-after-Activity").hide();
            $("#SC-Manual-OA-toggle").hide();
            $("#Manual-Submit-Act").hide();
            $("#SC-manual-saveSR").hide();
            $("#SC-manual-saveAct").hide();
            $("#SC-manual-saveSRAct").hide();
            $("#Cancel-Manual-Activity-AC").hide();
            $("#Cancel-Manual-Activity-SR").hide();
            $("#Cancel-Manual-Activity_order").hide();
            $("#SC-manual-saveSRBack").hide();
            $("#firstrightfields").hide();
            $("#SC-Manual-dynamic").hide();
            $("#SC-Manual-footer-Fields").hide();
            $("#sc-manual-editAct-text").hide();
          ...
          $(document).on("click", "#Cancel-Manual-Activity", function (event)
          {
            ...
            $("#SC-manual-activity-Modal").modal('hide');
          });
          //Start:code for on change of activity type
          $(document).on("change", "#SC-manual-ActType", function (event)
          {
            event.stopImmediatePropagation();
            if (this.value != "")
            {
              ...
              setTimeout(function ()
              {
                ...
                $("#SC-Manual-OA-toggle").removeClass("SC-disabled");
                $("#sc-manual-table-OA").hide();
                $("#sc-manual-title-OA").hide();
                $("#sc-manual-pag-OA").hide();
                $("#SC-Manual-ExistSR-parent").hide();
                ...
                if (ActvityFieldsJSON.hasOwnProperty(ActType))
                {
                  ...
                  {
                    $("#SC-manual-saveAct").show();
                    $("#firstrightfields").show();
                    $("#SC-Manual-dynamic").show();
                    isDropdown = "N";
                    ...
                    $("#SC-Manual-dynamic").html(FieldsMarkup);
                    var fieldValue = "";
                ...
                {
                  $("#Cancel-Manual-Activity-AC").show();
                }
                if (ActvityFieldsJSON.hasOwnProperty(ActType))
                {
          ...
          $(document).on('click', "#SC-maualSr-button", function (event)
          {
            ...
            setTimeout(function ()
            {
              ...
              GetExistSR();
              $("#SC-Manual-ExistSR-parent").show();
              $("#SC-manual-selectSR").show();
          ...
          function AppendSRMarkup(stpage)
          {
            ...
            for (var ex = stpage; ex < rcdlen && ExistSRLen != ex; ex++)
            {
			  ...
			  //9Apr25;SL;Added below 2 lines for elementool-SFSTRY0003379
              exSRMarkup += '<td class="lesspadding" title="' + ExistSRRcdSet[ex]["SC Order Line SKU"] + '">' + ExistSRRcdSet[ex]["SC Order Line SKU"] + '</td>';
			  if(ExistSRRcdSet[ex]["SC Order Product"] != undefined)
				exSRMarkup += '<td class="lesspadding" title="' + ExistSRRcdSet[ex]["SC Order Product"] + '">' + ExistSRRcdSet[ex]["SC Order Product"] + '</td>';
			  else
				exSRMarkup += '<td class="lesspadding" title=""></td>';
          ...
          function getAssetDeatils()
          {
            ...
            AssetMarkup += '                                        </tbody>';
            AssetMarkup += '                                    </table>';
            $("#sc-manual-table-OA").html(AssetMarkup);
            $("#sc-manual-pag-OA").show();
            if (ExistAssetLen <= 10)
            {
              $("#sc-manual-pag-OA").hide();
            }
          ...
          function getorderDeatils()
          {
            ...
            OrderMarkup += '                                        </tbody>';
            OrderMarkup += '                                    </table>';
            $("#sc-manual-table-OA").html(OrderMarkup);
            $("#sc-manual-pag-OA").show();
            if (ExistOrderLen <= 10)
            {
              $("#sc-manual-pag-OA").hide();
          ...
          function GetLineDeatils(Lineid)
          {
            ...
            for (var li = 0; li < ExistLineLen; li++)
            {
              ...
              LineMarkup += '<td class="orangbg"><input type="radio" name="existorderlineradio" id="' + ExistLineRcdSet[li]["Id"] + '" class="radio scorderlineradio"></td>';
          ...
          function footerActvity()
          {
            ...
            var ActFtMarkup = "",
              hasdropdown = "",
              LastArrayValues = [];
            var ftActType = $("#SC-manual-ActType").val();
            ActFtMarkup = "";
            ...
            {
              ActFtMarkup += '<form>';
              $("#sc-manual-editAct-text").show();
              $("#SC-Manual-footer-Fields").show();
            }
            ...
            $("#SC-Manual-footer-Fields").html(ActFtMarkup);
            if (ActFtMarkup != "")
            {
            ...
            /* if(ActBc.GetFieldValue("SR Number")!="" && ActBc.GetFieldValue("SC SR Asset Number")!="")
            	$("#Cancel-Manual-Activity-SR").show();
          ...
          $(document).on("click", "#sc-select-exSR", function (event)
          {
            ...
            setTimeout(function ()
            {
              ...
              var ActCntrl = "",
                selActType = $("#SC-manual-ActType").val(),
                ActcntrlName = "";
          ...
          $(document).on('change', "#sc-manual-order", function (event)
          {
            ...
            if ($("#sc-manual-order").prop('checked') == true)
            {
              ...
              setTimeout(function ()
              {
                ...
                getorderDeatils();
                $("#sc-manual-table-OA").show();
                $("#sc-manual-title-OA").show();
                ...
                $("#SC-manual-saveSR").addClass("SC-disabled");
                isAssetrcd = "N";
                isOrdercd = "Y";
                $("#maskoverlay").hide();
              }, 50);
          ...
          $(document).on('change', "#sc-manual-AO", function (event)
          {
            ...
            if ($("#sc-manual-AO").prop('checked') == true)
            {
              ...
              if ($("#sc-manual-order").prop('checked') == true)
                $("#sc-manual-order").trigger("click");
              $("#SC-manual-saveSR").removeClass("SC-disabled");
              isAssetrcd = "N";
              isOrdercd = "N";
            }
            else
          ...
          $(document).on('change', "#SC_Act_Stat", function (event)
          {
            event.stopImmediatePropagation();
            ActstatusDone = "N";
            if ((this.value == "Done") && ($("#SC-manual-ActType").val() == "Email Now" || $("#SC-manual-ActType").val() == "Trial Extension"))
            {
              var Emailvalue = SiebelApp.S_App.GetActiveView().GetAppletMap()["Contact Form Applet"].GetBusComp().GetFieldValue("Email Address");
              if (Emailvalue == "" || ($("#SC-manual-ActType").val() == "Email Now" && ($("#SC_Act_Cat1").val() == "" || $("#SC_Act_Cat2").val() == "")) || ($("#SC-manual-ActType").val() == "Trial Extension" && $("#SC_Trial_EXDate").val() == ""))
              {
                $("#SC_Act_Stat").val($(this).attr("title"));
                ActstatusDone = "Y";
                if ($("#SC-manual-ActType").val() == "Trial Extension" && $("#SC_Trial_EXDate").val() == "")
                  $("#SC-Footerfields-validator").submit();
                if (Emailvalue == "")
                  $("#sc-manual-Act-Creation").submit();
                else if (Emailvalue != "" && ($("#SC-manual-ActType").val() == "Email Now"))
                {
                  $("#SC_Act_Cat1").attr('name', 'SCemailCat1');
                  $("#SC_Act_Cat2").attr('name', 'SCemailCat2');
                  $("#sc-manual-Act-Creation").submit();
          ...
          $('#SC-manual-activity-Modal').on('shown.bs.modal', function (event)
          {
            event.stopImmediatePropagation();
            if (isvalidationreq == "Y")
            {
              ...
              else if ($("#SC-manual-ActType").val() == "Trial Extension")
              {
                if (SCEmailAd != "")
                  $("#SC-Footerfields-validator").submit();
                else
          ...
          $(document).on('change', "#SC-manual-newsrtoggle", function (event)
          {
            ...
            if ($("#SC-manual-newsrtoggle").prop('checked') == true)
            {
              ...
              $("#SC-Manual-Create-New-SR").show();
              $("#SC-Manual-OA-toggle").show();
              $("#SC-Manual-ExistSR-parent").hide();
              $("#SC-manual-selectSR").hide();
              $("#SC-manual-saveSR").show();
              $("#SC-manual-saveAct").hide();
              $("#SC-manual-saveSRBack").show();
              $("#SC-maualSr-button").hide();
              $("#SC-maualSr-button-parent").hide();
              $("#SC-manual-saveSR").addClass("SC-disabled");
            }
            ...
            $("#sc-manual-Act-Creation").validate(
            {
              ...
              submitHandler: function (form)
              {
                ...
                setTimeout(function ()
                {
                  ...
                  ActBc = SiebelApp.S_App.GetActiveView().GetAppletMap()["Contact Activity List Applet"].GetBusComp();
                  $("#maskoverlay").hide();
                  if ($("#SC-manual-ActType").val() == "Trial Extension" && $("#SC_Trial_EXDate").val() == "" && ActstatusDone == "Y")
                    $("#SC-Footerfields-validator").submit();
                  if ($("#SC-manual-ActType").val() == "Email Now")
                  {
                    $("#SC_Act_Cat1").attr('name', 'SCemailCat1');
            ...
            $("#SC-NewSR-form-Validate").validate(
            {
              ...
              submitHandler: function (form)
              {
                ...
                setTimeout(function ()
                {
                  ...
                  ActId = ActBc.GetFieldValue("Id");
				  //14Apr25;SL;Added below 2 lines for elementool-SFSTRY0003379
				  strLineId = (strLineId == undefined) ? "" : strLineId;
				  orderProd = (orderProd == undefined) ? "" : orderProd;
                  var SR_inPS = '',
                    SR_outPS = '',
                    Asset_Service = '';
                  ...
                  $("#SC-Manual-OA-toggle").addClass("SC-disabled");
                  NewSRcreated = "Y";
                  $("#SC-manual-saveSR").hide();
                  //$('#SC-NewSR-form-Validate')[0].reset();
                  $("#maskoverlay").hide();
          ...
          $(document).on('click', "#SC-manual-saveSR", function (event)
          {
            event.stopImmediatePropagation();
          ...
          $(document).on("click", "#SC-manual-saveAct", function (event)
          {
            event.stopImmediatePropagation();
            $("#maskoverlay").show();
            setTimeout(function ()
          ...
          $(document).on("click", "#Cancel-Manual-Activity-SR", function (event)
          {
            event.stopImmediatePropagation();
            $("#maskoverlay").show();
            var rcdline = ActBc.GetSelection() + 1;
          ...
          $(document).on("click", "#Cancel-Manual-Activity-AC", function (event)
          {
            event.stopImmediatePropagation();
            if (EmailChanged == "Y" && $("#SC-manual-ActType").val() == "Email Now")
            {
              $("#sc-manual-Act-Creation").submit();
            }
            //SPATIBAN:21:MAR:2022: Added code for #STRY0159897
            if ($("#SC-manual-ActType").val() == "Email Now" && ($("#SC_Act_IntDis").val().length == 0 || $("#SC_Act_Cmt").val().length < 5))
            {
              $("#SC-Footerfields-validator").submit();
              return false;
            }
            var SCEmailAd = SiebelApp.S_App.GetActiveView().GetAppletMap()["Contact Form Applet"].GetBusComp().GetFieldValue("Email Address");
            if (($("#SC-manual-ActType").val() == "Email Now" && ($("#SC_Act_Cat1").val() == "" || $("#SC_Act_Cat2").val() == "" || SCEmailAd == "")) || ($("#SC-manual-ActType").val() == "Trial Extension" && ($("#SC_Trial_EXDate").val() == "" || SCEmailAd == "")))
            {
              if (SCEmailAd != "" && $("#SC-manual-ActType").val() == "Email Now")
              {
                $("#SC_Act_Cat1").attr('name', 'SCemailCat1');
                $("#SC_Act_Cat2").attr('name', 'SCemailCat2');
                //$("#sc-manual-Act-Creation").submit();
          ...
          $(document).on("click", "#sc-ReqCnfrm-yes,#SC-manual-contact-fr-close", function (event)
          {
            ...
            //SPATIBAN:21:MAR:2022: Added code for #STRY0159897
            if (clickid == "SC-manual-contact-fr-close" && $("#SC-manual-ActType").val() == "Email Now")
            {
          ...
          $(document).on("click", "#SC-manual-saveSRBack", function (event)
          {
            event.stopImmediatePropagation();
            if ($("#SC-manual-newsrtoggle").prop('checked') == true)
              $("#SC-manual-newsrtoggle").trigger("click");
          ...
          $(document).on('click', ".scexorderradio", function (event)
          {
            ...
            if (previousValue == 'checked')
            {
			  ...
			  //9Apr25;SL;Unselect the radio related to order lines
			  $("input[name='existorderlineradio']:radio").prop("checked", false);
			  $("input[name='existorderlineradio']:radio").attr('previousValue', false);
          ...
          $(document).on('click', ".scorderlineradio", function (event)
          {
            ...
            if (previousValue == 'checked')
            {
              $(this).prop("checked", false);
              $(this).attr('previousValue', false);
			  //9Apr25;SL;Unselect the radio related to Order
			  $("input[name='existOrderradio']:radio").prop("checked", false);
			  $("input[name='existOrderradio']:radio").attr('previousValue', false);
			  $("#SC-manual-saveSR").addClass("SC-disabled");//disable Add Selected
            }
            else
            {
              $("input[name=" + name + "]:radio").attr('previousValue', false);
              $(this).attr('previousValue', 'checked');
			  //9Apr25;SL;Select the radio related to corresponding Order
			  $('#'+$(this).attr('id')).closest('.showhide').prev().find('.scexorderradio').prop('checked','checked');
			  $('#'+$(this).attr('id')).closest('.showhide').prev().find('.scexorderradio').attr('previousValue','checked');
			  $("#SC-manual-saveSR").removeClass("SC-disabled");//enable Add Selected
            }
          });
          ...
          function AppendManualActivityMarkup()
          {
            ...
            ManualActivityMarkup += '								<select class="SC-input" name="area" id="SC-manual-ActType">';
            ...
            ManualActivityMarkup += '							</div>';
            ManualActivityMarkup += '							<div id="SC-Manual-dynamic">';
            /*ManualActivityMarkup+=' 						<div class="SC-input-container height60 floatleft">';
            ManualActivityMarkup+='								<label class="SC-label mandatory">SKU#</label>';
            ManualActivityMarkup+='								<input type="text" name="sku" class="SC-input">';
            ManualActivityMarkup+='							</div>';
            ManualActivityMarkup+=' 						<div class="SC-input-container height60 floatleft floatright  no-border-bottom">';
            ManualActivityMarkup+='								<button class="srbutton" id="SC-maualSr-button">Service Request</button>';
            ManualActivityMarkup+='							</div>';*/
            ManualActivityMarkup += '                     </div>'
            ...
            ManualActivityMarkup += '							<div class="text-table-container clearfix" id="SC-Manual-ExistSR-parent">';
            ...
            ManualActivityMarkup += '								 </div>';
            ManualActivityMarkup += '								 <div class="table-container" id="SC-Manual-ExistSr-Parent">';
            ...
            //9Apr25;SL;Added below 2 lines for elementool-SFSTRY0003379
			ManualActivityMarkup += '                                                <th>Originating Order line</th>';
			ManualActivityMarkup += '                                                <th>Originating Order Product</th>';
            ...
            ManualActivityMarkup += '						 <div class="button-new-toggle" id="SC-manual-selectSR">';
            ...
            ManualActivityMarkup += '							<div class="sr-create-fields clearfix" id="SC-Manual-Create-New-SR">';
            ...
            ManualActivityMarkup += '							<div class="order-asset-toggle clearfix" id="SC-Manual-OA-toggle">';
            ...
            ManualActivityMarkup += '							<div class="text-table-container clearfix" id="sc-manual-title-OA">';
            ...
            ManualActivityMarkup += '										</div>';
            ManualActivityMarkup += '                                    </div>	';
            ManualActivityMarkup += '							 <div class="SC-table-with-scroll-main" id="sc-manual-table-OA">';
            ManualActivityMarkup += '                                </div>';
            ManualActivityMarkup += '								<div class="pagination activity-pagination pull-right" id="sc-manual-pag-OA">';
            ...
            ManualActivityMarkup += '							 	<div class="col-md-6 col-lg-6 col-sm-6 " style="display: none;padding-top: 45px;">';
            ManualActivityMarkup += '                                    <div class="SC-input-container height60">';
            ManualActivityMarkup += '                                    	<label class="SC-label" style="color:black">Originating Order Product</label>';
            ...
            ManualActivityMarkup += '						      <button id="SC-manual-saveAct">Save Activity</button>';
            ManualActivityMarkup += '						      <button id="SC-manual-saveSRBack" class="sc-so-cart">Back</button>';
            ManualActivityMarkup += '						      <button id="SC-manual-saveSR">Add Selected</button>';
            ManualActivityMarkup += '						   </div>';
            ...
            ManualActivityMarkup += '						<div class="row no-margin editsrdiv clearfix" id="sc-manual-editAct-text">	';
            ManualActivityMarkup += '							<p class="labelsr">Enter activity details</p>';
            ManualActivityMarkup += '						</div>';
            ManualActivityMarkup += '						<div class="fields-container clearfix" id="SC-Manual-footer-Fields">';
            ManualActivityMarkup += '						</div>';
            ManualActivityMarkup += '						</div>';
            ManualActivityMarkup += '					  </div>';
            ManualActivityMarkup += '                        <div class="modal-footer">';
            ManualActivityMarkup += '                            <div class="SC-single-button-container no-padding">';
            ManualActivityMarkup += '						      <button class="cancel" type="reset" id="Cancel-Manual-Activity-AC">Go to Contact Activities</button>';
            ManualActivityMarkup += '						      <button class="cancel" type="reset" id="Cancel-Manual-Activity-SR">Go To Service Request</button>';
            ...
            ManualActivityMarkup += '                </div>';
            ManualActivityMarkup += '            </div>';
            $("#SC-manual-activity-Modal").html(ManualActivityMarkup);
          }
        ...
        SCContactActivityListAppletPR.prototype.EndLife = function ()
        {
          SiebelAppFacade.SCContactActivityListAppletPR.superclass.EndLife.apply(this, arguments);
          if ($("#SC-manual-activity-Modal").hasClass("in"))
          {
            $("#SC-manual-activity-Modal").modal('hide');
            $(".modal-backdrop").hide();
          }
        ...
        return SCContactActivityListAppletPR;
      }());
      return "SiebelAppFacade.SCContactActivityListAppletPR";
    })
}