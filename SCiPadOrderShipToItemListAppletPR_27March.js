		 ...
		 if(!$.fn.bstooltip) { 
			...
			$.fn.bstooltip = bootstrapTooltip;
                    ...
                    if (localStorage.getItem('ComingFromOrder360') == "Y") {
                        ...
                        var Fields = "Ship Method,Product Line,SC Ship To Address Name,SC Line Total NRC,Request To Cancel,Start Price,SC Total Line Discounts,NRC CxTotal in Header Currency,Tax Amount,Ship To First Name,Ship To Last Name";
                ...
                SCiPadOrderShipToItemListAppletPR.prototype.BindData = function(bRefresh) {
                    ...
                    if (scRefresh == "Y") {
                        ...
                        var caninvoke = "", caninvoke1 = "";
                        caninvoke = SiebelApp.S_App.GetActiveView().GetAppletMap()["SC Sales Order Entry Form Applet OUI"].GetPModel().GetRenderer().GetPM().ExecuteMethod("CanInvokeMethod", "QuotesAndOrdersValidate");
                        caninvoke1 = SiebelApp.S_App.GetActiveView().GetAppletMap()["SC Order Entry Line Item List Applet"].GetPModel().GetRenderer().GetPM().ExecuteMethod("CanInvokeMethod", "SC Calculate Shipping");
                        SiebelJS.Log("caninvoke" + caninvoke);
                        if (!caninvoke && !caninvoke1) {
                            scRefresh = "Y";
		...
		//SiebelApp.S_App.GetActiveView().GetAppletMap()["SC Sales Order Entry Form Applet OUI"].GetBusComp().SetFieldValue("SC Referred By",$("#referreby").val());
			document.getElementById("referreby").value= RefbyName;
			  ...
			  document.getElementById("referreby").value= RefbyName;
                    ...
                    $(document).on("click", "#createsalesquote", function(e) {
                ...
                function referralcontactSearchMarkup() {
                    ...
                    var markup = "";
                    markup += ' 						<div class="modal-header" >';
                    markup += '                            <button type="button" class="close SC-close-popup blue-bg" id="SC-close-referredby">&times;</button>';
                    markup += '                            <div class="header-content no-padding">';
                    markup += '                                <div class="sc-head-title sc-set-top">';
                    markup += '                                    <div class="sc-icon-text sc-top-padding">';
                    markup += '                                        <div>';
                ...
                function GetAddressList(conId_Global) {
                    var search_Spec = "[Contact Id] = '" + conId_Global + "'";
                    var Fields = "Id,Address Name,SC HD Eligible,SC HD Service Level";
				...
				if(ScReadonly=="N"){*/
                            if (shiplineitemrcdset[i]["Fulfillment Status Code"] == "In Progress") {
                                ...
                                lineItem += '		<div class="column mini">' + shiplineitemrcdset[i]["Line Number"] + '</div>';
                                //Column1
                                lineItem += '		<div class="column big">' + shiplineitemrcdset[i]["SC Long Description"] + '</div>';
                                //Column2
                                lineItem += '		<div class="column big">';
                                //if(ScReadonly=="Y")
                                ...
                                //Column4
                                lineItem += '		<div class="column big contact-popover">';
                                //SPATIBANDLA :changed code for defect 616
                                ...
                                lineItem += '		<div class="column small">';
                                if (shiplineitemrcdset[i]["Ship To Contact Id"] != null && shiplineitemrcdset[i]["Ship To Contact Id"] != "" && shiplineitemrcdset[i]["Ship To Contact Id"] != "undefined" && shiplineitemrcdset[i]["Ship To Contact Id"] != "No Match Row Id") {
                                ...
                                lineItem += '		</div>';
                                //Column6
                                lineItem += '		<div class="column small reqShipDateTD">';
