  ...
  (SiebelAppFacade.ConfiguratorRenderer = (function () {
    ...
    function addPortItem(e, t) {
      ...
      if (p.length > 0) {
        ...
        w.bind(
          ...
          console.log("Calling inject function"); this.InjectAutomationAttr(w, e + _underscore + "INTID" + _pipe + r);
      }
      (p = $(
      ...
      if (t.GetProperty("CanDrillDown") === "Y") {
        ...
        d.bind(
          ...
          console.log("Calling inject function"); this.InjectAutomationAttr(d, e + _underscore + "INTID" + _pipe + r);
      } else
        (i =
          typeof t.GetProperty("Display Name") == "undefined" ||
          t.GetProperty("Display Name") === ""
    ...
    function createCustomizeIcon(e, t, n, r, i, s, o) {
      ...
      f.bind(
        ...
        console.log("Calling inject function"); this.InjectAutomationAttr(f, r);
    }
    function createEditFieldIcon(e, t, n, r, i, s, o, u, a) {
      ...
      n === _underscore + "INTID" + _pipe
        ...
        console.log("Calling inject function"); this.InjectAutomationAttr(h, r),
        console.log("Calling inject function"); this.InjectAutomationAttr(c, r);
    }
    ...
    function createRemoveIcon(e, t, n, r, i, s, o) {
      ...
      l.bind(
        ...
        console.log("Calling inject function"); this.InjectAutomationAttr(l, r);
    }
      ...
      if (n.GetChildByType("Quantity") !== null)
        if (r === null)
          ...
          d.bind(
            ...
            console.log("Calling inject function"); this.InjectAutomationAttr(d, t);
        }
    }
    ...
    function showCombo(e) {
      ...
      if (E === "Port") {
        ...
        g.bind(
          ...
          console.log("Calling inject function"); this.InjectAutomationAttr(g, e);
      } else if (E === "Attribute") {
        var A = "",
          c = "",
      ...
      for (var j = 0; j < d; j++) {
        ...
        if (t === "quantity") {
          ...
          (it = o.find(":input")),
            ...
            console.log("Calling inject function"); this.InjectAutomationAttr(it, e);
        ...
        if (
          ...
          i.bind(
            ...
            console.log("Calling inject function"); this.InjectAutomationAttr(i, e);
        } else st.html(q);
        st.appendTo(o),
      ...
      if (n !== null && o.length > 0) {
        ...
        if (c === "Y" || a === "MiniButton")
          u.bind(
            ...
            console.log("Calling inject function"); this.InjectAutomationAttr(u, e);
      }
    }
      ...
      if (r === "Port") showDomainAndChildrenControl.call(this, e, "radio");
        ...
        for (var C = 0; C < l; C++) {
          ...
          R.bind(
            ...
            console.log("Calling inject function"); this.InjectAutomationAttr(R, e);
        }
      }
    }
    ...
    function showSelectAndOptionsHelper(tableId, dispArray, dispFunction) {
      ...
      $(generateCfgSelectHTMLMarkup(selectConfig)).appendTo(colElement),
        console.log("Calling inject function");console.log("Calling inject function"); this.InjectAutomationAttr(colElement.find("select"), tableId);
      if (noQtyCtrl !== "Y") {
        ...
        (inputElement = $(
          ...
          console.log("Calling inject function"); console.log("Calling inject function"); this.InjectAutomationAttr(inputElement, tableId),
          dynReadOnly === "Y"
            ? (buttonElement = $(
                generateCfgHTMLMarkup({
                  type: "span",
      ...
      if (dynReadOnly !== "Y") {
        ...
        noQtyCtrl !== "Y"
          ...
          console.log("Calling inject function"); this.InjectAutomationAttr(buttonElement, tableId);
      }
    ...
    function showTextBox(e) {
      ...
      if (s === "Attribute" && o.length > 0) {
        ...
        w.bind(
          ...
          console.log("Calling inject function"); this.InjectAutomationAttr(w, e),
            ...
            if (instancePropSet.GetProperty("CanDrillDown") === "Y") {
              ...
              if (C.length > 0) {
                ...
                A.bind(
                  ...
                  console.log("Calling inject function"); this.InjectAutomationAttr(A, e.GetType());
              }
            }
            (C = $(
    ...
    function _CfgShowUI() {
      ...
      $(".siebui-ecfg-product-details #CfgObjDetails").hide(),
        ...
        console.log("Calling inject function"); this.InjectAutomationAttr($("#siebui-ecfg-toggleProdDetails")),
        $("#CfgMsgToggleBtn").bind("click", { ctx: this }, function (e) {
          setTimeout(function () {
            toggleCfgMessages.call(e.data.ctx);
          }, 0);
        }),
        console.log("Calling inject function"); this.InjectAutomationAttr($("#CfgMsgToggleBtn")),
          ...
          if (d.attr("type") === "button")
            ...
            if (h.length > 0) {
              ...
              m.bind(
                ...
                console.log("Calling inject function"); this.InjectAutomationAttr(h, c),
    ...
    function applicantShowSelectAndOptionsHelper(
      ...
      $(generateCfgSelectHTMLMarkup(selectConfig)).appendTo(colElement1),
        console.log("Calling inject function"); this.InjectAutomationAttr(colElement1.find("select"), tableId),
        ...
        console.log("Calling inject function"); this.InjectAutomationAttr(element, tableId),
        (portItemSpanId = tableId.replace(/PORT/, "PORTITEM")),
    ...
    function applicantAddPortItem(e, t) {
      ...
      if (l.length > 0) {
        ...
        m.bind(
          ...
          console.log("Calling inject function"); this.InjectAutomationAttr(m, e + _underscore + "INTID" + _pipe + s);
      }
      displayFieldList.call(
        this,
        f,
      ...
      $("#" + jqSelector(p))
        ...
        console.log("Calling inject function"); this.InjectAutomationAttr($("#" + jqSelector(p)).find("a"), e);
    }
    ...
    function _ShowCfgMenuLayout() {
        ...
        for (var W = 0; W < z.length; W++) {
          ...
          if (V) {
            ...
            Z.attr("id", "MENUBUTTON_" + Q),
              ...
              console.log("Calling inject function"); this.InjectAutomationAttr(Z.find("a"), "MENUBUTTON");
          } else {
            var B = "ChangeCurrentObj",
              j = CCFMiscUtil_CreatePropSet();
            j.SetType("Group"),
      ...
      for (var L = 0; L < vt.length; L++) {
        ...
        if (yt === "Y") {
          ...
          j.SetType("Group"),
            ...
            console.log("Calling inject function"); this.InjectAutomationAttr(mt);
      ...
      Et.bind("click", { ctx: this }, function (e) {
        ...
        console.log("Calling inject function"); this.InjectAutomationAttr(Et),
        console.log("Calling inject function"); this.InjectAutomationAttr(St),
        console.log("Calling inject function"); this.InjectAutomationAttr(xt);
    }
