...
if (typeof (SiebelAppFacade.SCOrderShipToItemListAppletPR) === "undefined") {

  SiebelJS.Namespace("SiebelAppFacade.SCOrderShipToItemListAppletPR");
  define("siebel/custom/SelectComfort/SCOrderShipToItemListAppletPR", ["siebel/jqgridrenderer", "siebel/custom/SelectComfort/SC_OUI_Markups", "siebel/custom/SelectComfort/bootstrap.min", "siebel/custom/SelectComfort/jquery.validate.min", "siebel/custom/SelectComfort/SCOrderShipToLineItemMarkup", "siebel/custom/SelectComfort/SCSalesOrderMarkup", "siebel/custom/SelectComfort/SCErrorCodes", "siebel/custom/SelectComfort/SCErrorCodes", "siebel/custom/SelectComfort/SC_OUI_Methods", "siebel/custom/SelectComfort/SC_OUI_Definitions"], //"siebel/custom/SelectComfort/SCSalesOrderMarkup"],
    function () {
      SiebelAppFacade.SCOrderShipToItemListAppletPR = (function () {
        ...
        SCOrderShipMarkup = SiebelJS.Dependency("SiebelAppFacade.SCOrderShipToLineItemMarkup");
        ...
        var sc_reffid = "";
        var sP2PEFlag = "";
        var sFeatureFlag = ""; //PJAYASHA:Added sFeatureFlag condition for adyen flow:110624
        var refsearchfields = "",
          refsearchCount = 2,
          currentValue = "",
          next = 1,
        ...
        function SCOrderShipToItemListAppletPR(pm) {
          SiebelAppFacade.SCOrderShipToItemListAppletPR.superclass.constructor.apply(this, arguments);
        }

        SiebelJS.Extend(SCOrderShipToItemListAppletPR, SiebelAppFacade.JQGridRenderer);

        SCOrderShipToItemListAppletPR.prototype.Init = function () {
          SiebelAppFacade.SCOrderShipToItemListAppletPR.superclass.Init.apply(this, arguments);
        ...
        SCOrderShipToItemListAppletPR.prototype.ShowUI = function () {
          SiebelAppFacade.SCOrderShipToItemListAppletPR.superclass.ShowUI.apply(this, arguments);
          ...
          //NGOLLA for defect 660
          /* if($.fn.bstooltip.noConflict()){
			 var bootstrapTooltip = $.fn.bstooltip.noConflict();
			$.fn.bstooltip = bootstrapTooltip;
		 }
		 if(!$.fn.bstooltip) { 
			var bootstrapTooltip = $.fn.tooltip.noConflict();
          ...
          sFeatureFlag = SiebelApp.S_App.GetProfileAttr('FeatureFlag'); //PJAYASHA:Added sFeatureFlag condition for adyen
          /*var scshipsearspec=[],
              scshipsortspec=[];
          	scshipsearspec[0]="[Type]= 'FS_ORDER_STATUS' and [Active] = 'Y' and [Name]='Siebel Error'";
          	scshipsortspec[0]="";
          	scshipsearspec[1]="[Type]= 'SC_MANUAL_DISCOUNT_REASON' and [Active] = 'Y'";
          	scshipsortspec[1]="Order By";
          	scshipsearspec[2]="[Type]= 'DISCNT_PERCENT' and [Active] = 'Y'";
          	scshipsortspec[2]="Order By";
          	scshipsearspec[3]="[Type]= 'PROD_CD' and [Active] = 'Y' and [Name]='Promotion'";
          	scshipsortspec[3]="Order By";
          	scshipsearspec[4]="[Type]= 'SC_DISA_ENABLE_FLAG' and [Active] = 'Y' and [Name]='Enable Disa Flag'";
          	scshipsortspec[4]="Order By";
          	
          	SC_OUI_Methods.SCSetLoVs(scshipsearspec, scshipsortspec);
          	SC_OUI_Methods.SCGetProfileAttr("SC Store Number,MachineInfo,SC Store User");*/
          sc_addr_id = "";
          sc_phnnumber = "";
          Sc_ship_contactid = "";
          primarycontactid = "";
          ...
          //SPATIBAN:FEB2019:added code for nullyfing the Ship to account and Shid to address for CR #CHG0034839
          if (scAccountOrder) {
            ...
            //localStorage.setItem("SCPrimaryContactId","");
            //if(primarycontactid!=""&&primarycontactid!='undefined'&&primarycontactid!="No Match Row Id"){
            //if(primaryornot=="hasprime"){
            /*if(primarycontactid!="" && primarycontactid!="undefined" && primarycontactid!=null && primarycontactid!="No Match Row Id"){
            	var inPS="",outPS="",Bservice="";
            		inPS = SiebelApp.S_App.NewPropertySet();
            		outPS = SiebelApp.S_App.NewPropertySet();
            		inPS.SetProperty("Contact Id", primarycontactid);
            		inPS.SetProperty("ProcessName", "SC Get Contact Details WorkFlow");
            		...
            		Sc_ship_contactid=outPS.GetChild(0).GetProperty("PrimaryContactId");
            		sc_addr_id=outPS.GetChild(0).GetProperty("AddrId");
            		sc_phnnumber=outPS.GetChild(0).GetProperty("Phonenumber");
            		sc_fst_name=outPS.GetChild(0).GetProperty("Firstname");
            		sc_lst_name=outPS.GetChild(0).GetProperty("LastName");
            		updateaccount="Y";
            		SiebelJS.Log("sc_phnnumber"+sc_phnnumber);
            		SiebelJS.Log("Primary Addr id"+sc_addr_id);
            		PrContactName=sc_fst_name+" "+sc_lst_name;
          ...
          if (!scAccountOrder) {
            /*if(updateaccount==="Y")
            {
            $("#Ship-Default-Name").html(sc_fst_name+sc_lst_name);	
            }
            else{*/
            //Start:Appending Default Shipping Details
            ...
            //End:Appending Default Shipping Details
          ...
          if (localStorage.getItem('ComingFromPayments') == "Y") {
            ...
            var Fields = "Ship Method,Product Line,SC Ship To Address Name,SC Line Total NRC";
        ...
        SCOrderShipToItemListAppletPR.prototype.BindData = function (bRefresh) {
          ...
          if (scRefresh == "Y") {
            ...
            SiebelJS.Log("CanInvokeVerify" + canInvokeVerify);

            if (canInvokeVerify) {
              SiebelJS.Log("Invoking Verifybutton");
              SCVerify = 'Y';
              ...
              SiebelApp.S_App.GetActiveView().GetAppletMap()["SC Order Entry Line Item List Applet"].InvokeMethod("SC Validate Freight");
            } else {
              scRefresh = "Y";
              SiebelApp.S_App.GetActiveView().GetAppletMap()["SC Order Entry Line Item List Applet"].InvokeMethod("RefreshBusComp");
            }
          }
          //start code for on click of calculate frieght button invoking calculate freight and verify button
          ...
          SiebelAppFacade.SCOrderShipToItemListAppletPR.superclass.BindData.apply(this, arguments);
          ...
          if (localStorage.getItem('ProceedToShipping') == 'Y') {
            ...
            setTimeout(function () {
              ...
              if (scAccountOrder) {
                ...
                //SPATIBAN:FEB2019:added code for if revorder revision number is >1 shipping section should be read only CR #CHG0035023
			   ...
			   if(ShipToContactRecordSet[0]["Primary Ship To Postal Code"]!=(''|""|"undefined"))
                ...
                addressLine = AttachAddresses(ShipToContactRecordSet[0]["Ship To Address Id"]);
                $("#Ship-Default-BillToAddress").html(addressLine);
                //$("#Delivery-Tier").html(getDeliveryTierOptions("")); //17Sep24;SL;Added for Tiered Delivery
                $("#Shipping-Detils").show();
                //SPATIBAN:FEB2019:added code for if revorder revision number is >1 shipping section should be read only CR #CHG0035023
                //if (sOrderRevisionNum > 1) {
              ...
              $("#custommaskoverlay").hide();
			   $(".SC-Discount-button").hide(); //Sukumar 01/25 to hide discount button
              $(".maualdiscaddons").hide(); //Sukumar 01/25 to hide discount button
        ...
        SCOrderShipToItemListAppletPR.prototype.BindEvents = function () {
          SiebelAppFacade.SCOrderShipToItemListAppletPR.superclass.BindEvents.apply(this, arguments);
          ...
          $(document).on('click', '#SC-ProdTerms-Decline-ok', function () {
            $("#SC-Prod-Terms-Decline-Info").modal('hide');
            $("#SC-Prod-Terms-Decline-Info").on('hidden.bs.modal', function () {
            ...
            var fieldnames = 'SC Products TACOS Acceptance,SC Products TACOS Acceptance Date';
          ...
          $("#SC-AccChange-contact").click(function () {
            ...
            setTimeout(function() {
            	if(ChnageContactloaded == "N"){
            		...
            		var ContactLines="",Contact_Array;
            		var Custom_Service = SiebelApp.S_App.GetService("SC Custom Query");
            		var InputArg = SiebelApp.S_App.NewPropertySet();
            		var OutputArg = SiebelApp.S_App.NewPropertySet();
            		var Fields = "First Name,Last Name,Contact Id,Primary Personal Address Id";
            		InputArg.SetProperty("BO", "Account");
            		InputArg.SetProperty("BC", "Account Contact");
            		InputArg.SetProperty("SearchSpecification", "[Account Id] = '"+ShipToContactRecordSet[0]["Bill To Account Id"]+"'");
            		InputArg.SetProperty("FieldsArray", Fields);
            		OutputArg = Custom_Service.InvokeMethod("Query", InputArg);
            		var Child_OutArg = OutputArg.GetChild(0);
            		var BS_Data = Child_OutArg.GetProperty("OutputRecordSet");
            		if(BS_Data!="}"){
            			Contact_Array = BS_Data.split(";");
            			for (var j = 0; j < Contact_Array.length; j++){
            				if(Contact_Array[j] != "")
            				{
            					var con_JSON = JSON.parse(Contact_Array[j]);
            					ContactLines += '<tr id="'+con_JSON["Contact Id"]+'_'+con_JSON["Primary Personal Address Id"]+'"><td>' + con_JSON["Last Name"]+" </td><td>"+ con_JSON["First Name"] + '</td></tr>';
            				}
            			}
            			
            		}
            		$("#SC-Acc-Contacts").html(ContactLines);
            	}
            	$('#SC-table-search-Acc-contact tbody tr').removeClass('highlate-row');
            	$("#SC-AccSelect-contact").addClass('SC-disabled');
            	$("#SC-Accsearch-contacts").modal({
            		backdrop: 'static'
            	});
            	$("#custommaskoverlay").hide();
            }, 50);*/
          ...
          $(document).on("click", "#store-yes-ship", function () {
            ...
            //SPATIBAN:added code for updating the order sale location based on user location
            var storeinfo = storeinfo = SC_OUI_Methods.SCGetProfileAttrValue("SC Primary Division Name");
            ...
            $("#clocation").attr("title", storeinfo);
          ...
          $(document).on('click', '#Ship-Defalut-RequestShipDate', function () {
            ...
            $("#Ship-Default-Calander").datepicker({
              minDate: 0,
              changeMonth: true,
              changeYear: true,
              onSelect: function (dateText, inst) {
                ...
                getOrderAPTDate();
                SiebelApp.S_App.GetActiveView().GetAppletMap()["SC Sales Order Entry Form Applet OUI"].InvokeMethod("RefreshBusComp");
                $("#Ship-Defalut-RequestShipDate-Val").html(dateText);
                $(".defaultRequestShipDate").val(dateText);
              },
              showButtonPanel: true
            });
          ...
          $(document).on("click", "#backtoship", function () {
			...
			$(".addonsdel").show();
      if ($('[id^=ProductCoupon]')[0] != undefined) { //LikhithaK:22Aug2025:Added if case
			  if($('[id^=ProductCoupon]')[0].innerText === "no coupons applied"){$('[id^=ProductCoupon]').prev().hide()}
      }
      if ($('[id^=scmanualcouponval]')[0] != undefined) { //LikhithaK:22Aug2025:Added if case
          ...
          //start:onclick on proced-payments
          $(document).on("click", "#SC-proced-payments", function () {
            if (sFeatureFlag == "Y" && localStorage.getItem('PoleDisplayConfBypass') == "Y") {
              //Start:LikhithaK:28Jan2025:phoneOrderpopup instead of terminal popup in case of Pole display "N" for a store.
              ...
              //End:LikhithaK:28Jan2025:phoneOrderpopup instead of terminal popup in case of Pole display "N" for a store.
            } else {
              if (sP2PEFlag == "Y") {
                $("#SC-SO-Phone-Order").modal({
                  backdrop: 'static'
                ...
                fNJConfirmFunction(); // this is not needed, can be removed in May 04th Release
              }
            }

          });
          //End:onclick on proced-payments

          //start:onclick on yes Phone Order
          $(document).on("click", "#SC-phoneorder-yes", function () {
            //AKSHAY: 28 AUG 2024 - Added below line for MKE.
            localStorage.setItem("isPhoneOrder", "Y");
            $("#SC-SO-Phone-Order").modal('hide');
			localStorage.setItem("OverlayRemoval", "Y");//Greyout issue-PROD
            setTimeout(function () {
              var sOrderId = ShipToContactRecordSet[0]["Id"];
              ...
              Bservice = SiebelApp.S_App.GetService("SC Custom Query Simplified"); //get service
              outPS = Bservice.InvokeMethod("Insert", inPS);
              //LikhithaK:28Jan2025:Start:Added below if case for Terminal popup incase of Phone Order "Y", Pole display "N" and MKE "Y".
              var sMKESwitch = SiebelApp.S_App.GetProfileAttr("MKESwitchFlag");
              if (sFeatureFlag == "Y" && localStorage.getItem('PoleDisplayConfBypass') == "Y" && sMKESwitch == "Y") {
                SC_OUI_Methods.SCnGetDisplayTerminals();
                //LikhithaK:28Jan2025:End:Added above if case for Terminal popup incase of Phone Order "Y", Pole display "N" and MKE "Y".
              } else {
                fNJConfirmFunction();
              }
            }, 1000)
          ...
          $(document).on("click", "#SC-phoneorder-no", function () {
            ...
            setTimeout(function () {
              ...
              Bservice = SiebelApp.S_App.GetService("SC Custom Query Simplified"); //get service
              outPS = Bservice.InvokeMethod("Insert", inPS);
              //LikhithaK:28Jan2025:Start:Added below if case for Terminal popup incase of Phone Order "N", Pole display "N".
              if (sFeatureFlag == "Y" && localStorage.getItem('PoleDisplayConfBypass') == "Y") {
                SC_OUI_Methods.SCnGetDisplayTerminals();
                //LikhithaK:28Jan2025:End:Added above if case for Terminal popup incase of Phone Order "N", Pole display "N".
              } else {
                fNJConfirmFunction();
              }
            }, 1000)
          ...
          $(document).on("click", "#SC-RepriceAll-shipping", function () {
            if (scAccountOrder) {
              ...
              if (scnullshipMethod == "N") {
                $("#custommaskoverlay").show();
                setTimeout(function () {
                  SiebelApp.S_App.GetActiveView().GetAppletMap()["SC Order Entry Line Item List Applet"].GetPModel().GetRenderer().GetPM().ExecuteMethod("InvokeMethod", "SC Calculate Shipping", null, false);
                  OrderItemDetails = SC_Order_PMinstance.GetRecordSet();
                  SiebelJS.Log("SC_orderStatus" + SC_orderStatus);
                  SiebelJS.Log(OrderItemDetails[0]["Status"]);
                  if (OrderItemDetails[0]["Status"] == SC_orderStatus) {
          ...
          //Start:salesorder quote after clicking Create Quote
          ...
          $(document).on("change", ".Ship-ShippingMethod", function () {
            ...
            if ($(this).val() == "Recd At Store") {
              if ($("#" + ship_line_row_id + "defaultRequestShipDate").val() != "" || $("#" + ship_line_row_id + "defaultRequestShipDate").val() != '') {
                ...
                inPS.SetProperty("FieldsArray", fieldnames);
                inPS.SetProperty("ValuesArray", fieldvalues);
                inPS.SetProperty("SearchSpecification", "[Order Header Id] = '" + orderid + "' AND [Id]='" + shippingItemsRecordSet[ship_line_row_id]["Id"] + "'");
                Bservice = SiebelApp.S_App.GetService("SC Custom Query Simplified"); //get service
                outPS = Bservice.InvokeMethod("Insert", inPS);
              }
            ...
            if ($(this).val() != "Recd At Store") {
              ...
              if (strPrevShipMethod == "Home Delivery" || $(this).val() == "Home Delivery") //30Sep24;SL;Added for Tiered Delivery
              {
                ...
                if (strPrevShipMethod == "Home Delivery") //user selects shipping other than Home Delivery
                {
                  ...
                  //this.parentElement.nextElementSibling.innerHTML = "<select class='shipping-dropdown' id='" + (ship_line_row_id) + "Delivery-Tier'>" + getDeliveryTierOptions(shippingItemsRecordSet[ship_line_row_id - 1]["Id"]) + "</select>"; //enable delivery tier dropdown on current line
          ...
          //Start:on focus out of Default Shipping Phone number field
          ...
          $("#SC-CF-failure-button").click(function () {
            //$("body").trigger('Custom.Start');
            //SPATIBAN:MAY2019 Release:Added below code for refresh the line items Section
            //setTimeout(function(){
            $("#SC-SO-CF-failure").modal('hide');
          ...
          $(document).on('click', "#SC-Ship-BackToProducts", function () {
            ...
            $("#Default-Shipping").hide();
            $("#Shipping-Detils").hide();
			 $(".SC-Discount-button").show(); //Sukumar 02/25 to hide discount button
            $(".maualdiscaddons").show(); //Sukumar 02/25 to hide discount button
			 $(".prodcoupon").show();//Sukumar 01/25 to hide discount button
      ...
      if ($('[id^=scmanualcouponval]')[0] != undefined) { //LikhithaK:22Aug2025:Added if case
            ...
            if (this.id == "Ship-Default-BillToAddress") {
              if (val != "ADD NEW ADDRESS") {
                ...
                for (var i = 0; i < orderrcd.length; i++) {
                  SiebelJS.Log(conId + "   bujyhb" + orderrcd[i]["Ship To Contact Id"]);
                  $("#" + (i + 1) + "Ship-ShipToAddress").html(addressLine);
                  $("#" + (i + 1) + "Ship-ShippingLineItemATP").html(orderrcd[i]["ATP Status As Of Date"]);
                }
              }
            } else {
              if (val != "ADD NEW ADDRESS") {
                ...
                SiebelApp.S_App.GetActiveView().GetAppletMap()["SC Order Entry - Line Items Form Applet"].GetBusComp().SetFieldValue("Ship To Address Id", addrid);
                SiebelApp.S_App.GetActiveView().GetAppletMap()["SC Order Entry - Line Items Form Applet"].InvokeMethod("WriteRecord");
                shippingItemsRecordSet = SiebelApp.S_App.GetActiveView().GetAppletMap()["SC Order Entry - Line Items Form Applet"].GetBusComp().GetRecordSet();
                var inpPS = "",
                  outPS = "",
                  oBS = "";
                inPS = SiebelApp.S_App.NewPropertySet();
                outPS = SiebelApp.S_App.NewPropertySet();
                inPS.SetProperty("Object Id", orderid);
                inPS.SetProperty("LineItemId", shippingItemsRecordSet[Addr_line_row_id - 1]["Id"]);
                inPS.SetProperty("ProcessName", "SC Get ATP Scheduled Date From GOP");
                Bservice = SiebelApp.S_App.GetService("Workflow Process Manager"); //get service
                outPS = Bservice.InvokeMethod("RunProcess", inPS);
                var ship_line_row_id1 = parseInt(Addr_line_row_id) - 1;
                $("#" + Addr_line_row_id + "Ship-ShippingLineItemATP").text(SiebelApp.S_App.GetActiveView().GetAppletMap()["SC Order Entry Line Item List Applet"].GetPModel().Get("GetRecordSet")[ship_line_row_id1]["ATP Status As Of Date"]);
              }
            }
            if (val == "ADD NEW ADDRESS") {
              accAddr = "N";
          ...
          $(document).on('change', '[id$="Delivery-Tier"]', function (evt) //20Sep24;SL;Added for Tiered Delivery
            {
              ...
              if (elemId == "Delivery-Tier" || elemId == "acc-Delivery-Tier") { //copy delivery tier onto the line items with matching ship address
                ...
                /*numOfRec = SiebelApp.S_App.GetActiveView().GetAppletMap()["SC Order Entry - Line Items Form Applet"].GetBusComp().GetRecordSet().length;
                for (var i = 0; i < numOfRec; i++)
                {
                  strLineItemAddrId = parentAddrJSON[$("#" + (i + 1) + "Ship-ShipToAddress").val()];
                  if (strOrdAddrId == strLineItemAddrId && shippingItemsRecordSet[i]['Ship Method'] == "Home Delivery" && shippingItemsRecordSet[i]['Product Line'] != 'DELIVERY' && shippingItemsRecordSet[i]['Product Line'] != 'SERVICE' && shippingItemsRecordSet[i]["Product Type Code"] != ProductTypeCode)
                  {
                    $("#" + (i + 1) + "Delivery-Tier").val(strSelectedTier); //Set the value at line item
        ...
        /* function ShowReferralPopup () {
					//console.log("Inside Process Referral");
					var ReferralInsider = "";
					if (SiebelApp.S_App.GetActiveView().GetAppletMap()["SC Sales Order Entry Form Applet OUI"] !== undefined) {
						ReferralInsider= SiebelApp.S_App.GetActiveView().GetAppletMap()["SC Sales Order Entry Form Applet OUI"].GetBusComp().GetFieldValue("SC Referred By");
					}
					if ($("#SC-Add-Referral").is(":visible") && ReferralInsider === "") {
						$("#SC-SO-RR-popup").modal({
							backdrop: 'static'
						});
						$("#SC-SO-RR-popup").css({
							"display": "flex",
        ...
        function customerInfoConformation() {
	      ...
	      $('.modal-backdrop').remove(); //LikhithaK:10Feb2025:Manual removal of overlay for the modal
              if (confirmFlag == "Y" || sConfirmTimeOut == "Y" || termId == "No Terminal Available") {
                ...
                if (localStorage.getItem('BypassTerminalSave') == "Y") {
                  if (sP2PEFlag == "Y") {
                    fNJConfirmFunction(); //LikhithaK:28Jan2025:Navigation to Payments page, after Confirmation call if Pole Display is "N".
                    //LikhithaK:Start:28Jan2025:Commented: as no phone order pop-up required after Confirmation call in case pole display "N".
                    /* $("#SC-SO-Phone-Order").modal(
                    {
                      backdrop: 'static'
                    });
                    ...
                    $(".modal-backdrop").css('background', '#ffffff'); */
                    //LikhithaK:End:28Jan2025:Commented
                  }
            ...
            //AKSHAY: Added below if/else condition for DF-1980 
            if (localStorage.getItem('BypassTerminalSave') == "Y") {
              fNJConfirmFunction(); //LikhithaK:28Jan2025:Navigation to Payments page, after Confirmation call if Pole Display is "N".
              //LikhithaK:Start:28Jan2025:Commented: as no phone order pop-up required after Confirmation call in case pole display "N".
              /*$("#SC-SO-Phone-Order").modal(
        ...
        function fUpdateBilltoContactConf() {
          ...
          setTimeout(function () {
            ...
            if (confirmFlag == "Y") {
              //Akshay:07Nov2024:Updated for Terminal CR:Start
              ...
              //Akshay:07Nov2024:Updated for Terminal CR:End
              $("body").trigger('Custom.Start');
              setTimeout(function () {
                var InPut = SiebelApp.S_App.NewPropertySet();
                var OutPut = SiebelApp.S_App.NewPropertySet();
      ...
      if ($('[id^=scmanualcouponval]')[0] != undefined) { //LikhithaK:22Aug2025:Added if case
        ...
        //VALLA : 09-DEC-2019 : Added the below logic to prompt the HD Lines on P2PE device
        ...
        //VALLA : 09-DEC-2019 : Added the below logic to prompt the Product Terms and Conditions on P2PE device
          ...
          for (var i = 0; i < lineItemsRecordSet.length; i++) {
            ...
            if ((scAccountOrder || lineItemsRecordSet[i]["Product Line"] != 'DELIVERY') && shiplineitemrcdset[i]["Product Type Code"] != ProductTypeCode) {
              ...
              if ((shiplineitemrcdset[i]["SC Revisable"] == "Revisable" && shiplineitemrcdset[i]["Request To Cancel"] != "Y") || shiplineitemrcdset[i]["Fulfillment Status Code"] == "In Progress") {
                ...
                lineItem += '		</div>';
                //column3
                if (shiplineitemrcdset[i]["Shipping"] != null && shiplineitemrcdset[i]["Shipping"] != undefined) { //17Sep24;SL;Modified below for Tiered Delivery
                  if (shippingItemsRecordSet[i]['Ship Method'] == "Home Delivery") {
                    bInvokeTD = (bInvokeTD == "N") ? "Y" : bInvokeTD;
                  }
                  if (shippingItemsRecordSet[i]['Ship Method'] == "Home Delivery" && shippingItemsRecordSet[i]['Product Line'] != "SERVICE" && lineItemsRecordSet[i]["Product Line"] != 'DELIVERY') {
                    lineItem += '		<div class="column bigtr">';
                    lineItem += '			<select class="shipping-dropdown" id="' + (i + 1) + 'Delivery-Tier">';
                    //lineItem += getDeliveryTierOptions(shippingItemsRecordSet[i]['Id']);
                    lineItem += '			</select>';
                    lineItem += '		</div>';
                  } else {
                ...
                lineItem += '		</div>';
                //new column
                if (shiplineitemrcdset[i]["ATP Status As Of Date"] != null && shiplineitemrcdset[i]["ATP Status As Of Date"] != undefined) {
                  lineItem += '   <div class="column smalltr" id="' + (i + 1) + 'Ship-ShippingLineItemATP">' + shiplineitemrcdset[i]["ATP Status As Of Date"] + '</div>';
                } else {
                ...
                if (lineItemsRecordSet[i]["Ship Method"] != "Recd At Store") {
                    ...
                    lineItem += '			<input type="" name="" class="shipping-input date reqShipDateTDSN total-width SC-readonly SN-fields-readonly" id="' + (i + 1) + 'defaultRequestShipDate" value="">';
                lineItem += '		</div>';*/
                lineItem += '	</div>';
        ...
        function Get_OrderShipToLineItemsAccount(lineItemsRecordSet, shiplineitemrcdset) {
          ...
          for (var i = 0; i < lineItemsRecordSet.length; i++) {
            ...
            if (shiplineitemrcdset[i]["Product Type Code"] != ProductTypeCode) {
              var lineItem = '';
              var ScReadonly = "N";
              if (shiplineitemrcdset[i]["SC Address Revisable"] == "N") //12Nov24;SL;Made it similar to iPad
              {
                if (shiplineitemrcdset[i]["Fulfillment Status Code"] == "In Progress") //12Nov24;SL;Made it similar to iPad
                {
                  lineItem += '	<div class="table-row">';
                } else {
                  lineItem += '	<div class="table-row sn-bookedlines-readonly">';
                ...
                if (lineItemsRecordSet[i]["Ship Method"] != "Recd At Store") {
                  ...
                  lineItem += '			<input type="" name="" class="shipping-input date total-width defaultRequestShipDate" id="' + (i + 1) + 'defaultRequestShipDate" value="' + Reqshipdate + '">';
                } else
                  lineItem += '			<input type="" name="" class="shipping-input date total-width SC-readonly" id="' + (i + 1) + 'defaultRequestShipDate" value="">';
                lineItem += '		</div>';
                lineItem += '	</div>';
                lineItemsList += lineItem;
              }
        ...
        function DeliveryTypePopup() {
          ...
          if (iEligibleAdderCount) {
            ...
            outPS = Bservice.InvokeMethod("Insert", inPS);
            //AKSHAY: added below line due to selected record modified error.
            SiebelApp.S_App.GetActiveView().GetAppletMap()["SC Sales Order Entry Form Applet OUI"].InvokeMethod("RefreshBusComp");
            ...
            if (canInvokeVerify) {
              ...
              setTimeout(function () {
                ...
                if (canInvokeCalculate) {
                  ...
                  SiebelApp.S_App.GetActiveView().GetAppletMap()["SC Order Entry Line Item List Applet"].InvokeMethod("SC Calculate Shipping");
                }
              }, 100);
            } else {
        ...
        SCOrderShipToItemListAppletPR.prototype.EndLife = function () {
          SiebelAppFacade.SCOrderShipToItemListAppletPR.superclass.EndLife.apply(this, arguments);
        ...
        return SCOrderShipToItemListAppletPR;
      }());
      return "SiebelAppFacade.SCOrderShipToItemListAppletPR"
    })
}