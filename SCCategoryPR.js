if (typeof(SiebelAppFacade.SCCategoryPR) === "undefined") {

 SiebelJS.Namespace("SiebelAppFacade.SCCategoryPR");
 define("siebel/custom/SelectComfort/SCCategoryPR", ["siebel/jqgridrenderer","siebel/custom/SelectComfort/SC_OUI_Methods","siebel/custom/SelectComfort/SCSalesOrderMarkup","siebel/custom/SelectComfort/SC_OUI_Markups"],
  function () {
   SiebelAppFacade.SCCategoryPR = (function () {
    ...
    function SCCategoryPR(pm) {
     SiebelAppFacade.SCCategoryPR.superclass.constructor.apply(this, arguments);
    }

    SiebelJS.Extend(SCCategoryPR, SiebelAppFacade.JQGridRenderer);

    SCCategoryPR.prototype.Init = function () {
		SiebelAppFacade.SCCategoryPR.superclass.Init.apply(this, arguments);
    ...
    SCCategoryPR.prototype.ShowUI = function () {
     SiebelAppFacade.SCCategoryPR.superclass.ShowUI.apply(this, arguments);
		...
		var scstatus=SiebelApp.S_App.GetActiveView().GetAppletMap()["SC Sales Order Entry Form Applet OUI"].GetBusComp().GetFieldValue("Status");
		//SPATIBAN: nov 15 2019:to hide edit details
...
/* 			$(document).ready(function(){						
    ...
    SCCategoryPR.prototype.BindData = function (bRefresh) {
		SiebelAppFacade.SCCategoryPR.superclass.BindData.apply(this, arguments);
    ...
    SCCategoryPR.prototype.BindEvents = function () {
     SiebelAppFacade.SCCategoryPR.superclass.BindEvents.apply(this, arguments);
	...
	function productsearch(){
		...
		if(SKUs==""){
			...
			$('.modal-backdrop').remove(); //LikhithaK:09Sep2025:Added as part of Greout issue
		}
		...
		//hiding the Loader
		$('.modal-backdrop').remove(); //LikhithaK:22Aug2025:Added as part of Greout issue on Add to Order button click.
    ...
    SCCategoryPR.prototype.EndLife = function () {
     SiebelAppFacade.SCCategoryPR.superclass.EndLife.apply(this, arguments);
  ...
  return "SiebelAppFacade.SCCategoryPR";
 })
}
