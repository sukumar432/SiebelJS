if (typeof (SiebelAppFacade.SCiPadPaymentsPR) === "undefined") {

    SiebelJS.Namespace("SiebelAppFacade.SCiPadPaymentsPR");
    define("siebel/custom/SelectComfort/SCiPadPaymentsPR", ["siebel/jqgridrenderer", "siebel/custom/SelectComfort/SCiPadPaymentsMarkup", "siebel/custom/SelectComfort/bootstrap.min.js", "siebel/custom/SelectComfort/jquery.validate.min", "siebel/custom/SelectComfort/SC_OUI_Methods", "siebel/custom/SelectComfort/SC_OUI_Definitions", "siebel/custom/SelectComfort/SC_OUI_Markups", "siebel/custom/SelectComfort/SCErrorCodes"],
        function () {
            SiebelAppFacade.SCiPadPaymentsPR = (function () {
                var SCPaymentMarkup = SiebelJS.Dependency("SiebelApp.SCiPadPaymentsMarkup");
                ...
                var orderPM, orderBC, paymentBC, orderRecord, contactId, orderId, orderNumberBS, notCommited = false,
                ...
                var sPrintOne = "";
                var sIpadFeatureFlag = "N";
                var poleDisplayFlg;
                var MKESwitchFlag = theApplication().GetProfileAttr("MKESwitchFlag");
                var PayByLinkFlag = theApplication().GetProfileAttr("PayByLinkFlag"); //LikhithaK:EP-157:19Aug2025:Pay By Link
                //LikhithaK:End:SFSTRY0003472:Terminal UI Changes
                var pblGetAccount = "";

                function SCiPadPaymentsPR(pm) {
                    SiebelAppFacade.SCiPadPaymentsPR.superclass.constructor.apply(this, arguments);
                }

                SiebelJS.Extend(SCiPadPaymentsPR, SiebelAppFacade.JQGridRenderer);

                SCiPadPaymentsPR.prototype.Init = function () {
                    isFinancing = "N";
                    // Init is called each time the object is initialised.
                    SiebelAppFacade.SCiPadPaymentsPR.superclass.Init.apply(this, arguments);
                    SiebelJS.Log(this.GetPM().Get("GetName") + ": SCiPadPaymentsPR:      Init method reached.");
                    ...
                    //LikhithaK:Start:SFSTRY0003472:Terminal UI Changes
                    sIpadFeatureFlag = theApplication().GetProfileAttr("IpadFeatureFlag");
                    ...
                    //RevisionReason = SiebelApp.S_App.GetActiveView().GetAppletMap()["SC Sales Order Entry Form Applet OUI"].GetBusComp().GetFieldValue("Revision Reason");

                    //VALLA - 25-March-2020 Below code is to Temporary disabled paySCStoreUser
                    if (sIpadFeatureFlag == "Y") //LikhithaK:Added if case as part of Terminal UI Changes
                    {} else {
                        paySCStoreUser = "N";
                    }
                ...
                SCiPadPaymentsPR.prototype.ShowUI = function () {
                    SiebelAppFacade.SCiPadPaymentsPR.superclass.ShowUI.apply(this, arguments);
                    SiebelJS.Log(this.GetPM().Get("GetName") + ": SCiPadPaymentsPR:      ShowUI method reached.");
                    //LikhithaK:Start:SFSTRY0003472:Terminal UI Changes
                    //Added below code for Terminal session timeout config.
                    ...
                    //Added below code for Terminal UI.

                    var terminalValue = SiebelApp.S_App.GetProfileAttr('TerminalSelected');
                    var fitFlag = SiebelApp.S_App.GetProfileAttr('IpadFeatureFlag');
                    SCInactivityTime();
                    ...
                    if (isFinanceDisabled == "N") {
                        $("#SC-financeapp").addClass("SC-disabled");
                    }
                    ...
                    city = orderBC.GetFieldValue("Primary Bill To City"); //Likhithak:18Feb2025:To add city name in the address on payments page
                    ...
                    //Likhithak:Start:18Feb2025:To add city name in the address on payments page
                    if (city.length != 0) {
                        address = address + ', ' + city;
                    }
                    //Likhithak:End:18Feb2025:To add city name in the address on payments page
                    if (state.length != 0) {
                            ...
                            if (canNewRecord) {
                                ...
                                if (this.id == "credit-card-paymnet") {
                                    ...
                                    if (PayByLinkFlag == "Y") {
                                        ...
                                        $("#Payment-Link-CC_PBL").val(sPBLPaymentLink);
                                        $("#CreditCapt-Status_PBL").val(sPBLCaptureStatus);
                                        if (sPBLSMS == "Y") {
                                    ...
                                    //LikhithaK:End:19Aug2025:EP-157:SFSTRY0003466
                                    ...
                                    if (PayByLinkFlag == "Y" && P2PEFlag == "Y" && MKESwitchFlag == "N" && sPayStatus == "Entered" && sPayLink != null && sPayLink != "") {
                                        $("#SC-CreditCard").addClass("SC-disabled");
                                    ...
                                    } else if (PayByLinkFlag == "Y" && P2PEFlag == "Y" && MKESwitchFlag == "N" && sPayStatus == "Entered" && (sPayLink == null || sPayLink == "")) {
                                    ...
                                    //Added code for Restrict Payment Method and Type Changes to only when the Payment Status is "Entered" or "In Progress".
                                ...
                                if (this.id == "financing-payment") {
                                    ...
                                    if (isFinanceDisabled == "N") {
                                        ...
                                        $("#SC-financeapp").removeClass("SC-disabled");
                                    }
                                    ...
                                    if (paymentGroup == "SYNCHRONY") {
                                        ...
                                        $("#financeaccountnumber").rules("add", {
                                            ...
                                            maxlength: 7,
                                            messages: {
                                                minlength: "Account Number Should be 7 digits",
                                                maxlength: "Account Number Should be 7 digits"
                                            }
                                        });
                                    } else {
                                        financelen = 10;
                                ...
                                if (this.id == "reward-payment") {
                                    ...
                                    //$("#sc-reward-type-input").focus(); //LikhithaK:SFSTRY0003430:Commented
                                    ...
                                    if (id == "SC-finance-payment") {
                                        ...
                                        setTimeout(function () {
                                            ...
                                            if (paymentGroup == "HELPCARD") {
                                                ...
                                                if ($("#financeaccountnumber").val().length != 7) {
                                                    $("#financeaccountnumber").focus();
                                                    $("#financeaccountnumber").trigger("keyup");
                                                }
                                            }
                    ...
                    $(document).on("click", "#sc-reward-type", function () {
                        ...
                        SiebelApp.S_App.GetActiveView().GetAppletMap()[appletName].GetPModel().AttachNotificationHandler("g", function (o) {
                            ...
                            /*if(IsStoreUser == "Y")
                            	$('#sc-reward-type-input').val("X-XXXXXXXXXXX");
                            else
                            	$('#sc-reward-type-input').val(rewardType);*/
                            $('#rewardaccountnumber').val(accountNumber);
                            SiebelJS.Log("paymentType...:" + rewardType);
                            var scRwdAmt = "";
                            //[Start]Added  by APRAKASH FOR SFSTRY0001789
                            orderBC = SiebelApp.S_App.GetActiveView().GetAppletMap()["SC Sales Order Entry Form Applet OUI"].GetBusComp();
                        ...
                        submitHandler: function (form) {
                            ...
                            setTimeout(function () {
                                ...
                                if (sIpadFeatureFlag == "Y") {
                                    ...
                                    var BS_Data = Child.GetProperty("OutputRecordSet");
                                    BS_Data = JSON.parse(BS_Data);
                                    var sIsPhnOrder = BS_Data["SC Phone Order Flag"];
                                }

                                if (sIpadFeatureFlag == "Y" && sIsPhnOrder == "Y" && MKESwitchFlag != "Y") {
                                    ...
                                    if (paymentStatus == "Need Verbal Authorization" && P2PEFlag != "Y") {
                                        ...
                                        if (caninvoke) {
                                            ...
                                            if (sIpadFeatureFlag == "Y") {
                                                ...
                                                inPS.SetProperty("SearchSpecification", "[Id] = '" + sPayID + "'");
                                            ...
                                            pm.ExecuteMethod("InvokeMethod", "GetAccessToken", null, false);
                                            var AccessToken = SiebelApp.S_App.GetProfileAttr("SCAccessToken");
                                            theApplication().SetProfileAttr("Device", "Tablet")
                                            //var storeUser = SiebelApp.S_App.GetProfileAttr('SC Store User');
                                            if (paySCStoreUser == 'Y') {
                                                pm.ExecuteMethod("InvokeMethod", "GetAccessToken", null, false);
                                                var AccessToken = SiebelApp.S_App.GetProfileAttr("SCAccessToken");
                                                ...
                                                if (P2PEFlag == "Y" && paymentStatus != "Need Verbal Authorization") {
                                                    //LikhithaK:Start:SFSTRY0003472:Terminal UI Changes
                                                    //Added if-else - isPhoneOrder condition for MKE.
                                                    var isPhoneOrder = localStorage.getItem("isPhoneOrder");
                                                    if (MKESwitchFlag == "Y" && sIpadFeatureFlag == "Y" && isPhoneOrder == "Y") {
                                                        $("#custommaskoverlay").show();
                                ...
                                var paymentCheck = setInterval(function () {
                                    var sAccNum = paymentBC.GetFieldValue("Account Number");
                                    var payStatus = paymentBC.GetFieldValue('SC Payment Status');
                                    if (payStatus != "Entered" || (sAccNum != "" && sAccNum != null)) {
                                        //Kolasani
                    ...
                    //LikhithaK:Start:SFSTRY0003472:Terminal UI Changes
                    //Added below handler for Terminal Busy CR.
                        ...
                        setTimeout(function () {
                            if (orderId != null) {
                                ...
                                if (OrderSubType == "Wholesale" || OrderSubType == "Commercial" || OrderSubType == "QVC" || OrderSubType == "Internal" || OrderSubType == "HSN") {
                                    ...
                                    ai2.opdecode = true;
                                    ai2.errcb = function () {
                                        SiebelJS.Log("Error while executing 'SC Store Data BS -- SC WC Reciept Generation' Business Service");
                                    };
                                    ai2.cb = function () {
                                        // do nothing
                                    }
                                    Service3.InvokeMethod("SC WC Reciept Generation", InPS3, ai2);
                                    ...
                                    Service3.InvokeMethod("SC Reciept Generation", InPS3, ai2);
                    ...
                    function getHDSRList() {
                        ...
                        for (var sr = 0; sr < SRrcdlen1; sr++) {
                            ...
                            //UALVES - make the field read/write
                    ...
                    $("#SC-complete").click(function () {
                        ...
                        //LikhithaK:Start:SFSTRY0003472:Terminal UI Changes
                        if (sIpadFeatureFlag == "Y") {
                            var sOrdID = orderBC.GetFieldValue("Id");
                            ...
                            inPS.SetProperty("FieldsArray", fieldnames);
                            inPS.SetProperty("ValuesArray", fieldvalues);
                            inPS.SetProperty("SearchSpecification", "[Id] = '" + sOrdID + "'");
                            Bservice = SiebelApp.S_App.GetService("SC Custom Query Simplified"); //get service
                            outPS = Bservice.InvokeMethod("Insert", inPS);

                            SCOUIMethods.CheckTerminalStatus(localStorage.getItem('OrderId'));
                            //Clear Interval.
                            if (window.terminalcheck != undefined && window.terminalcheck != "undefined") {
                                clearInterval(window.terminalcheck);
                                clearTimeout(window.time);
                    ...
                    $("#order360").click(function () {
                        ...
                        //LikhithaK:Start:SFSTRY0003472:Terminal UI Changes
                        if (sIpadFeatureFlag == "Y") {
                            SCOUIMethods.CheckTerminalStatus(localStorage.getItem('OrderId')); //Added for home page navigation on Terminal
                            //Clear Interval.
                            if (window.terminalcheck != undefined && window.terminalcheck != "undefined") {
                                clearInterval(window.terminalcheck);
                                clearTimeout(window.time);
                    ...
                    $(document).on("click", "#SC-CreditCard-ResendPBL", function () {
                        ...
                        pblGetStatus = setInterval(function () {
                            ...
                            $("#CreditCapt-Status_PBL").val(sPayLinkStat);
                    ...
                    $(document).on("click", "#SC-CreditCard-PBL", function () {
                        ...
                        if (canWrite) {
                            ...
                            if (sPBLPaymentLink == "") {
                                ...
                                $("#CreditCapt-Status_PBL").val(sPBLCaptStatus);
                                var Refreshservice = '',
                                    RefreshinPS = '',
                                    RefreshoutPS = '';
                                RefreshinPS = SiebelApp.S_App.NewPropertySet();
                            ...
                            if (sPBLPayLink != null && sPBLPayLink != "") {
                                ...
                                $("#CreditCapt-Status_PBL").val(sPBLLinkStatus);
                                var sPaytMethod = paymentBC.GetFieldValue("Payment Method");
                                if (sPaytMethod == "Credit Card") {
                                    $("#SC-CreditCard").addClass("SC-disabled");
                                    $("#SC-CreditCard-PBL").addClass("SC-disabled");
                                ...
                                var maxTimeLimit = 0;
                                var pblGetAccount = setInterval(function () {
                                    var sPBLAccountNumber = paymentBC.GetFieldValue("Account Number");
                                    if (sPBLAccountNumber != "" && sPBLAccountNumber != null) {
                                        setTimeout(function () {
                                            $(".active-tab").each(function () {
                                                $('#' + this.id).removeClass("active-tab");
                                            });
                ...
                SCiPadPaymentsPR.prototype.BindData = function (bRefresh) {
                    // BindData is called each time the data set changes.
                    // This is where you'll bind that data to user interface elements you might have created in ShowUI
                    // Add code here that should happen before default processing
                    SiebelJS.Log(this.GetPM().Get("GetName") + ": SCiPadPaymentsPR:      BindData method reached.");
                    SiebelAppFacade.SCiPadPaymentsPR.superclass.BindData.apply(this, arguments);
                    $("#custommaskoverlay").show();
                    setTimeout(function () {
                        records = pm.Get("GetRecordSet");
                ...
                SCiPadPaymentsPR.prototype.BindEvents = function () {
                    // BindEvents is where we add UI event processing.
                    // Add code here that should happen before default processing
                    SiebelJS.Log(this.GetPM().Get("GetName") + ": SCiPadPaymentsPR:      BindEvents method reached.");
                    SiebelAppFacade.SCiPadPaymentsPR.superclass.BindEvents.apply(this, arguments);
                    ...
                    //VALLA: 23-Aug-23: Added to stop the Buying GiftCard using Finance
                    ...
                    function printQuote() {
                        ...
                        ai.errcb = function () {}
                        ai.cb = function () {}
                        Bservice.InvokeMethod("Insert", inPS, ai);
                        //outPS = Bservice.InvokeMethod("Insert", inPS);
                        var orderSubType = orderBC.GetFieldValue("SC Sub-Type");
                        setTimeout(function () {
                            ...
                            setTimeout(function () {
                                $("#SC-salesordercreatequote").modal("hide");
                                $(".ui-dialog-buttonset button:nth-child(2)").trigger('click');
                                setTimeout(function () {
                                    $(".ui-dialog-buttonset button:nth-child(3)").trigger('click');
                                    $("#SC-salesorderquote").modal("hide");
                    ...
                    $("#sc-fin-Acc-Lookup-Details").validate({
                        ...
                        messages: {
                            ...
                            finzipCode: {
                                ...
                                regex: "Input is not valid. Please enter digits only."
                            },
                            finphoneNumber: {
                ...
                SCiPadPaymentsPR.prototype.EndLife = function () {
                    // EndLife is where we perform any required cleanup.
                    // Add code here that should happen before default processing
                    SiebelJS.Log(this.GetPM().Get("GetName") + ": SCiPadPaymentsPR:      EndLife method reached.");
                    SiebelAppFacade.SCiPadPaymentsPR.superclass.EndLife.apply(this, arguments);
                    localStorage.setItem("comingfrom", "");
                        ...
                        ai.cb = function () {
                            ...
                            var myVar = setInterval(function () {
                                ...
                                ai.cb = function () {
                                    //Code occurs here for the method that Siebel Open UI runs if the AJAX call is successful
                                    SiebelJS.Log("In 1759 Refresh BC Call Back");
                                    checkOrderStatus(myVar);
                                };
                                SiebelApp.S_App.GetActiveView().GetAppletMap()["SC Sales Order Entry Form Applet OUI"].GetPModel().GetRenderer().GetPM().ExecuteMethod("InvokeMethod", "RefreshBusComp", inPS1, ai);
                                //SiebelApp.S_App.GetActiveView().GetAppletMap()["SC Sales Order Entry Form Applet OUI"].InvokeMethod("RefreshBusComp");
                            }, 1000);
                        };
                        SiebelApp.S_App.GetActiveView().GetAppletMap()["SC Sales Order Entry Form Applet OUI"].GetPModel().GetRenderer().GetPM().ExecuteMethod("InvokeMethod", "SubmitOrder", inPS, ai);
                ...
                function checkOrderStatus(myVar) {
                ...
                function selectSalesRep() {
                    ...
                    if (localStorage.getItem("comingfrom") == "refundbtn") {
                        ...
                        if (orderBC.GetFieldValue("Revision") == 1) {
                            var InPS = SiebelApp.S_App.NewPropertySet();
                            var OutPS = SiebelApp.S_App.NewPropertySet();
                            var Service = SiebelApp.S_App.GetService("SC Get Employee");
                            var empsearchSpec = "[Employee Type Code]='Employee'";
                ...
                //LikhithaK:Start:SFSTRY0003472:Terminal UI Changes
                //added below function to track inactivity. Terminal Busy CR.
                ...
                return SCiPadPaymentsPR;
            }());
            return "SiebelAppFacade.SCiPadPaymentsPR";
        })
