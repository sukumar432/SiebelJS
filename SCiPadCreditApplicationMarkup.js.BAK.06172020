        ...
        function() {
            SiebelApp.SCiPadCreditApplicationMarkup = (function() {
                ...
                SCiPadCreditApplicationMarkup.prototype.SCCreditApp_RootMarkup = function() {
                    ...
                    markup += ' <span class="add-margin">Do you want to apply for a Joint Application?</span>';
                ...
                SCiPadCreditApplicationMarkup.prototype.SCFinanceHeaderMarkup = function() {
                    var headermarkup = "";
                    /* headermarkup+='<html>';
                    headermarkup+='<head>';
                    headermarkup+='</head>';
                    ...
                    headermarkup += '<p class="terms marginleft">TERMS AND CONDITIONS</p>';
                    headermarkup += '<ul>';
                    ...
                    headermarkup += '<button class="SC-sign-button SC-disabled" id="SC-sign-submit">Submit</button>';
                    headermarkup += ' </div>';
                    headermarkup += ' </div>';
                    headermarkup += '</div>';
                    headermarkup += '</div>';
